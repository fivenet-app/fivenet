...
goog.exportSymbol('proto.services.livemapper.ServerStreamResponse', null, global);
 ...
 * @constructor
 */
proto.services.livemapper.ServerStreamResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.livemapper.ServerStreamResponse.repeatedFields_, null);
};
goog.inherits(proto.services.livemapper.ServerStreamResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.livemapper.ServerStreamResponse.displayName = 'proto.services.livemapper.ServerStreamResponse';
}
 ...
 * @const
 */
proto.services.livemapper.ServerStreamResponse.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.services.livemapper.ServerStreamResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.livemapper.ServerStreamResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.livemapper.ServerStreamResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.livemapper.ServerStreamResponse}
 */
proto.services.livemapper.ServerStreamResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.livemapper.ServerStreamResponse;
  return proto.services.livemapper.ServerStreamResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.livemapper.ServerStreamResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.livemapper.ServerStreamResponse}
 */
proto.services.livemapper.ServerStreamResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.livemapper.ServerStreamResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.livemapper.ServerStreamResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.livemapper.ServerStreamResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.livemapper.ServerStreamResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!proto.services.livemapper.ServerStreamResponse} returns this
 */
proto.services.livemapper.ServerStreamResponse.prototype.clearDispatchesList = function() {
 ...
 * @return {!proto.services.livemapper.ServerStreamResponse} returns this
 */
proto.services.livemapper.ServerStreamResponse.prototype.clearUsersList = function() {
