...
goog.exportSymbol('proto.services.citizenstore.GetUserDocumentsRequest', null, global);
goog.exportSymbol('proto.services.citizenstore.GetUserDocumentsResponse', null, global);
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.services.citizenstore.GetUserDocumentsRequest.displayName = 'proto.services.citizenstore.GetUserDocumentsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.citizenstore.GetUserDocumentsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.citizenstore.GetUserDocumentsResponse.repeatedFields_, null);
};
goog.inherits(proto.services.citizenstore.GetUserDocumentsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.citizenstore.GetUserDocumentsResponse.displayName = 'proto.services.citizenstore.GetUserDocumentsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.services.citizenstore.GetUserDocumentsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.citizenstore.GetUserDocumentsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.citizenstore.GetUserDocumentsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.citizenstore.GetUserDocumentsRequest}
 */
proto.services.citizenstore.GetUserDocumentsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.citizenstore.GetUserDocumentsRequest;
  return proto.services.citizenstore.GetUserDocumentsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.citizenstore.GetUserDocumentsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.citizenstore.GetUserDocumentsRequest}
 */
proto.services.citizenstore.GetUserDocumentsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.citizenstore.GetUserDocumentsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.citizenstore.GetUserDocumentsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.citizenstore.GetUserDocumentsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {number}
 */
proto.services.citizenstore.GetUserDocumentsRequest.prototype.getUserId = function() {
 ...
 * @return {!Object}
 */
proto.services.citizenstore.GetUserDocumentsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.citizenstore.GetUserDocumentsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.citizenstore.GetUserDocumentsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.citizenstore.GetUserDocumentsResponse}
 */
proto.services.citizenstore.GetUserDocumentsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.citizenstore.GetUserDocumentsResponse;
  return proto.services.citizenstore.GetUserDocumentsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.citizenstore.GetUserDocumentsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.citizenstore.GetUserDocumentsResponse}
 */
proto.services.citizenstore.GetUserDocumentsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.citizenstore.GetUserDocumentsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.citizenstore.GetUserDocumentsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.citizenstore.GetUserDocumentsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
