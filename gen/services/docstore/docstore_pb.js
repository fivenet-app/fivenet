...
goog.exportSymbol('proto.services.docstore.GetDocumentFeedRequest', null, global);
goog.exportSymbol('proto.services.docstore.GetDocumentFeedResponse', null, global);
 ...
 * @constructor
 */
proto.services.docstore.GetDocumentFeedRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.docstore.GetDocumentFeedRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.docstore.GetDocumentFeedRequest.displayName = 'proto.services.docstore.GetDocumentFeedRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.docstore.GetDocumentFeedResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.docstore.GetDocumentFeedResponse.repeatedFields_, null);
};
goog.inherits(proto.services.docstore.GetDocumentFeedResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.docstore.GetDocumentFeedResponse.displayName = 'proto.services.docstore.GetDocumentFeedResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.services.docstore.GetDocumentFeedRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.docstore.GetDocumentFeedRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.docstore.GetDocumentFeedRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetDocumentFeedRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    documentId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.docstore.GetDocumentFeedRequest}
 */
proto.services.docstore.GetDocumentFeedRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.docstore.GetDocumentFeedRequest;
  return proto.services.docstore.GetDocumentFeedRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.docstore.GetDocumentFeedRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.docstore.GetDocumentFeedRequest}
 */
proto.services.docstore.GetDocumentFeedRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.docstore.GetDocumentFeedRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.docstore.GetDocumentFeedRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.docstore.GetDocumentFeedRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetDocumentFeedRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDocumentId();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.services.docstore.GetDocumentFeedRequest.prototype.getDocumentId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.services.docstore.GetDocumentFeedRequest} returns this
 */
proto.services.docstore.GetDocumentFeedRequest.prototype.setDocumentId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @const
 */
proto.services.docstore.GetDocumentFeedResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.services.docstore.GetDocumentFeedResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.docstore.GetDocumentFeedResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.docstore.GetDocumentFeedResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetDocumentFeedResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    resources_documents_documents_pb.DocumentFeed.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.docstore.GetDocumentFeedResponse}
 */
proto.services.docstore.GetDocumentFeedResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.docstore.GetDocumentFeedResponse;
  return proto.services.docstore.GetDocumentFeedResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.docstore.GetDocumentFeedResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.docstore.GetDocumentFeedResponse}
 */
proto.services.docstore.GetDocumentFeedResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new resources_documents_documents_pb.DocumentFeed;
      reader.readMessage(value,resources_documents_documents_pb.DocumentFeed.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.services.docstore.GetDocumentFeedResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.docstore.GetDocumentFeedResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.docstore.GetDocumentFeedResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetDocumentFeedResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      resources_documents_documents_pb.DocumentFeed.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated resources.documents.DocumentFeed items = 1;
 * @return {!Array<!proto.resources.documents.DocumentFeed>}
 */
proto.services.docstore.GetDocumentFeedResponse.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.resources.documents.DocumentFeed>} */ (
    jspb.Message.getRepeatedWrapperField(this, resources_documents_documents_pb.DocumentFeed, 1));
};


/**
 * @param {!Array<!proto.resources.documents.DocumentFeed>} value
 * @return {!proto.services.docstore.GetDocumentFeedResponse} returns this
*/
proto.services.docstore.GetDocumentFeedResponse.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.resources.documents.DocumentFeed=} opt_value
 * @param {number=} opt_index
 * @return {!proto.resources.documents.DocumentFeed}
 */
proto.services.docstore.GetDocumentFeedResponse.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.resources.documents.DocumentFeed, opt_index);
};
 ...
 * @return {!proto.services.docstore.GetDocumentFeedResponse} returns this
 */
proto.services.docstore.GetDocumentFeedResponse.prototype.clearItemsList = function() {
