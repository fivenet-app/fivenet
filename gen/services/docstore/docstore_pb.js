...
goog.exportSymbol('proto.services.docstore.GetUserDocumentsRequest', null, global);
goog.exportSymbol('proto.services.docstore.GetUserDocumentsResponse', null, global);
 ...
 * @constructor
 */
proto.services.docstore.GetUserDocumentsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.docstore.GetUserDocumentsRequest.repeatedFields_, null);
};
goog.inherits(proto.services.docstore.GetUserDocumentsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.docstore.GetUserDocumentsRequest.displayName = 'proto.services.docstore.GetUserDocumentsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.docstore.GetUserDocumentsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.docstore.GetUserDocumentsResponse.repeatedFields_, null);
};
goog.inherits(proto.services.docstore.GetUserDocumentsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.docstore.GetUserDocumentsResponse.displayName = 'proto.services.docstore.GetUserDocumentsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.services.docstore.GetUserDocumentsRequest.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.docstore.GetUserDocumentsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.docstore.GetUserDocumentsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetUserDocumentsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    pagination: (f = msg.getPagination()) && resources_common_database_database_pb.PaginationRequest.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.docstore.GetUserDocumentsRequest}
 */
proto.services.docstore.GetUserDocumentsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.docstore.GetUserDocumentsRequest;
  return proto.services.docstore.GetUserDocumentsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.docstore.GetUserDocumentsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.docstore.GetUserDocumentsRequest}
 */
proto.services.docstore.GetUserDocumentsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.docstore.GetUserDocumentsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.docstore.GetUserDocumentsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetUserDocumentsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPagination();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.resources.common.database.PaginationRequest}
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.getPagination = function() {
  return /** @type{?proto.resources.common.database.PaginationRequest} */ (
    jspb.Message.getWrapperField(this, resources_common_database_database_pb.PaginationRequest, 1));
};
...
*/
proto.services.docstore.GetUserDocumentsRequest.prototype.setPagination = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.services.docstore.GetUserDocumentsRequest} returns this
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.clearPagination = function() {
  return this.setPagination(undefined);
};
 ...
 * @return {boolean}
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.hasPagination = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.getUserId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.services.docstore.GetUserDocumentsRequest} returns this
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.setUserId = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!proto.services.docstore.GetUserDocumentsRequest} returns this
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.addRelations = function(value, opt_index) {
 ...
 * @return {!proto.services.docstore.GetUserDocumentsRequest} returns this
 */
proto.services.docstore.GetUserDocumentsRequest.prototype.clearRelationsList = function() {
  return this.setRelationsList([]);
};
 ...
 * @const
 */
proto.services.docstore.GetUserDocumentsResponse.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.docstore.GetUserDocumentsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.docstore.GetUserDocumentsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetUserDocumentsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    pagination: (f = msg.getPagination()) && resources_common_database_database_pb.PaginationResponse.toObject(includeInstance, f),
    relationsList: jspb.Message.toObjectList(msg.getRelationsList(),
    resources_documents_documents_pb.DocumentRelation.toObject, includeInstance)
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.docstore.GetUserDocumentsResponse}
 */
proto.services.docstore.GetUserDocumentsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.docstore.GetUserDocumentsResponse;
  return proto.services.docstore.GetUserDocumentsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.docstore.GetUserDocumentsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.docstore.GetUserDocumentsResponse}
 */
proto.services.docstore.GetUserDocumentsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.docstore.GetUserDocumentsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.docstore.GetUserDocumentsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.docstore.GetUserDocumentsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPagination();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.resources.common.database.PaginationResponse}
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.getPagination = function() {
  return /** @type{?proto.resources.common.database.PaginationResponse} */ (
    jspb.Message.getWrapperField(this, resources_common_database_database_pb.PaginationResponse, 1));
};
...
/**
 * @param {?proto.resources.common.database.PaginationResponse|undefined} value
 * @return {!proto.services.docstore.GetUserDocumentsResponse} returns this
*/
proto.services.docstore.GetUserDocumentsResponse.prototype.setPagination = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.services.docstore.GetUserDocumentsResponse} returns this
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.clearPagination = function() {
  return this.setPagination(undefined);
};
 ...
 * @return {boolean}
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.hasPagination = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Array<!proto.resources.documents.DocumentRelation>}
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.getRelationsList = function() {
  return /** @type{!Array<!proto.resources.documents.DocumentRelation>} */ (
 ...
 * @return {!proto.services.docstore.GetUserDocumentsResponse} returns this
*/
proto.services.docstore.GetUserDocumentsResponse.prototype.setRelationsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.resources.documents.DocumentRelation}
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.addRelations = function(opt_value, opt_index) {
 ...
 * @return {!proto.services.docstore.GetUserDocumentsResponse} returns this
 */
proto.services.docstore.GetUserDocumentsResponse.prototype.clearRelationsList = function() {
  return this.setRelationsList([]);
};
