...
func (c *livemapServiceClient) Stream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (LivemapService_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &LivemapService_ServiceDesc.Streams[0], "/gen.livemap.LivemapService/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
var LivemapService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gen.livemap.LivemapService",
	...
	Metadata: "livemap/livemap.proto",
}
