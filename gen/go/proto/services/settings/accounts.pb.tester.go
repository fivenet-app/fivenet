...
func NewTestAccountsServiceClient(srv AccountsServiceServer) (AccountsServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterAccountsServiceServer(server, srv)
	go func() {
