...
const file_services_settings_laws_proto_rawDesc = "" +
	"\n" +
	"\x1cservices/settings/laws.proto\x12\x11services.settings\x1a\x19resources/laws/laws.proto\x1a\x17validate/validate.proto\"[\n" +
...
var file_services_settings_laws_proto_depIdxs = []int32{
	8, // 0: services.settings.CreateOrUpdateLawBookRequest.lawBook:type_name -> resources.laws.LawBook
	8, // 1: services.settings.CreateOrUpdateLawBookResponse.lawBook:type_name -> resources.laws.LawBook
