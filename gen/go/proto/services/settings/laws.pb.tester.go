...
func NewTestLawsServiceClient(srv LawsServiceServer) (LawsServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterLawsServiceServer(server, srv)
	go func() {
	...
	client := NewLawsServiceClient(conn)
