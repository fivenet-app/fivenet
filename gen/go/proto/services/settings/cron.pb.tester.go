...
func NewTestCronServiceClient(srv CronServiceServer) (CronServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterCronServiceServer(server, srv)
	go func() {
	...
	client := NewCronServiceClient(conn)
