...
const file_services_settings_config_proto_rawDesc = "" +
	"\n" +
	"\x1eservices/settings/config.proto\x12\x11services.settings\x1a\x1fresources/settings/config.proto\x1a\x17validate/validate.proto\"\x15\n" +
	"\x13GetAppConfigRequest\"M\n" +
	"\x14GetAppConfigResponse\x125\n" +
	"\x06config\x18\x01 \x01(\v2\x1d.resources.settings.AppConfigR\x06config\"Y\n" +
	"\x16UpdateAppConfigRequest\x12?\n" +
	"\x06config\x18\x01 \x01(\v2\x1d.resources.settings.AppConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06config\"P\n" +
