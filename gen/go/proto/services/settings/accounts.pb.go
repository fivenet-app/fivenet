...
const file_services_settings_accounts_proto_rawDesc = "" +
	"\n" +
	" services/settings/accounts.proto\x12\x11services.settings\x1a(resources/common/database/database.proto\x1a!resources/accounts/accounts.proto\x1a\x17validate/validate.proto\"\x8f\x02\n" +
	...
	"\aaccount\x18\x01 \x01(\v2\x1b.resources.accounts.AccountR\aaccount\"j\n" +
	"!DisconnectOAuth2ConnectionRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x04B\a\xfaB\x042\x02 \x00R\x02id\x12,\n" +
	"\fproviderName\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xff\x01R\fproviderName\"$\n" +
	"\"DisconnectOAuth2ConnectionResponse\"/\n" +
	"\x14DeleteAccountRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x04B\a\xfaB\x042\x02 \x00R\x02id\"\x17\n" +
