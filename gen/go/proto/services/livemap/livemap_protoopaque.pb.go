...
const file_services_livemap_livemap_proto_rawDesc = "" +
	...
	"\x03job\x18\x02 \x01(\tR\x03job\"f\n" +
	"\x1bCreateOrUpdateMarkerRequest\x12G\n" +
	"\x06marker\x18\x01 \x01(\v2'.resources.livemap.markers.MarkerMarkerB\x06\xbaH\x03\xc8\x01\x01R\x06marker\"_\n" +
