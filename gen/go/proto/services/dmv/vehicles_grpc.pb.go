...
func (c *dMVServiceClient) ListVehicles(ctx context.Context, in *ListVehiclesRequest, opts ...grpc.CallOption) (*ListVehiclesResponse, error) {
	...
	err := c.cc.Invoke(ctx, DMVService_ListVehicles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDMVServiceServer must be embedded to have
...
func (UnimplementedDMVServiceServer) testEmbeddedByValue()                    {}
...
func RegisterDMVServiceServer(s grpc.ServiceRegistrar, srv DMVServiceServer) {
	// If the following call pancis, it indicates UnimplementedDMVServiceServer was
