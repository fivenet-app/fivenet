...
const file_services_dmv_vehicles_proto_rawDesc = "" +
	"\n" +
	"\x1bservices/dmv/vehicles.proto\x12\fservices.dmv\x1a(resources/common/database/database.proto\x1a!resources/vehicles/vehicles.proto\x1a\x17validate/validate.proto\"\xfe\x02\n" +
	...
	"\n" +
	"DMVService\x12U\n" +
	"\fListVehicles\x12!.services.dmv.ListVehiclesRequest\x1a\".services.dmv.ListVehiclesResponseB>Z<github.com/fivenet-app/fivenet/gen/go/proto/services/dmv;dmvb\x06proto3"
