...
const file_services_internet_domain_proto_rawDesc = "" +
	"\n" +
	"\x1eservices/internet/domain.proto\x12\x11services.internet\x1a(resources/common/database/database.proto\x1a\x1fresources/internet/domain.proto\"?\n" +
	...
	"\x06domain\x18\x01 \x01(\v2\x1a.resources.internet.DomainR\x06domain\"j\n" +
	"\x12ListDomainsRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\"\xa2\x01\n" +
	"\x13ListDomainsResponse\x12U\n" +
	"\n" +
