...
func NewTestStampsServiceClient(srv StampsServiceServer) (StampsServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterStampsServiceServer(server, srv)
	go func() {
	...
	client := NewStampsServiceClient(conn)
