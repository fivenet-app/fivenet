...
func NewTestFormsServiceClient(srv FormsServiceServer) (FormsServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterFormsServiceServer(server, srv)
	go func() {
	...
	client := NewFormsServiceClient(conn)
