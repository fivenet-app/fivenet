...
const file_services_documents_signing_proto_rawDesc = "" +
	...
	"\x05panel\x18\x02 \x01(\v2*.services.documents.SignaturePanelSnapshotR\x05panel\"]\n" +
	"\x16RevokeSignatureRequest\x12!\n" +
	"\fsignature_id\x18\x01 \x01(\x03R\vsignatureId\x12 \n" +
	"\x06reason\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\x06reason\"\x99\x01\n" +
	...
	"\x05panel\x18\x02 \x01(\v2*.services.documents.SignaturePanelSnapshotR\x05panel\"\x90\x01\n" +
