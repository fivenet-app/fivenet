...
const file_services_documents_approval_proto_rawDesc = "" +
	...
	"\x05panel\x18\x01 \x01(\v2).services.documents.ApprovalPanelSnapshotR\x05panel\"\xb3\x01\n" +
	"\x1aListMyApprovalTasksRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x12?\n" +
	"\x06status\x18\x02 \x03(\x0e2'.resources.documents.ApprovalTaskStatusR\x06status\"\xad\x01\n" +
	"\x1bListMyApprovalTasksResponse\x12U\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2-.resources.common.database.PaginationResponseB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x127\n" +
	"\x05tasks\x18\x02 \x03(\v2!.resources.documents.ApprovalTaskR\x05tasks\"5\n" +
	"\x0fDecisionApprove\x12\"\n" +
	"\acomment\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\acomment\"3\n" +
	"\x0fDecisionDecline\x12 \n" +
	"\x06reason\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\x06reason\"\xc2\x01\n" +
	...
	"\x05panel\x18\x02 \x01(\v2).services.documents.ApprovalPanelSnapshotR\x05panel\"x\n" +
	"\x18CancelReviewTasksRequest\x12\x1f\n" +
	"\vdocument_id\x18\x01 \x01(\x03R\n" +
	"documentId\x12\x19\n" +
	"\btask_ids\x18\x02 \x03(\tR\ataskIds\x12 \n" +
	"\x06reason\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\x06reason\"\x9d\x01\n" +
