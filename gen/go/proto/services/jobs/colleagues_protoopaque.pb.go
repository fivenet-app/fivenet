...
const file_services_jobs_colleagues_proto_rawDesc = "" +
	...
	"\x06search\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x18@R\x06search\x127\n" +
	...
	"\x06absent\x18\x06 \x01(\bH\x03R\x06absent\x88\x01\x01\x12%\n" +
	"\tlabel_ids\x18\a \x03(\x03B\b\xbaH\x05\x92\x01\x02\x10\n" +
	"R\blabelIds\x12-\n" +
	"\vname_prefix\x18\b \x01(\tB\a\xbaH\x04r\x02\x18\fH\x04R\n" +
	"namePrefix\x88\x01\x01\x12-\n" +
	"\vname_suffix\x18\t \x01(\tB\a\xbaH\x04r\x02\x18\fH\x05R\n" +
	...
	"\tcolleague\x18\x01 \x01(\v2$.resources.jobs.colleagues.ColleagueR\tcolleague\"\xed\x02\n" +
	...
	"\x05users\x18\x03 \x01(\v2\x1c.resources.jobs.UserSelectorH\x01R\x05users\x88\x01\x01\x12q\n" +
	...
	"\x06labels\x18\x01 \x03(\v2\x1c.resources.jobs.labels.LabelR\x06labels\"X\n" +
	"\x1aCreateOrUpdateLabelRequest\x12:\n" +
	"\x05label\x18\x01 \x01(\v2\x1c.resources.jobs.labels.LabelB\x06\xbaH\x03\xc8\x01\x01R\x05label\"Q\n" +
	...
	"\x15ReorderLabelsResponse\"G\n" +
	"\x1eGetColleagueLabelsStatsRequest\x12%\n" +
	"\tlabel_ids\x18\x01 \x03(\x03B\b\xbaH\x05\x92\x01\x02\x102R\blabelIds\"Z\n" +
