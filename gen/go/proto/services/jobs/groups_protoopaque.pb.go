...
type ListGroupsRequest struct {
	...
	xxx_hidden_Kind            groups.GroupType            `protobuf:"varint,9,opt,name=kind,proto3,enum=resources.jobs.groups.GroupType,oneof"`
...
func (x *ListGroupsRequest) ClearKind() {
	...
	x.xxx_hidden_Kind = groups.GroupType_GROUP_TYPE_UNSPECIFIED
}
...
type GetGroupRequest struct {
	...
	xxx_hidden_IncludeArchived bool                   `protobuf:"varint,2,opt,name=include_archived,json=includeArchived,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type GetGroupResponse struct {
	...
	xxx_hidden_Access *access.Access         `protobuf:"bytes,2,opt,name=access,proto3,oneof"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type CreateGroupRequest struct {
	...
	xxx_hidden_Access              *access.Access             `protobuf:"bytes,13,opt,name=access,proto3,oneof"`
	XXX_raceDetectHookData         protoimpl.RaceDetectHookData
	XXX_presence                   [1]uint32
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
...
type AddGroupMemberRequest struct {
	...
	xxx_hidden_SkipNotification bool                   `protobuf:"varint,4,opt,name=skip_notification,json=skipNotification,proto3"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *AddGroupMemberRequest) GetSkipNotification() bool {
	if x != nil {
		return x.xxx_hidden_SkipNotification
	}
	return false
}
...
func (x *AddGroupMemberRequest) SetSkipNotification(v bool) {
	x.xxx_hidden_SkipNotification = v
}
...
func (b0 AddGroupMemberRequest_builder) Build() *AddGroupMemberRequest {
	...
	x.xxx_hidden_SkipNotification = b.SkipNotification
	return m0
}
