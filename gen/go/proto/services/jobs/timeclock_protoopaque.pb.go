...
const file_services_jobs_timeclock_proto_rawDesc = "" +
	...
	"\buser_ids\x18\a \x03(\x05B\b\xbaH\x05\x92\x01\x02\x10\x0fR\auserIdsB\a\n" +
	"\x05_sortB\a\n" +
	"\x05_date\"\xb9\x03\n" +
	...
	"\auser_id\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00H\x00R\x06userId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_id\"\xa3\x01\n" +
	"\x19GetTimeclockStatsResponse\x12>\n" +
	"\x05stats\x18\x01 \x01(\v2(.resources.jobs.timeclock.TimeclockStatsR\x05stats\x12F\n" +
	"\x06weekly\x18\x02 \x03(\v2..resources.jobs.timeclock.TimeclockWeeklyStatsR\x06weekly\"\xd4\x01\n" +
	...
	"\x04days\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\x04daysB\a\n" +
	"\x05_sort\"\xc2\x01\n" +
	...
	"\x11GetTimeclockStats\x12'.services.jobs.GetTimeclockStatsRequest\x1a(.services.jobs.GetTimeclockStatsResponse\"\x15\xd2\xf3\x18\x11\b\x01\"\rListTimeclock\x12z\n" +
