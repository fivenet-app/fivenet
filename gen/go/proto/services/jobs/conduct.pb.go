...
const file_services_jobs_conduct_proto_rawDesc = "" +
	"\n" +
	"\x1bservices/jobs/conduct.proto\x12\rservices.jobs\x1a(resources/common/database/database.proto\x1a\x1cresources/jobs/conduct.proto\x1a\x17validate/validate.proto\"\xcf\x02\n" +
	"\x19ListConductEntriesRequest\x12V\n" +
	"\n" +
	...
	"pagination\x126\n" +
	"\aentries\x18\x02 \x03(\v2\x1c.resources.jobs.ConductEntryR\aentries\"Y\n" +
	"\x19CreateConductEntryRequest\x12<\n" +
	"\x05entry\x18\x01 \x01(\v2\x1c.resources.jobs.ConductEntryB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05entry\"P\n" +
	"\x1aCreateConductEntryResponse\x122\n" +
	"\x05entry\x18\x01 \x01(\v2\x1c.resources.jobs.ConductEntryR\x05entry\"Y\n" +
	"\x19UpdateConductEntryRequest\x12<\n" +
	"\x05entry\x18\x01 \x01(\v2\x1c.resources.jobs.ConductEntryB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05entry\"Z\n" +
