...
var file_services_livemapper_livemap_proto_rawDesc = []byte{
	...
	0x72, 0x6b, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x4c, 0x5a, 0x4a,
...
func file_services_livemapper_livemap_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_livemapper_livemap_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_services_livemapper_livemap_proto_msgTypes[8].Exporter = func(v any, i int) any {
