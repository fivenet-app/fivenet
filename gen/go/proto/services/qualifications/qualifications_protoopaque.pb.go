...
type ListQualificationRequestsRequest struct {
	...
	xxx_hidden_Search          *string                        `protobuf:"bytes,6,opt,name=search,proto3,oneof"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
const file_services_qualifications_qualifications_proto_rawDesc = "" +
	...
	"\x06search\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x18@H\x01R\x06search\x88\x01\x01\x12\x1e\n" +
	"\x03job\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x18\x14H\x02R\x03job\x88\x01\x01B\a\n" +
	"\x05_sortB\t\n" +
	"\a_searchB\x06\n" +
	"\x04_job\"\xca\x01\n" +
	"\x1aListQualificationsResponse\x12U\n" +
	"\n" +
	...
	"\rqualification\x18\x01 \x01(\v2'.resources.qualifications.QualificationR\rqualification\"p\n" +
	...
	"\x10qualification_id\x18\x01 \x01(\x03R\x0fqualificationId\"Z\n" +
	"\x1eGetQualificationAccessResponse\x128\n" +
	"\x06access\x18\x01 \x01(\v2\x18.resources.access.AccessB\x06\xbaH\x03\xc8\x01\x01R\x06access\"\x84\x01\n" +
	"\x1dSetQualificationAccessRequest\x12)\n" +
	"\x10qualification_id\x18\x01 \x01(\x03R\x0fqualificationId\x128\n" +
	"\x06access\x18\x02 \x01(\v2\x18.resources.access.AccessB\x06\xbaH\x03\xc8\x01\x01R\x06access\" \n" +
	"\x1eSetQualificationAccessResponse\"\xae\x03\n" +
	" ListQualificationRequestsRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x128\n" +
	"\x04sort\x18\x02 \x01(\v2\x1f.resources.common.database.SortH\x00R\x04sort\x88\x01\x01\x12.\n" +
	"\x10qualification_id\x18\x03 \x01(\x03H\x01R\x0fqualificationId\x88\x01\x01\x12P\n" +
	"\x06status\x18\x04 \x03(\x0e2'.resources.qualifications.RequestStatusB\x0f\xbaH\f\x92\x01\t\x10\x06\"\x05\x82\x01\x02\x10\x01R\x06status\x12)\n" +
	"\buser_ids\x18\x05 \x03(\x05B\x0e\xbaH\v\x92\x01\b\x10\n" +
	"\"\x04\x1a\x02 \x00R\auserIds\x12$\n" +
	"\x06search\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x18@H\x02R\x06search\x88\x01\x01B\a\n" +
	"\x05_sortB\x13\n" +
	"\x11_qualification_idB\t\n" +
	"\a_search\"\xcc\x01\n" +
	"!ListQualificationRequestsResponse\x12U\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2-.resources.common.database.PaginationResponseB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x12P\n" +
	"\brequests\x18\x02 \x03(\v2..resources.qualifications.QualificationRequestB\x04\xc8\xf3\x18\x01R\brequests\"}\n" +
	")CreateOrUpdateQualificationRequestRequest\x12P\n" +
	"\arequest\x18\x01 \x01(\v2..resources.qualifications.QualificationRequestB\x06\xbaH\x03\xc8\x01\x01R\arequest\"v\n" +
	...
	"\x1eDeleteQualificationReqResponse\"\xad\x03\n" +
	" ListQualificationsResultsRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x128\n" +
	"\x04sort\x18\x02 \x01(\v2\x1f.resources.common.database.SortH\x00R\x04sort\x88\x01\x01\x12.\n" +
	"\x10qualification_id\x18\x03 \x01(\x03H\x01R\x0fqualificationId\x88\x01\x01\x12O\n" +
	"\x06status\x18\x04 \x03(\x0e2&.resources.qualifications.ResultStatusB\x0f\xbaH\f\x92\x01\t\x10\x03\"\x05\x82\x01\x02\x10\x01R\x06status\x12)\n" +
	"\buser_ids\x18\x05 \x03(\x05B\x0e\xbaH\v\x92\x01\b\x10\n" +
	"\"\x04\x1a\x02 \x00R\auserIds\x12$\n" +
	"\x06search\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x18@H\x02R\x06search\x88\x01\x01B\a\n" +
	"\x05_sortB\x13\n" +
	"\x11_qualification_idB\t\n" +
	"\a_search\"\xc9\x01\n" +
	"!ListQualificationsResultsResponse\x12U\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2-.resources.common.database.PaginationResponseB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x12M\n" +
	"\aresults\x18\x02 \x03(\v2-.resources.qualifications.QualificationResultB\x04\xc8\xf3\x18\x01R\aresults\"\xd0\x01\n" +
	"(CreateOrUpdateQualificationResultRequest\x12M\n" +
	"\x06result\x18\x01 \x01(\v2-.resources.qualifications.QualificationResultB\x06\xbaH\x03\xc8\x01\x01R\x06result\x12I\n" +
