...
type ListQualificationsResponse struct {
	...
	xxx_hidden_Qualifications *[]*qualifications.Qualification `protobuf:"bytes,2,rep,name=qualifications,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
type GetQualificationRequest struct {
	...
	xxx_hidden_WithExam        bool                   `protobuf:"varint,2,opt,name=with_exam,json=withExam,proto3,oneof"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
func (b0 GetQualificationRequest_builder) Build() *GetQualificationRequest {
	...
	if b.WithExam != nil {
		...
		x.xxx_hidden_WithExam = *b.WithExam
	}
	return m0
}
...
type GetQualificationResponse struct {
	state                    protoimpl.MessageState        `protogen:"opaque.v1"`
	xxx_hidden_Qualification *qualifications.Qualification `protobuf:"bytes,1,opt,name=qualification,proto3"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type GetQualificationAccessResponse struct {
	state             protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_Access *access.QualificationAccess `protobuf:"bytes,1,opt,name=access,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type SetQualificationAccessRequest struct {
	state                      protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_QualificationId int64                       `protobuf:"varint,1,opt,name=qualification_id,json=qualificationId,proto3"`
	xxx_hidden_Access          *access.QualificationAccess `protobuf:"bytes,2,opt,name=access,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type ListQualificationRequestsRequest struct {
	...
	xxx_hidden_Pagination      *database.PaginationRequest    `protobuf:"bytes,1,opt,name=pagination,proto3"`
	xxx_hidden_Sort            *database.Sort                 `protobuf:"bytes,2,opt,name=sort,proto3,oneof"`
	xxx_hidden_QualificationId int64                          `protobuf:"varint,3,opt,name=qualification_id,json=qualificationId,proto3,oneof"`
	xxx_hidden_Status          []qualifications.RequestStatus `protobuf:"varint,4,rep,packed,name=status,proto3,enum=resources.qualifications.RequestStatus"`
...
func (x *ListQualificationRequestsRequest) ClearQualificationId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_QualificationId = 0
}
...
type ListQualificationRequestsResponse struct {
	state                 protoimpl.MessageState                  `protogen:"opaque.v1"`
	xxx_hidden_Pagination *database.PaginationResponse            `protobuf:"bytes,1,opt,name=pagination,proto3"`
	xxx_hidden_Requests   *[]*qualifications.QualificationRequest `protobuf:"bytes,2,rep,name=requests,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type CreateOrUpdateQualificationRequestRequest struct {
	state              protoimpl.MessageState               `protogen:"opaque.v1"`
	xxx_hidden_Request *qualifications.QualificationRequest `protobuf:"bytes,1,opt,name=request,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type ListQualificationsResultsRequest struct {
	...
	xxx_hidden_Sort            *database.Sort                `protobuf:"bytes,2,opt,name=sort,proto3,oneof"`
	xxx_hidden_QualificationId int64                         `protobuf:"varint,3,opt,name=qualification_id,json=qualificationId,proto3,oneof"`
	xxx_hidden_Status          []qualifications.ResultStatus `protobuf:"varint,4,rep,packed,name=status,proto3,enum=resources.qualifications.ResultStatus"`
	xxx_hidden_UserId          int32                         `protobuf:"varint,5,opt,name=user_id,json=userId,proto3,oneof"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
...
type ListQualificationsResultsResponse struct {
	state                 protoimpl.MessageState                 `protogen:"opaque.v1"`
	xxx_hidden_Pagination *database.PaginationResponse           `protobuf:"bytes,1,opt,name=pagination,proto3"`
	xxx_hidden_Results    *[]*qualifications.QualificationResult `protobuf:"bytes,2,rep,name=results,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type CreateOrUpdateQualificationResultRequest struct {
	state              protoimpl.MessageState              `protogen:"opaque.v1"`
	xxx_hidden_Result  *qualifications.QualificationResult `protobuf:"bytes,1,opt,name=result,proto3"`
	xxx_hidden_Grading *exam.ExamGrading                   `protobuf:"bytes,2,opt,name=grading,proto3,oneof"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type DeleteQualificationResultRequest struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ResultId int64                  `protobuf:"varint,1,opt,name=result_id,json=resultId,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (b0 DeleteQualificationResultRequest_builder) Build() *DeleteQualificationResultRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_ResultId = b.ResultId
	return m0
}
...
var file_services_qualifications_qualifications_proto_depIdxs = []int32{
	...
	50, // 49: services.qualifications.QualificationsService.UploadFile:input_type -> resources.file.UploadFileRequest
	...
	51, // 65: services.qualifications.QualificationsService.UploadFile:output_type -> resources.file.UploadFileResponse
