...
type ListQualificationActivityRequest struct {
	...
	xxx_hidden_Types           []activity.QualificationActivityType `protobuf:"varint,4,rep,packed,name=types,proto3,enum=resources.qualifications.activity.QualificationActivityType"`
...
type ListQualificationActivityResponse struct {
	state                 protoimpl.MessageState             `protogen:"opaque.v1"`
	xxx_hidden_Pagination *database.PaginationResponse       `protobuf:"bytes,1,opt,name=pagination,proto3"`
	xxx_hidden_Activity   *[]*activity.QualificationActivity `protobuf:"bytes,2,rep,name=activity,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type CreateOrUpdateQualificationRequestRequest struct {
	...
	xxx_hidden_SkipNotification bool                                 `protobuf:"varint,2,opt,name=skip_notification,json=skipNotification,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
type DeleteQualificationReqRequest struct {
	...
	xxx_hidden_SkipNotification bool                   `protobuf:"varint,3,opt,name=skip_notification,json=skipNotification,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
