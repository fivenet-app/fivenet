...
const file_services_qualifications_qualifications_proto_rawDesc = "" +
	...
	"\x10qualification_id\x18\x01 \x01(\x03R\x0fqualificationId\"v\n" +
	"\x1eGetQualificationAccessResponse\x12T\n" +
	"\x06access\x18\x01 \x01(\v24.resources.qualifications.access.QualificationAccessB\x06\xbaH\x03\xc8\x01\x01R\x06access\"\xa0\x01\n" +
	"\x1dSetQualificationAccessRequest\x12)\n" +
	"\x10qualification_id\x18\x01 \x01(\x03R\x0fqualificationId\x12T\n" +
	"\x06access\x18\x02 \x01(\v24.resources.qualifications.access.QualificationAccessB\x06\xbaH\x03\xc8\x01\x01R\x06access\" \n" +
	"\x1eSetQualificationAccessResponse\"\x83\x03\n" +
	" ListQualificationRequestsRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x128\n" +
	"\x04sort\x18\x02 \x01(\v2\x1f.resources.common.database.SortH\x00R\x04sort\x88\x01\x01\x12.\n" +
	"\x10qualification_id\x18\x03 \x01(\x03H\x01R\x0fqualificationId\x88\x01\x01\x12N\n" +
	"\x06status\x18\x04 \x03(\x0e2'.resources.qualifications.RequestStatusB\r\xbaH\n" +
	"\x92\x01\a\"\x05\x82\x01\x02\x10\x01R\x06status\x12%\n" +
	...
	"\x1eDeleteQualificationReqResponse\"\x82\x03\n" +
	" ListQualificationsResultsRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x128\n" +
	"\x04sort\x18\x02 \x01(\v2\x1f.resources.common.database.SortH\x00R\x04sort\x88\x01\x01\x12.\n" +
	"\x10qualification_id\x18\x03 \x01(\x03H\x01R\x0fqualificationId\x88\x01\x01\x12M\n" +
	"\x06status\x18\x04 \x03(\x0e2&.resources.qualifications.ResultStatusB\r\xbaH\n" +
	"\x92\x01\a\"\x05\x82\x01\x02\x10\x01R\x06status\x12%\n" +
	"\auser_id\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00H\x02R\x06userId\x88\x01\x01B\a\n" +
	"\x05_sortB\x13\n" +
	"\x11_qualification_idB\n" +
