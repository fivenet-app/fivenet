...
var file_services_qualifications_qualifications_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x68, 0x0a, 0x0f, 0x54, 0x61, 0x6b, 0x65, 0x45, 0x78, 0x61, 0x6d, 0x52, 0x65,
	...
	0x01, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x22, 0x4f, 0x0a, 0x10,
	0x54, 0x61, 0x6b, 0x65, 0x45, 0x78, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x3b, 0x0a, 0x04, 0x65, 0x78, 0x61, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27,
	...
	0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x04, 0x65, 0x78, 0x61, 0x6d, 0x22, 0x89, 0x01,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x88, 0x0e, 0x0a, 0x15, 0x51, 0x75, 0x61, 0x6c, 0x69,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f, 0x0a, 0x08, 0x54, 0x61, 0x6b,
...
var file_services_qualifications_qualifications_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_services_qualifications_qualifications_proto_goTypes = []interface{}{
	...
	(*TakeExamRequest)(nil),                            // 26: services.qualifications.TakeExamRequest
	(*TakeExamResponse)(nil),                           // 27: services.qualifications.TakeExamResponse
	(*SubmitExamRequest)(nil),                          // 28: services.qualifications.SubmitExamRequest
	(*SubmitExamResponse)(nil),                         // 29: services.qualifications.SubmitExamResponse
	...
	(*qualifications.Qualification)(nil),               // 32: resources.qualifications.Qualification
	(*qualifications.QualificationAccess)(nil),         // 33: resources.qualifications.QualificationAccess
	(qualifications.AccessLevelUpdateMode)(0),          // 34: resources.qualifications.AccessLevelUpdateMode
	(qualifications.RequestStatus)(0),                  // 35: resources.qualifications.RequestStatus
	(*qualifications.QualificationRequest)(nil),        // 36: resources.qualifications.QualificationRequest
	(qualifications.ResultStatus)(0),                   // 37: resources.qualifications.ResultStatus
	(*qualifications.QualificationResult)(nil),         // 38: resources.qualifications.QualificationResult
	(*qualifications.ExamQuestions)(nil),               // 39: resources.qualifications.ExamQuestions
	(*qualifications.ExamResponses)(nil),               // 40: resources.qualifications.ExamResponses
	(*durationpb.Duration)(nil),                        // 41: google.protobuf.Duration
}
var file_services_qualifications_qualifications_proto_depIdxs = []int32{
	30, // 0: services.qualifications.ListQualificationsRequest.pagination:type_name -> resources.common.database.PaginationRequest
	31, // 1: services.qualifications.ListQualificationsResponse.pagination:type_name -> resources.common.database.PaginationResponse
	32, // 2: services.qualifications.ListQualificationsResponse.qualifications:type_name -> resources.qualifications.Qualification
	32, // 3: services.qualifications.GetQualificationResponse.qualification:type_name -> resources.qualifications.Qualification
	32, // 4: services.qualifications.CreateQualificationRequest.qualification:type_name -> resources.qualifications.Qualification
	32, // 5: services.qualifications.UpdateQualificationRequest.qualification:type_name -> resources.qualifications.Qualification
	33, // 6: services.qualifications.GetQualificationAccessResponse.access:type_name -> resources.qualifications.QualificationAccess
	34, // 7: services.qualifications.SetQualificationAccessRequest.mode:type_name -> resources.qualifications.AccessLevelUpdateMode
	33, // 8: services.qualifications.SetQualificationAccessRequest.access:type_name -> resources.qualifications.QualificationAccess
	30, // 9: services.qualifications.ListQualificationRequestsRequest.pagination:type_name -> resources.common.database.PaginationRequest
	35, // 10: services.qualifications.ListQualificationRequestsRequest.status:type_name -> resources.qualifications.RequestStatus
	31, // 11: services.qualifications.ListQualificationRequestsResponse.pagination:type_name -> resources.common.database.PaginationResponse
	36, // 12: services.qualifications.ListQualificationRequestsResponse.requests:type_name -> resources.qualifications.QualificationRequest
	36, // 13: services.qualifications.CreateOrUpdateQualificationRequestRequest.request:type_name -> resources.qualifications.QualificationRequest
	36, // 14: services.qualifications.CreateOrUpdateQualificationRequestResponse.request:type_name -> resources.qualifications.QualificationRequest
	30, // 15: services.qualifications.ListQualificationsResultsRequest.pagination:type_name -> resources.common.database.PaginationRequest
	37, // 16: services.qualifications.ListQualificationsResultsRequest.status:type_name -> resources.qualifications.ResultStatus
	31, // 17: services.qualifications.ListQualificationsResultsResponse.pagination:type_name -> resources.common.database.PaginationResponse
	38, // 18: services.qualifications.ListQualificationsResultsResponse.results:type_name -> resources.qualifications.QualificationResult
	38, // 19: services.qualifications.CreateOrUpdateQualificationResultRequest.result:type_name -> resources.qualifications.QualificationResult
	38, // 20: services.qualifications.CreateOrUpdateQualificationResultResponse.result:type_name -> resources.qualifications.QualificationResult
	39, // 21: services.qualifications.TakeExamResponse.exam:type_name -> resources.qualifications.ExamQuestions
	40, // 22: services.qualifications.SubmitExamRequest.responses:type_name -> resources.qualifications.ExamResponses
	41, // 23: services.qualifications.SubmitExamResponse.duration:type_name -> google.protobuf.Duration
	...
	26, // 35: services.qualifications.QualificationsService.TakeExam:input_type -> services.qualifications.TakeExamRequest
	28, // 36: services.qualifications.QualificationsService.SubmitExam:input_type -> services.qualifications.SubmitExamRequest
	1,  // 37: services.qualifications.QualificationsService.ListQualifications:output_type -> services.qualifications.ListQualificationsResponse
	3,  // 38: services.qualifications.QualificationsService.GetQualification:output_type -> services.qualifications.GetQualificationResponse
	5,  // 39: services.qualifications.QualificationsService.CreateQualification:output_type -> services.qualifications.CreateQualificationResponse
	7,  // 40: services.qualifications.QualificationsService.UpdateQualification:output_type -> services.qualifications.UpdateQualificationResponse
	9,  // 41: services.qualifications.QualificationsService.DeleteQualification:output_type -> services.qualifications.DeleteQualificationResponse
	15, // 42: services.qualifications.QualificationsService.ListQualificationRequests:output_type -> services.qualifications.ListQualificationRequestsResponse
	17, // 43: services.qualifications.QualificationsService.CreateOrUpdateQualificationRequest:output_type -> services.qualifications.CreateOrUpdateQualificationRequestResponse
	19, // 44: services.qualifications.QualificationsService.DeleteQualificationReq:output_type -> services.qualifications.DeleteQualificationReqResponse
	21, // 45: services.qualifications.QualificationsService.ListQualificationsResults:output_type -> services.qualifications.ListQualificationsResultsResponse
	23, // 46: services.qualifications.QualificationsService.CreateOrUpdateQualificationResult:output_type -> services.qualifications.CreateOrUpdateQualificationResultResponse
	25, // 47: services.qualifications.QualificationsService.DeleteQualificationResult:output_type -> services.qualifications.DeleteQualificationResultResponse
	27, // 48: services.qualifications.QualificationsService.TakeExam:output_type -> services.qualifications.TakeExamResponse
	29, // 49: services.qualifications.QualificationsService.SubmitExam:output_type -> services.qualifications.SubmitExamResponse
...
func file_services_qualifications_qualifications_proto_init() {
	...
	file_services_qualifications_qualifications_proto_msgTypes[26].OneofWrappers = []interface{}{}
	type x struct{}
