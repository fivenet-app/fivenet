...
func NewTestExamServiceClient(srv ExamServiceServer) (ExamServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterExamServiceServer(server, srv)
	go func() {
	...
	client := NewExamServiceClient(conn)
