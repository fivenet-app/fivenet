...
type NotificationsServiceClient interface {
	...
	// @perm: Name=Any
	Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamMessage, StreamResponse], error)
}
...
func (c *notificationsServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamMessage, StreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type NotificationsService_StreamClient = grpc.BidiStreamingClient[StreamMessage, StreamResponse]
...
type NotificationsServiceServer interface {
	...
	// @perm: Name=Any
	Stream(grpc.BidiStreamingServer[StreamMessage, StreamResponse]) error
...
func (UnimplementedNotificationsServiceServer) Stream(grpc.BidiStreamingServer[StreamMessage, StreamResponse]) error {
...
func _NotificationsService_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(NotificationsServiceServer).Stream(&grpc.GenericServerStream[StreamMessage, StreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type NotificationsService_StreamServer = grpc.BidiStreamingServer[StreamMessage, StreamResponse]
