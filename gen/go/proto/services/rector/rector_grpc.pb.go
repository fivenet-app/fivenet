...
type RectorServiceClient interface {
	...
	// @perm: Name=SuperUser
	CreateOrUpdateLawBook(ctx context.Context, in *laws.LawBook, opts ...grpc.CallOption) (*laws.LawBook, error)
	// @perm: Name=SuperUser
	DeleteLawBook(ctx context.Context, in *DeleteLawBookRequest, opts ...grpc.CallOption) (*DeleteLawBookResponse, error)
	// @perm: Name=SuperUser
	CreateOrUpdateLaw(ctx context.Context, in *laws.Law, opts ...grpc.CallOption) (*laws.Law, error)
	// @perm: Name=SuperUser
...
func (c *rectorServiceClient) GetJobProps(ctx context.Context, in *GetJobPropsRequest, opts ...grpc.CallOption) (*GetJobPropsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_GetJobProps_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) SetJobProps(ctx context.Context, in *SetJobPropsRequest, opts ...grpc.CallOption) (*SetJobPropsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_SetJobProps_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) GetRoles(ctx context.Context, in *GetRolesRequest, opts ...grpc.CallOption) (*GetRolesResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_GetRoles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) GetRole(ctx context.Context, in *GetRoleRequest, opts ...grpc.CallOption) (*GetRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_GetRole_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) CreateRole(ctx context.Context, in *CreateRoleRequest, opts ...grpc.CallOption) (*CreateRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_CreateRole_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) DeleteRole(ctx context.Context, in *DeleteRoleRequest, opts ...grpc.CallOption) (*DeleteRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_DeleteRole_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) UpdateRolePerms(ctx context.Context, in *UpdateRolePermsRequest, opts ...grpc.CallOption) (*UpdateRolePermsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_UpdateRolePerms_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) GetPermissions(ctx context.Context, in *GetPermissionsRequest, opts ...grpc.CallOption) (*GetPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_GetPermissions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) ViewAuditLog(ctx context.Context, in *ViewAuditLogRequest, opts ...grpc.CallOption) (*ViewAuditLogResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_ViewAuditLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) UpdateRoleLimits(ctx context.Context, in *UpdateRoleLimitsRequest, opts ...grpc.CallOption) (*UpdateRoleLimitsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RectorService_UpdateRoleLimits_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rectorServiceClient) CreateOrUpdateLawBook(ctx context.Context, in *laws.LawBook, opts ...grpc.CallOption) (*laws.LawBook, error) {
	out := new(laws.LawBook)
...
func (c *rectorServiceClient) CreateOrUpdateLaw(ctx context.Context, in *laws.Law, opts ...grpc.CallOption) (*laws.Law, error) {
	out := new(laws.Law)
...
type RectorServiceServer interface {
	...
	// @perm: Name=SuperUser
	CreateOrUpdateLawBook(context.Context, *laws.LawBook) (*laws.LawBook, error)
	// @perm: Name=SuperUser
	DeleteLawBook(context.Context, *DeleteLawBookRequest) (*DeleteLawBookResponse, error)
	// @perm: Name=SuperUser
	CreateOrUpdateLaw(context.Context, *laws.Law) (*laws.Law, error)
	// @perm: Name=SuperUser
...
func (UnimplementedRectorServiceServer) CreateOrUpdateLawBook(context.Context, *laws.LawBook) (*laws.LawBook, error) {
...
func (UnimplementedRectorServiceServer) CreateOrUpdateLaw(context.Context, *laws.Law) (*laws.Law, error) {
...
func _RectorService_CreateOrUpdateLawBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RectorServiceServer).CreateOrUpdateLawBook(ctx, req.(*laws.LawBook))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RectorService_CreateOrUpdateLaw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RectorServiceServer).CreateOrUpdateLaw(ctx, req.(*laws.Law))
	}
	return interceptor(ctx, in, info, handler)
}
