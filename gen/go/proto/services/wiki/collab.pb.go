...
const file_services_wiki_collab_proto_rawDesc = "" +
	"\n" +
	"\x1aservices/wiki/collab.proto\x12\rservices.wiki\x1a\x1dresources/collab/collab.proto2c\n" +
	"\rCollabService\x12R\n" +
	"\fJoinDocument\x12\x1e.resources.collab.ClientPacket\x1a\x1e.resources.collab.ServerPacket(\x010\x01BFZDgithub.com/fivenet-app/fivenet/v2025/gen/go/proto/services/wiki;wikib\x06proto3"
...
var file_services_wiki_collab_proto_depIdxs = []int32{
	0, // 0: services.wiki.CollabService.JoinDocument:input_type -> resources.collab.ClientPacket
	1, // 1: services.wiki.CollabService.JoinDocument:output_type -> resources.collab.ServerPacket
