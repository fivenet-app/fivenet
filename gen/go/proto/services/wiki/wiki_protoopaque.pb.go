...
const file_services_wiki_wiki_proto_rawDesc = "" +
	...
	"\x12DeletePageResponse\"\xa2\x01\n" +
	"\x0fMovePageRequest\x12 \n" +
	"\apage_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\x06pageId\x12)\n" +
	...
	"_before_idB\v\n" +
	"\t_after_id\"\x12\n" +
	"\x10MovePageResponse\"\x88\x01\n" +
	"\x17ListPageActivityRequest\x12T\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"pagination\x12\x17\n" +
	"\apage_id\x18\x02 \x01(\x03R\x06pageId\"\xba\x01\n" +
	...
	"\n" +
	"UpdatePage\x12 .services.wiki.UpdatePageRequest\x1a!.services.wiki.UpdatePageResponse\"2\xd2\xf3\x18.\b\x01*\n" +
	"UpdatePage*\n" +
	"CreatePage:\x12\n" +
