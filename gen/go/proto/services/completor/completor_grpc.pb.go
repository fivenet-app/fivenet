...
func (c *completorServiceClient) CompleteCitizens(ctx context.Context, in *CompleteCitizensRequest, opts ...grpc.CallOption) (*CompleteCitizensResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompleteCitizensResponse)
...
func (UnimplementedCompletorServiceServer) CompleteCitizens(context.Context, *CompleteCitizensRequest) (*CompleteCitizensResponse, error) {
