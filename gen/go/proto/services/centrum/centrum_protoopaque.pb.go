...
func (x *StreamResponse) GetSettingsDeleted() string {
	if x != nil {
		if x, ok := x.xxx_hidden_Change.(*streamResponse_SettingsDeleted); ok {
...
func (x *StreamResponse) SetSettingsDeleted(v string) {
	x.xxx_hidden_Change = &streamResponse_SettingsDeleted{v}
}
...
func (x *StreamResponse) HasSettingsDeleted() bool {
	...
	_, ok := x.xxx_hidden_Change.(*streamResponse_SettingsDeleted)
	return ok
}
...
func (x *StreamResponse) ClearSettingsDeleted() {
	if _, ok := x.xxx_hidden_Change.(*streamResponse_SettingsDeleted); ok {
		x.xxx_hidden_Change = nil
	}
}
...
func (b0 StreamResponse_builder) Build() *StreamResponse {
	...
	if b.SettingsDeleted != nil {
		x.xxx_hidden_Change = &streamResponse_SettingsDeleted{*b.SettingsDeleted}
	}
	return m0
}
