...
const file_services_centrum_units_proto_rawDesc = "" +
	...
	"\x10ListUnitsRequest\x12L\n" +
	"\x06status\x18\x01 \x03(\x0e2#.resources.centrum.units.StatusUnitB\x0f\xbaH\f\x92\x01\t\x10\a\"\x05\x82\x01\x02\x10\x01R\x06status\"N\n" +
	...
	"\x14ReorderUnitsResponse\"t\n" +
	"\x11AssignUnitRequest\x12\x17\n" +
	"\aunit_id\x18\x01 \x01(\x03R\x06unitId\x12\x1f\n" +
	"\x06to_add\x18\x02 \x03(\x05B\b\xbaH\x05\x92\x01\x02\x10\x1eR\x05toAdd\x12%\n" +
	"\tto_remove\x18\x03 \x03(\x05B\b\xbaH\x05\x92\x01\x02\x10\x1eR\btoRemove\"\x14\n" +
