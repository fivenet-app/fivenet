...
func NewTestUnitsServiceClient(srv UnitsServiceServer) (UnitsServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterUnitsServiceServer(server, srv)
	go func() {
	...
	client := NewUnitsServiceClient(conn)
