...
var file_services_citizenstore_citizenstore_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x19, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x66,
	0x69, 0x6c, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x06, 0x61,
	0x76, 0x61, 0x74, 0x61, 0x72, 0x32, 0xae, 0x04, 0x0a, 0x13, 0x43, 0x69, 0x74, 0x69, 0x7a, 0x65,
...
var file_services_citizenstore_citizenstore_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_services_citizenstore_citizenstore_proto_goTypes = []interface{}{
	...
	(*users.UserProps)(nil),             // 14: resources.users.UserProps
	(*filestore.File)(nil),              // 15: resources.filestore.File
}
var file_services_citizenstore_citizenstore_proto_depIdxs = []int32{
	10, // 0: services.citizenstore.ListCitizensRequest.pagination:type_name -> resources.common.database.PaginationRequest
	11, // 1: services.citizenstore.ListCitizensResponse.pagination:type_name -> resources.common.database.PaginationResponse
	12, // 2: services.citizenstore.ListCitizensResponse.users:type_name -> resources.users.User
	12, // 3: services.citizenstore.GetUserResponse.user:type_name -> resources.users.User
	10, // 4: services.citizenstore.ListUserActivityRequest.pagination:type_name -> resources.common.database.PaginationRequest
	11, // 5: services.citizenstore.ListUserActivityResponse.pagination:type_name -> resources.common.database.PaginationResponse
	13, // 6: services.citizenstore.ListUserActivityResponse.activity:type_name -> resources.users.UserActivity
	14, // 7: services.citizenstore.SetUserPropsRequest.props:type_name -> resources.users.UserProps
	14, // 8: services.citizenstore.SetUserPropsResponse.props:type_name -> resources.users.UserProps
	15, // 9: services.citizenstore.SetProfilePictureRequest.avatar:type_name -> resources.filestore.File
	15, // 10: services.citizenstore.SetProfilePictureResponse.avatar:type_name -> resources.filestore.File
	0,  // 11: services.citizenstore.CitizenStoreService.ListCitizens:input_type -> services.citizenstore.ListCitizensRequest
	2,  // 12: services.citizenstore.CitizenStoreService.GetUser:input_type -> services.citizenstore.GetUserRequest
	4,  // 13: services.citizenstore.CitizenStoreService.ListUserActivity:input_type -> services.citizenstore.ListUserActivityRequest
	6,  // 14: services.citizenstore.CitizenStoreService.SetUserProps:input_type -> services.citizenstore.SetUserPropsRequest
	8,  // 15: services.citizenstore.CitizenStoreService.SetProfilePicture:input_type -> services.citizenstore.SetProfilePictureRequest
	1,  // 16: services.citizenstore.CitizenStoreService.ListCitizens:output_type -> services.citizenstore.ListCitizensResponse
	3,  // 17: services.citizenstore.CitizenStoreService.GetUser:output_type -> services.citizenstore.GetUserResponse
	5,  // 18: services.citizenstore.CitizenStoreService.ListUserActivity:output_type -> services.citizenstore.ListUserActivityResponse
	7,  // 19: services.citizenstore.CitizenStoreService.SetUserProps:output_type -> services.citizenstore.SetUserPropsResponse
	9,  // 20: services.citizenstore.CitizenStoreService.SetProfilePicture:output_type -> services.citizenstore.SetProfilePictureResponse
