...
func file_services_citizenstore_citizenstore_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_citizenstore_citizenstore_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_citizenstore_citizenstore_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_citizenstore_citizenstore_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_citizenstore_citizenstore_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_citizenstore_citizenstore_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
