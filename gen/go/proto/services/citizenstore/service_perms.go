			...
			Attrs: []perms.Attr{
				{
					...
					ValidValues: []string{"PhoneNumber", "Licenses", "UserProps.Wanted", "UserProps.Job", "UserProps.TrafficInfractionPoints", "UserProps.OpenFines", "UserProps.BloodType", "UserProps.Picture", "UserProps.Picture.Update"},
				},
			},
		},
		{
