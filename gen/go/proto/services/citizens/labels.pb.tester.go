...
func NewTestLabelsServiceClient(srv LabelsServiceServer) (LabelsServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterLabelsServiceServer(server, srv)
	go func() {
	...
	client := NewLabelsServiceClient(conn)
