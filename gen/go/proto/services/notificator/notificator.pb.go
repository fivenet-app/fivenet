...
func (x *StreamResponse) GetJobProps() *users.JobProps {
	if x, ok := x.GetData().(*StreamResponse_JobProps); ok {
		return x.JobProps
	}
	return nil
}
...
type StreamResponse_JobProps struct {
	JobProps *users.JobProps `protobuf:"bytes,5,opt,name=job_props,json=jobProps,proto3,oneof"`
}
...
func (*StreamResponse_JobProps) isStreamResponse_Data() {}
...
var file_services_notificator_notificator_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa0, 0x02, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x38, 0x0a, 0x09, 0x6a, 0x6f,
	0x62, 0x5f, 0x70, 0x72, 0x6f, 0x70, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	...
	0x72, 0x6f, 0x70, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x0a, 0x0a, 0x08,
	0x5f, 0x72, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x32, 0xd4, 0x02, 0x0a, 0x12, 0x4e, 0x6f, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x71, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x12, 0x2d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x6e,
	...
	0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x6e, 0x6f,
	...
	0x73, 0x65, 0x12, 0x74, 0x0a, 0x11, 0x4d, 0x61, 0x72, 0x6b, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x2e, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4d,
	...
	0x65, 0x73, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4d,
	0x61, 0x72, 0x6b, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x55, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x12, 0x23, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x6e, 0x6f,
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x74, 0x6f, 0x72, 0x3b, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x62,
...
var file_services_notificator_notificator_proto_goTypes = []interface{}{
	...
	(*users.JobProps)(nil),                  // 10: resources.users.JobProps
}
var file_services_notificator_notificator_proto_depIdxs = []int32{
	...
	9,  // 4: services.notificator.StreamResponse.notification:type_name -> resources.notifications.Notification
	10, // 5: services.notificator.StreamResponse.job_props:type_name -> resources.users.JobProps
	0,  // 6: services.notificator.NotificatorService.GetNotifications:input_type -> services.notificator.GetNotificationsRequest
	2,  // 7: services.notificator.NotificatorService.MarkNotifications:input_type -> services.notificator.MarkNotificationsRequest
	4,  // 8: services.notificator.NotificatorService.Stream:input_type -> services.notificator.StreamRequest
	1,  // 9: services.notificator.NotificatorService.GetNotifications:output_type -> services.notificator.GetNotificationsResponse
	3,  // 10: services.notificator.NotificatorService.MarkNotifications:output_type -> services.notificator.MarkNotificationsResponse
	5,  // 11: services.notificator.NotificatorService.Stream:output_type -> services.notificator.StreamResponse
