...
type ListCalendarsRequest struct {
	...
	xxx_hidden_OnlyPublic     bool                        `protobuf:"varint,2,opt,name=only_public,json=onlyPublic,proto3"`
	xxx_hidden_MinAccessLevel access.AccessLevel          `protobuf:"varint,3,opt,name=min_access_level,json=minAccessLevel,proto3,enum=resources.calendar.access.AccessLevel,oneof"`
	xxx_hidden_After          *timestamp.Timestamp        `protobuf:"bytes,4,opt,name=after,proto3,oneof"`
	xxx_hidden_CalendarIds    []int64                     `protobuf:"varint,5,rep,packed,name=calendar_ids,json=calendarIds,proto3"`
...
func (x *ListCalendarsRequest) GetOnlyPublic() bool {
	if x != nil {
		return x.xxx_hidden_OnlyPublic
	}
	return false
}
...
func (x *ListCalendarsRequest) GetMinAccessLevel() access.AccessLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 2) {
			return x.xxx_hidden_MinAccessLevel
		}
	}
...
func (x *ListCalendarsRequest) ClearMinAccessLevel() {
	...
	x.xxx_hidden_MinAccessLevel = access.AccessLevel_ACCESS_LEVEL_UNSPECIFIED
}
...
func (b0 ListCalendarsRequest_builder) Build() *ListCalendarsRequest {
	...
	x.xxx_hidden_OnlyPublic = b.OnlyPublic
	if b.MinAccessLevel != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 5)
		x.xxx_hidden_MinAccessLevel = *b.MinAccessLevel
	}
...
type ListCalendarsResponse struct {
	...
	xxx_hidden_Calendars  *[]*calendar.Calendar        `protobuf:"bytes,2,rep,name=calendars,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ListCalendarsResponse) GetCalendars() []*calendar.Calendar {
	if x != nil {
		if x.xxx_hidden_Calendars != nil {
			return *x.xxx_hidden_Calendars
		}
	}
	return nil
}
...
func (b0 ListCalendarsResponse_builder) Build() *ListCalendarsResponse {
	...
	_, _ = b, x
	x.xxx_hidden_Pagination = b.Pagination
	x.xxx_hidden_Calendars = &b.Calendars
	return m0
}
...
type GetCalendarResponse struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Calendar *calendar.Calendar     `protobuf:"bytes,1,opt,name=calendar,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type ListSubscriptionsResponse struct {
	state                 protoimpl.MessageState       `protogen:"opaque.v1"`
	xxx_hidden_Pagination *database.PaginationResponse `protobuf:"bytes,1,opt,name=pagination,proto3"`
	xxx_hidden_Subs       *[]*calendar.CalendarSub     `protobuf:"bytes,2,rep,name=subs,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ListSubscriptionsResponse) GetSubs() []*calendar.CalendarSub {
	if x != nil {
		if x.xxx_hidden_Subs != nil {
			return *x.xxx_hidden_Subs
		}
	}
	return nil
}
...
func (b0 ListSubscriptionsResponse_builder) Build() *ListSubscriptionsResponse {
	...
	_, _ = b, x
	x.xxx_hidden_Pagination = b.Pagination
	x.xxx_hidden_Subs = &b.Subs
	return m0
}

type SubscribeToCalendarRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Sub    *calendar.CalendarSub  `protobuf:"bytes,1,opt,name=sub,proto3"`
...
const file_services_calendar_calendar_proto_rawDesc = "" +
	"\n" +
	" services/calendar/calendar.proto\x12\x11services.calendar\x1a\x1fcodegen/itemslen/itemslen.proto\x1a\x19codegen/perms/perms.proto\x1a&resources/calendar/access/access.proto\x1a!resources/calendar/calendar.proto\x1a(resources/common/database/database.proto\x1a#resources/timestamp/timestamp.proto\"\xf5\x02\n" +
	...
	"onlyPublic\x12_\n" +
	"\x10min_access_level\x18\x03 \x01(\x0e2&.resources.calendar.access.AccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01H\x00R\x0eminAccessLevel\x88\x01\x01\x129\n" +
	"\x05after\x18\x04 \x01(\v2\x1e.resources.timestamp.TimestampH\x01R\x05after\x88\x01\x01\x12+\n" +
	"\fcalendar_ids\x18\x05 \x03(\x03B\b\xbaH\x05\x92\x01\x02\x102R\vcalendarIdsB\x13\n" +
