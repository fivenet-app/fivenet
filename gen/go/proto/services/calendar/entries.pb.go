...
type RSVPCalendarEntryRequest struct {
	...
	OccurrenceKey *string                    `protobuf:"bytes,4,opt,name=occurrence_key,json=occurrenceKey,proto3,oneof" json:"occurrence_key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_services_calendar_entries_proto_rawDesc = "" +
	"\n" +
	"\x1fservices/calendar/entries.proto\x12\x11services.calendar\x1a\x1fcodegen/itemslen/itemslen.proto\x1a\x19codegen/perms/perms.proto\x1a(resources/calendar/entries/entries.proto\x1a(resources/common/database/database.proto\x1a#resources/timestamp/timestamp.proto\"\x83\x02\n" +
	...
	"\fcalendar_ids\x18\x03 \x03(\x03B\b\xbaH\x05\x92\x01\x02\x102R\vcalendarIds\x12$\n" +
	...
	"\x05entry\x18\x01 \x01(\v2).resources.calendar.entries.CalendarEntryR\x05entry\"\x92\x01\n" +
	"\"CreateOrUpdateCalendarEntryRequest\x12G\n" +
	"\x05entry\x18\x01 \x01(\v2).resources.calendar.entries.CalendarEntryB\x06\xbaH\x03\xc8\x01\x01R\x05entry\x12#\n" +
	"\buser_ids\x18\x02 \x03(\x05B\b\xbaH\x05\x92\x01\x02\x10\x19R\auserIds\"f\n" +
	...
	"\x1bDeleteCalendarEntryResponse\"[\n" +
	"\x19ShareCalendarEntryRequest\x12\x19\n" +
	"\bentry_id\x18\x01 \x01(\x03R\aentryId\x12#\n" +
	"\buser_ids\x18\x02 \x03(\x05B\b\xbaH\x05\x92\x01\x02\x10\x19R\auserIds\"\x1c\n" +
	...
	"pagination\x12\x19\n" +
	"\bentry_id\x18\x02 \x01(\x03R\aentryId\"\xc5\x01\n" +
	...
	"pagination\x12M\n" +
	"\aentries\x18\x02 \x03(\v2-.resources.calendar.entries.CalendarEntryRSVPB\x04\xc8\xf3\x18\x01R\aentries\"\xee\x01\n" +
	...
	"\x06remove\x18\x03 \x01(\bH\x00R\x06remove\x88\x01\x01\x124\n" +
	"\x0eoccurrence_key\x18\x04 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x01H\x01R\roccurrenceKey\x88\x01\x01B\t\n" +
	"\a_removeB\x11\n" +
