...
func NewTestCalendarServiceClient(srv CalendarServiceServer) (CalendarServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterCalendarServiceServer(server, srv)
	go func() {
