...
const file_services_calendar_calendar_proto_rawDesc = "" +
	"\n" +
	" services/calendar/calendar.proto\x12\x11services.calendar\x1a(resources/common/database/database.proto\x1a\x1fresources/calendar/access.proto\x1a!resources/calendar/calendar.proto\x1a#resources/timestamp/timestamp.proto\x1a\x17validate/validate.proto\"\xb9\x02\n" +
	"\x14ListCalendarsRequest\x12V\n" +
	"\n" +
	...
	"\x04year\x18\x01 \x01(\x05B\b\xfaB\x05\x1a\x03(\xe7\x0fR\x04year\x12\x1f\n" +
	"\x05month\x18\x02 \x01(\x05B\t\xfaB\x06\x1a\x04\x18\f(\x01R\x05month\x12!\n" +
	...
	"\x05entry\x18\x01 \x01(\v2!.resources.calendar.CalendarEntryR\x05entry\"\x82\x01\n" +
	"\"CreateOrUpdateCalendarEntryRequest\x12A\n" +
	"\x05entry\x18\x01 \x01(\v2!.resources.calendar.CalendarEntryB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05entry\x12\x19\n" +
	...
	"\x1aShareCalendarEntryResponse\"\x91\x01\n" +
	"\x1cListCalendarEntryRSVPRequest\x12V\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\b\xfaB\x05\x8a\x01\x02\x10\x01R\n" +
	"pagination\x12\x19\n" +
	"\bentry_id\x18\x02 \x01(\x04R\aentryId\"\xb9\x01\n" +
	"\x1dListCalendarEntryRSVPResponse\x12W\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2-.resources.common.database.PaginationResponseB\b\xfaB\x05\x8a\x01\x02\x10\x01R\n" +
	"pagination\x12?\n" +
	"\aentries\x18\x02 \x03(\v2%.resources.calendar.CalendarEntryRSVPR\aentries\"\x9d\x01\n" +
	...
	"\x06_entry\"r\n" +
	"\x18ListSubscriptionsRequest\x12V\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2,.resources.common.database.PaginationRequestB\b\xfaB\x05\x8a\x01\x02\x10\x01R\n" +
	"pagination\"\xa9\x01\n" +
	...
	"pagination\x18\x01 \x01(\v2-.resources.common.database.PaginationResponseB\b\xfaB\x05\x8a\x01\x02\x10\x01R\n" +
	"pagination\x123\n" +
	"\x04subs\x18\x02 \x03(\v2\x1f.resources.calendar.CalendarSubR\x04subs\"g\n" +
	...
	"\x10GetCalendarEntry\x12*.services.calendar.GetCalendarEntryRequest\x1a+.services.calendar.GetCalendarEntryResponse\x12\x8c\x01\n" +
	"\x1bCreateOrUpdateCalendarEntry\x125.services.calendar.CreateOrUpdateCalendarEntryRequest\x1a6.services.calendar.CreateOrUpdateCalendarEntryResponse\x12t\n" +
	"\x13DeleteCalendarEntry\x12-.services.calendar.DeleteCalendarEntryRequest\x1a..services.calendar.DeleteCalendarEntryResponse\x12q\n" +
	"\x12ShareCalendarEntry\x12,.services.calendar.ShareCalendarEntryRequest\x1a-.services.calendar.ShareCalendarEntryResponse\x12z\n" +
