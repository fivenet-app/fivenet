...
const file_services_auth_auth_proto_rawDesc = "" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\"\x80\x01\n" +
	"\fLoginRequest\x12E\n" +
	...
	"\aexpires\x18\x01 \x01(\v2\x1e.resources.timestamp.TimestampR\aexpires\"\xa1\x01\n" +
	"\x15ChangeUsernameRequest\x12C\n" +
	"\acurrent\x18\x01 \x01(\tB)\xbaH&r$\x10\x03\x18\x182\x1e(?i)^[0-9A-ZÄÖÜß_-]{3,24}$R\acurrent\x12C\n" +
	"\x03new\x18\x02 \x01(\tB1\xda\xf3\x18\x04\b\x01\x18\x01\xbaH&r$\x10\x03\x18\x182\x1e(?i)^[0-9A-ZÄÖÜß_-]{3,24}$R\x03new\"\x18\n" +
	...
	"\achar_id\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x06charId\"\xef\x02\n" +
