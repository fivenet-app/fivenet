...
func NewTestMailerServiceClient(srv MailerServiceServer) (MailerServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterMailerServiceServer(server, srv)
	go func() {
	...
	client := NewMailerServiceClient(conn)
