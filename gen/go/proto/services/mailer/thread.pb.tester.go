...
func NewTestThreadServiceClient(srv ThreadServiceServer) (ThreadServiceClient, context.Context, context.CancelFunc) {
	...
	RegisterThreadServiceServer(server, srv)
	go func() {
	...
	client := NewThreadServiceClient(conn)
