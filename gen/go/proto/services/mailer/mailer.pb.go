...
const file_services_mailer_mailer_proto_rawDesc = "" +
	...
	"\x06thread\x18\x01 \x01(\v2\x18.resources.mailer.ThreadR\x06thread\"\xaf\x01\n" +
	"\x13CreateThreadRequest\x120\n" +
	"\x06thread\x18\x01 \x01(\v2\x18.resources.mailer.ThreadR\x06thread\x123\n" +
	"\amessage\x18\x02 \x01(\v2\x19.resources.mailer.MessageR\amessage\x121\n" +
	"\n" +
	"recipients\x18\x03 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\n" +
	"recipients\"H\n" +
	...
	"pagination\x18\x01 \x01(\v2-.resources.common.database.PaginationResponseR\n" +
	"pagination\x12;\n" +
	"\bmessages\x18\x02 \x03(\v2\x19.resources.mailer.MessageB\x04\xc8\xf3\x18\x01R\bmessages\"|\n" +
	"\x12PostMessageRequest\x123\n" +
	"\amessage\x18\x01 \x01(\v2\x19.resources.mailer.MessageR\amessage\x121\n" +
	"\n" +
	"recipients\x18\x02 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\n" +
	"recipients\"J\n" +
