...
const file_services_vehicles_vehicles_proto_rawDesc = "" +
	"\n" +
	" services/vehicles/vehicles.proto\x12\x11services.vehicles\x1a\x1fcodegen/itemslen/itemslen.proto\x1a\x19codegen/perms/perms.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a(resources/common/database/database.proto\x1a$resources/vehicles/props/props.proto\x1a!resources/vehicles/vehicles.proto\"\x9a\x03\n" +
	...
	"pagination\x12=\n" +
	"\bvehicles\x18\x02 \x03(\v2\x1b.resources.vehicles.VehicleB\x04\xc8\xf3\x18\x01R\bvehicles\"^\n" +
	"\x16SetVehiclePropsRequest\x12D\n" +
	"\x05props\x18\x01 \x01(\v2&.resources.vehicles.props.VehiclePropsB\x06\xbaH\x03\xc8\x01\x01R\x05props\"\x84\x01\n" +
	"\x17SetVehiclePropsResponse\x12<\n" +
	"\x05props\x18\x01 \x01(\v2&.resources.vehicles.props.VehiclePropsR\x05props\x12+\n" +
	"\x06reason\x18\x02 \x01(\tB\x13\xda\xf3\x18\x02\b\x01\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x03\x18\xff\x01R\x06reason2\xb0\x02\n" +
