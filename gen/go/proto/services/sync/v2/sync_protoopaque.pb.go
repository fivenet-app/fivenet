...
type SendUsersJobsRequest struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_UsersJobs *[]*v2.DataUserJobs    `protobuf:"bytes,1,rep,name=users_jobs,json=usersJobs,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SendUsersJobsRequest) GetUsersJobs() []*v2.DataUserJobs {
	if x != nil {
		if x.xxx_hidden_UsersJobs != nil {
			return *x.xxx_hidden_UsersJobs
		}
	}
	return nil
}
...
func (b0 SendUsersJobsRequest_builder) Build() *SendUsersJobsRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_UsersJobs = &b.UsersJobs
	return m0
}

type SendUsersPhoneNumbersRequest struct {
	state                        protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_UsersPhoneNumbers *[]*v2.DataUserPhoneNumbers `protobuf:"bytes,1,rep,name=users_phone_numbers,json=usersPhoneNumbers,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *SendUsersPhoneNumbersRequest) GetUsersPhoneNumbers() []*v2.DataUserPhoneNumbers {
	if x != nil {
		if x.xxx_hidden_UsersPhoneNumbers != nil {
			return *x.xxx_hidden_UsersPhoneNumbers
		}
	}
	return nil
}
...
func (x *SendUsersPhoneNumbersRequest) SetUsersPhoneNumbers(v []*v2.DataUserPhoneNumbers) {
	x.xxx_hidden_UsersPhoneNumbers = &v
}
...
func (b0 SendUsersPhoneNumbersRequest_builder) Build() *SendUsersPhoneNumbersRequest {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_UsersPhoneNumbers = &b.UsersPhoneNumbers
	return m0
}
