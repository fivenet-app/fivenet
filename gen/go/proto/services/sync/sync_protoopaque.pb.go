...
const file_services_sync_sync_proto_rawDesc = "" +
	...
	"\x06marker\x18\x01 \x01(\v2'.resources.livemap.markers.MarkerMarkerR\x06marker\"e\n" +
	...
	"\tAddMarker\x12\x1f.services.sync.AddMarkerRequest\x1a\".services.sync.AddActivityResponse\x12K\n" +
...
var file_services_sync_sync_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_services_sync_sync_proto_goTypes = []any{
	...
	(*AddUserActivityRequest)(nil),      // 9: services.sync.AddUserActivityRequest
	(*AddUserPropsRequest)(nil),         // 10: services.sync.AddUserPropsRequest
	(*AddColleagueActivityRequest)(nil), // 11: services.sync.AddColleagueActivityRequest
	(*AddColleaguePropsRequest)(nil),    // 12: services.sync.AddColleaguePropsRequest
	(*AddJobTimeclockRequest)(nil),      // 13: services.sync.AddJobTimeclockRequest
	(*AddAccountUpdateRequest)(nil),     // 14: services.sync.AddAccountUpdateRequest
	(*AddUserUpdateRequest)(nil),        // 15: services.sync.AddUserUpdateRequest
	(*AddActivityResponse)(nil),         // 16: services.sync.AddActivityResponse
	(*SendJobsRequest)(nil),             // 17: services.sync.SendJobsRequest
	(*SendLicensesRequest)(nil),         // 18: services.sync.SendLicensesRequest
	(*SendAccountsRequest)(nil),         // 19: services.sync.SendAccountsRequest
	(*SendUsersRequest)(nil),            // 20: services.sync.SendUsersRequest
	(*SendVehiclesRequest)(nil),         // 21: services.sync.SendVehiclesRequest
	(*SendUserLocationsRequest)(nil),    // 22: services.sync.SendUserLocationsRequest
	(*SetLastCharIDRequest)(nil),        // 23: services.sync.SetLastCharIDRequest
	(*SendDataResponse)(nil),            // 24: services.sync.SendDataResponse
	(*DeleteUsersRequest)(nil),          // 25: services.sync.DeleteUsersRequest
	(*DeleteVehiclesRequest)(nil),       // 26: services.sync.DeleteVehiclesRequest
	(*StreamResponse)(nil),              // 27: services.sync.StreamResponse
	(*AddActivityRequest)(nil),          // 28: services.sync.AddActivityRequest
	(*SendDataRequest)(nil),             // 29: services.sync.SendDataRequest
	(*DeleteDataRequest)(nil),           // 30: services.sync.DeleteDataRequest
	(*DeleteDataResponse)(nil),          // 31: services.sync.DeleteDataResponse
	(*StreamRequest)(nil),               // 32: services.sync.StreamRequest
	(*timestamp.Timestamp)(nil),         // 33: resources.timestamp.Timestamp
	(*data.DataStatus)(nil),             // 34: resources.sync.data.DataStatus
	(*activity.UserOAuth2Conn)(nil),     // 35: resources.sync.activity.UserOAuth2Conn
	(*dispatches.Dispatch)(nil),         // 36: resources.centrum.dispatches.Dispatch
	(*markers.MarkerMarker)(nil),        // 37: resources.livemap.markers.MarkerMarker
	(*activity1.UserActivity)(nil),      // 38: resources.users.activity.UserActivity
	(*activity.UserProps)(nil),          // 39: resources.sync.activity.UserProps
	(*activity2.ColleagueActivity)(nil), // 40: resources.jobs.colleagues.activity.ColleagueActivity
	(*activity.ColleagueProps)(nil),     // 41: resources.sync.activity.ColleagueProps
	(*activity.TimeclockUpdate)(nil),    // 42: resources.sync.activity.TimeclockUpdate
	(*activity.AccountUpdate)(nil),      // 43: resources.sync.activity.AccountUpdate
	(*activity.UserUpdate)(nil),         // 44: resources.sync.activity.UserUpdate
	(*jobs.Job)(nil),                    // 45: resources.jobs.Job
	(*licenses.License)(nil),            // 46: resources.citizens.licenses.License
	(*data.DataUser)(nil),               // 47: resources.sync.data.DataUser
	(*vehicles.Vehicle)(nil),            // 48: resources.vehicles.Vehicle
	(*data.CitizenLocations)(nil),       // 49: resources.sync.data.CitizenLocations
	(*data.LastCharID)(nil),             // 50: resources.sync.data.LastCharID
	(*data.DataJobs)(nil),               // 51: resources.sync.data.DataJobs
	(*data.DataLicenses)(nil),           // 52: resources.sync.data.DataLicenses
	(*data.DataAccounts)(nil),           // 53: resources.sync.data.DataAccounts
	(*data.DataUsers)(nil),              // 54: resources.sync.data.DataUsers
	(*data.DataVehicles)(nil),           // 55: resources.sync.data.DataVehicles
	(*data.DataUserLocations)(nil),      // 56: resources.sync.data.DataUserLocations
	(*data.DeleteUsers)(nil),            // 57: resources.sync.data.DeleteUsers
	(*data.DeleteVehicles)(nil),         // 58: resources.sync.data.DeleteVehicles
}
var file_services_sync_sync_proto_depIdxs = []int32{
	33, // 0: services.sync.GetStatusResponse.last_synced_data:type_name -> resources.timestamp.Timestamp
	33, // 1: services.sync.GetStatusResponse.last_synced_activity:type_name -> resources.timestamp.Timestamp
	34, // 2: services.sync.GetStatusResponse.jobs:type_name -> resources.sync.data.DataStatus
	34, // 3: services.sync.GetStatusResponse.licenses:type_name -> resources.sync.data.DataStatus
	34, // 4: services.sync.GetStatusResponse.users:type_name -> resources.sync.data.DataStatus
	34, // 5: services.sync.GetStatusResponse.vehicles:type_name -> resources.sync.data.DataStatus
	34, // 6: services.sync.GetStatusResponse.accounts:type_name -> resources.sync.data.DataStatus
	35, // 7: services.sync.AddUserOAuth2ConnRequest.user_oauth2:type_name -> resources.sync.activity.UserOAuth2Conn
	36, // 8: services.sync.AddDispatchRequest.dispatch:type_name -> resources.centrum.dispatches.Dispatch
	37, // 9: services.sync.AddMarkerRequest.marker:type_name -> resources.livemap.markers.MarkerMarker
	38, // 10: services.sync.AddUserActivityRequest.user_activity:type_name -> resources.users.activity.UserActivity
	39, // 11: services.sync.AddUserPropsRequest.user_props:type_name -> resources.sync.activity.UserProps
	40, // 12: services.sync.AddColleagueActivityRequest.colleague_activity:type_name -> resources.jobs.colleagues.activity.ColleagueActivity
	41, // 13: services.sync.AddColleaguePropsRequest.colleague_props:type_name -> resources.sync.activity.ColleagueProps
	42, // 14: services.sync.AddJobTimeclockRequest.job_timeclock:type_name -> resources.sync.activity.TimeclockUpdate
	43, // 15: services.sync.AddAccountUpdateRequest.account_update:type_name -> resources.sync.activity.AccountUpdate
	44, // 16: services.sync.AddUserUpdateRequest.user_update:type_name -> resources.sync.activity.UserUpdate
	33, // 17: services.sync.AddActivityResponse.created_at:type_name -> resources.timestamp.Timestamp
	45, // 18: services.sync.SendJobsRequest.jobs:type_name -> resources.jobs.Job
	46, // 19: services.sync.SendLicensesRequest.licenses:type_name -> resources.citizens.licenses.License
	43, // 20: services.sync.SendAccountsRequest.account_updates:type_name -> resources.sync.activity.AccountUpdate
	47, // 21: services.sync.SendUsersRequest.users:type_name -> resources.sync.data.DataUser
	48, // 22: services.sync.SendVehiclesRequest.vehicles:type_name -> resources.vehicles.Vehicle
	49, // 23: services.sync.SendUserLocationsRequest.users:type_name -> resources.sync.data.CitizenLocations
	50, // 24: services.sync.SetLastCharIDRequest.last_char_id:type_name -> resources.sync.data.LastCharID
	35, // 25: services.sync.AddActivityRequest.user_oauth2:type_name -> resources.sync.activity.UserOAuth2Conn
	36, // 26: services.sync.AddActivityRequest.dispatch:type_name -> resources.centrum.dispatches.Dispatch
	38, // 27: services.sync.AddActivityRequest.user_activity:type_name -> resources.users.activity.UserActivity
	39, // 28: services.sync.AddActivityRequest.user_props:type_name -> resources.sync.activity.UserProps
	40, // 29: services.sync.AddActivityRequest.colleague_activity:type_name -> resources.jobs.colleagues.activity.ColleagueActivity
	41, // 30: services.sync.AddActivityRequest.colleague_props:type_name -> resources.sync.activity.ColleagueProps
	42, // 31: services.sync.AddActivityRequest.job_timeclock:type_name -> resources.sync.activity.TimeclockUpdate
	43, // 32: services.sync.AddActivityRequest.account_update:type_name -> resources.sync.activity.AccountUpdate
	44, // 33: services.sync.AddActivityRequest.user_update:type_name -> resources.sync.activity.UserUpdate
	51, // 34: services.sync.SendDataRequest.jobs:type_name -> resources.sync.data.DataJobs
	52, // 35: services.sync.SendDataRequest.licenses:type_name -> resources.sync.data.DataLicenses
	53, // 36: services.sync.SendDataRequest.accounts:type_name -> resources.sync.data.DataAccounts
	54, // 37: services.sync.SendDataRequest.users:type_name -> resources.sync.data.DataUsers
	55, // 38: services.sync.SendDataRequest.vehicles:type_name -> resources.sync.data.DataVehicles
	56, // 39: services.sync.SendDataRequest.user_locations:type_name -> resources.sync.data.DataUserLocations
	50, // 40: services.sync.SendDataRequest.last_char_id:type_name -> resources.sync.data.LastCharID
	57, // 41: services.sync.DeleteDataRequest.users:type_name -> resources.sync.data.DeleteUsers
	58, // 42: services.sync.DeleteDataRequest.vehicles:type_name -> resources.sync.data.DeleteVehicles
	...
	14, // 47: services.sync.SyncService.AddAccountUpdate:input_type -> services.sync.AddAccountUpdateRequest
	15, // 48: services.sync.SyncService.AddUserUpdate:input_type -> services.sync.AddUserUpdateRequest
	9,  // 49: services.sync.SyncService.AddUserActivity:input_type -> services.sync.AddUserActivityRequest
	10, // 50: services.sync.SyncService.AddUserProps:input_type -> services.sync.AddUserPropsRequest
	11, // 51: services.sync.SyncService.AddColleagueActivity:input_type -> services.sync.AddColleagueActivityRequest
	12, // 52: services.sync.SyncService.AddColleagueProps:input_type -> services.sync.AddColleaguePropsRequest
	13, // 53: services.sync.SyncService.AddJobTimeclock:input_type -> services.sync.AddJobTimeclockRequest
	...
	17, // 56: services.sync.SyncService.SendJobs:input_type -> services.sync.SendJobsRequest
	18, // 57: services.sync.SyncService.SendLicenses:input_type -> services.sync.SendLicensesRequest
	19, // 58: services.sync.SyncService.SendAccounts:input_type -> services.sync.SendAccountsRequest
	20, // 59: services.sync.SyncService.SendUsers:input_type -> services.sync.SendUsersRequest
	21, // 60: services.sync.SyncService.SendVehicles:input_type -> services.sync.SendVehiclesRequest
	22, // 61: services.sync.SyncService.SendUserLocations:input_type -> services.sync.SendUserLocationsRequest
	23, // 62: services.sync.SyncService.SetLastCharID:input_type -> services.sync.SetLastCharIDRequest
	25, // 63: services.sync.SyncService.DeleteUsers:input_type -> services.sync.DeleteUsersRequest
	26, // 64: services.sync.SyncService.DeleteVehicles:input_type -> services.sync.DeleteVehiclesRequest
	32, // 65: services.sync.SyncService.Stream:input_type -> services.sync.StreamRequest
	28, // 66: services.sync.SyncService.AddActivity:input_type -> services.sync.AddActivityRequest
	29, // 67: services.sync.SyncService.SendData:input_type -> services.sync.SendDataRequest
	30, // 68: services.sync.SyncService.DeleteData:input_type -> services.sync.DeleteDataRequest
	1,  // 69: services.sync.SyncService.GetStatus:output_type -> services.sync.GetStatusResponse
	3,  // 70: services.sync.SyncService.RegisterAccount:output_type -> services.sync.RegisterAccountResponse
	5,  // 71: services.sync.SyncService.TransferAccount:output_type -> services.sync.TransferAccountResponse
	16, // 72: services.sync.SyncService.AddUserOAuth2Conn:output_type -> services.sync.AddActivityResponse
	16, // 73: services.sync.SyncService.AddAccountUpdate:output_type -> services.sync.AddActivityResponse
	16, // 74: services.sync.SyncService.AddUserUpdate:output_type -> services.sync.AddActivityResponse
	16, // 75: services.sync.SyncService.AddUserActivity:output_type -> services.sync.AddActivityResponse
	16, // 76: services.sync.SyncService.AddUserProps:output_type -> services.sync.AddActivityResponse
	16, // 77: services.sync.SyncService.AddColleagueActivity:output_type -> services.sync.AddActivityResponse
	16, // 78: services.sync.SyncService.AddColleagueProps:output_type -> services.sync.AddActivityResponse
	16, // 79: services.sync.SyncService.AddJobTimeclock:output_type -> services.sync.AddActivityResponse
	16, // 80: services.sync.SyncService.AddDispatch:output_type -> services.sync.AddActivityResponse
	16, // 81: services.sync.SyncService.AddMarker:output_type -> services.sync.AddActivityResponse
	24, // 82: services.sync.SyncService.SendJobs:output_type -> services.sync.SendDataResponse
	24, // 83: services.sync.SyncService.SendLicenses:output_type -> services.sync.SendDataResponse
	24, // 84: services.sync.SyncService.SendAccounts:output_type -> services.sync.SendDataResponse
	24, // 85: services.sync.SyncService.SendUsers:output_type -> services.sync.SendDataResponse
	24, // 86: services.sync.SyncService.SendVehicles:output_type -> services.sync.SendDataResponse
	24, // 87: services.sync.SyncService.SendUserLocations:output_type -> services.sync.SendDataResponse
	24, // 88: services.sync.SyncService.SetLastCharID:output_type -> services.sync.SendDataResponse
	31, // 89: services.sync.SyncService.DeleteUsers:output_type -> services.sync.DeleteDataResponse
	31, // 90: services.sync.SyncService.DeleteVehicles:output_type -> services.sync.DeleteDataResponse
	27, // 91: services.sync.SyncService.Stream:output_type -> services.sync.StreamResponse
	16, // 92: services.sync.SyncService.AddActivity:output_type -> services.sync.AddActivityResponse
	24, // 93: services.sync.SyncService.SendData:output_type -> services.sync.SendDataResponse
	31, // 94: services.sync.SyncService.DeleteData:output_type -> services.sync.DeleteDataResponse
...
func file_services_sync_sync_proto_init() {
	...
	file_services_sync_sync_proto_msgTypes[22].OneofWrappers = []any{}
