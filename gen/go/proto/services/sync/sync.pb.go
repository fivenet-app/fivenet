...
const file_services_sync_sync_proto_rawDesc = "" +
	"\n" +
	"\x18services/sync/sync.proto\x12\rservices.sync\x1a\"resources/centrum/dispatches.proto\x1a\x1dresources/jobs/activity.proto\x1a\x1dresources/sync/activity.proto\x1a\x19resources/sync/data.proto\x1a\x1eresources/users/activity.proto\x1a\x17validate/validate.proto\"\x12\n" +
	...
	"resetToken\x12.\n" +
	"\flast_char_id\x18\x03 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00H\x00R\n" +
	...
	"\vold_license\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x18@R\n" +
	"oldLicense\x12(\n" +
	"\vnew_license\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x18@R\n" +
	"newLicense\"\x19\n" +
	"\x17TransferAccountResponse\"\xc5\x02\n" +
	...
	"\x0euser_locations\x18\x05 \x01(\v2!.resources.sync.DataUserLocationsH\x00R\ruserLocationsB\v\n" +
	"\x04data\x12\x03\xf8B\x01\"7\n" +
	"\x10SendDataResponse\x12#\n" +
	"\raffected_rows\x18\x01 \x01(\x03R\faffectedRows\"\x93\x01\n" +
	"\x11DeleteDataRequest\x123\n" +
	"\x05users\x18\x01 \x01(\v2\x1b.resources.sync.DeleteUsersH\x00R\x05users\x12<\n" +
	"\bvehicles\x18\x02 \x01(\v2\x1e.resources.sync.DeleteVehiclesH\x00R\bvehiclesB\v\n" +
	"\x04data\x12\x03\xf8B\x01\"9\n" +
