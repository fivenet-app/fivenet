...
func (x *StreamResponse) GetUserSync() *UserSyncRequest {
	if x != nil {
		if x, ok := x.Payload.(*StreamResponse_UserSync); ok {
			return x.UserSync
		}
	}
	return nil
...
func (x *StreamResponse) SetUserSync(v *UserSyncRequest) {
	...
	x.Payload = &StreamResponse_UserSync{v}
}
...
func (x *StreamResponse) HasUserSync() bool {
	...
	_, ok := x.Payload.(*StreamResponse_UserSync)
	return ok
}
...
func (x *StreamResponse) ClearUserSync() {
	if _, ok := x.Payload.(*StreamResponse_UserSync); ok {
		x.Payload = nil
	}
}
...
func (b0 StreamResponse_builder) Build() *StreamResponse {
	...
	_, _ = b, x
	if b.UserSync != nil {
		x.Payload = &StreamResponse_UserSync{b.UserSync}
	}
	return m0
}
