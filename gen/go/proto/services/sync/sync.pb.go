...
type StreamRequest struct {
	...
	SyncState     *ClientSyncState       `protobuf:"bytes,2,opt,name=sync_state,json=syncState,proto3" json:"sync_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 StreamRequest_builder) Build() *StreamRequest {
	...
	_, _ = b, x
	x.Version = b.Version
	x.SyncState = b.SyncState
	return m0
}

type ClientSyncState struct {
	state         protoimpl.MessageState  `protogen:"hybrid.v1"`
	Tables        []*ClientTableSyncState `protobuf:"bytes,1,rep,name=tables,proto3" json:"tables,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ClientTableSyncState struct {
	...
	LastCheck     *timestamp.Timestamp   `protobuf:"bytes,2,opt,name=last_check,json=lastCheck,proto3,oneof" json:"last_check,omitempty"`
	LastId        *string                `protobuf:"bytes,3,opt,name=last_id,json=lastId,proto3,oneof" json:"last_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
