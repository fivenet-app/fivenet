...
const file_resources_calendar_access_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/calendar/access.proto\x12\x12resources.calendar\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x13tagger/tagger.proto\"\xbc\x01\n" +
	"\x0eCalendarAccess\x12R\n" +
	"\x04jobs\x18\x01 \x03(\v2%.resources.calendar.CalendarJobAccessB\x17\x9a\x84\x9e\x03\x12alias:\"job_access\"R\x04jobs\x12V\n" +
	"\x05users\x18\x02 \x03(\v2&.resources.calendar.CalendarUserAccessB\x18\x9a\x84\x9e\x03\x13alias:\"user_access\"R\x05users\"\xf4\x02\n" +
	...
	"\x0fjob_grade_label\x18\a \x01(\tH\x02R\rjobGradeLabel\x88\x01\x01\x127\n" +
	"\x06access\x18\b \x01(\x0e2\x1f.resources.calendar.AccessLevelR\x06accessB\r\n" +
	"\v_created_atB\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
	"\x10_job_grade_label\"\xa4\x02\n" +
	...
	"\x04user\x18\x05 \x01(\v2\x1a.resources.users.UserShortH\x01R\x04user\x88\x01\x01\x127\n" +
	"\x06access\x18\x06 \x01(\x0e2\x1f.resources.calendar.AccessLevelR\x06accessB\r\n" +
	"\v_created_atB\a\n" +
	"\x05_user*\xa4\x01\n" +
	...
	"\x13ACCESS_LEVEL_MANAGE\x10\x05BOZMgithub.com/fivenet-app/fivenet/v2025/gen/go/proto/resources/calendar;calendarb\x06proto3"
