...
type Calendar struct {
	...
	xxx_hidden_Access          *access.Access           `protobuf:"bytes,15,opt,name=access,proto3"`
...
const file_resources_calendar_calendar_proto_rawDesc = "" +
	...
	"\x04icon\x18\x12 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01H\x06R\x04icon\x88\x01\x01\x12+\n" +
	"\n" +
