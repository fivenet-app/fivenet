...
type CalendarEntry struct {
	...
	Data       *CalendarEntryData `protobuf:"bytes,17,opt,name=data,proto3,oneof" json:"data,omitempty"`
}
...
func (x *CalendarEntry) GetData() *CalendarEntryData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *CalendarEntryData) Reset() {
	*x = CalendarEntryData{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalendarEntryData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalendarEntryData) ProtoMessage() {}

func (x *CalendarEntryData) ProtoReflect() protoreflect.Message {
	mi := &file_resources_calendar_calendar_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalendarEntryData.ProtoReflect.Descriptor instead.
func (*CalendarEntryData) Descriptor() ([]byte, []int) {
...
var file_resources_calendar_calendar_proto_rawDesc = []byte{
	...
	0x0a, 0x0c, 0x5f, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xe3,
	...
	0x65, 0x73, 0x73, 0x12, 0x3e, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x11, 0x20, 0x01, 0x28,
	...
	0x6e, 0x74, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61, 0x48, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61,
	...
	0x0a, 0x0a, 0x08, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x42, 0x07, 0x0a, 0x05, 0x5f,
	0x64, 0x61, 0x74, 0x61, 0x22, 0x13, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x65, 0x6e, 0x64, 0x61, 0x72,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61, 0x22, 0xae, 0x02, 0x0a, 0x11, 0x43, 0x61,
...
var file_resources_calendar_calendar_proto_goTypes = []interface{}{
	...
	(*CalendarEntryData)(nil),   // 4: resources.calendar.CalendarEntryData
...
var file_resources_calendar_calendar_proto_depIdxs = []int32{
	...
	4,  // 14: resources.calendar.CalendarEntry.data:type_name -> resources.calendar.CalendarEntryData
	6,  // 15: resources.calendar.CalendarEntryRSVP.created_at:type_name -> resources.timestamp.Timestamp
	7,  // 16: resources.calendar.CalendarEntryRSVP.user:type_name -> resources.users.UserShort
	0,  // 17: resources.calendar.CalendarEntryRSVP.response:type_name -> resources.calendar.RsvpResponses
...
func file_resources_calendar_calendar_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resources_calendar_calendar_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalendarEntryData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
