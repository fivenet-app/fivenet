...
type Cronjob struct {
	...
	xxx_hidden_Schedule           string                 `protobuf:"bytes,2,opt,name=schedule,proto3"`
	xxx_hidden_State              CronjobState           `protobuf:"varint,3,opt,name=state,proto3,enum=resources.cron.CronjobState"`
	xxx_hidden_NextScheduleTime   *timestamp.Timestamp   `protobuf:"bytes,4,opt,name=next_schedule_time,json=nextScheduleTime,proto3"`
	xxx_hidden_LastAttemptTime    *timestamp.Timestamp   `protobuf:"bytes,5,opt,name=last_attempt_time,json=lastAttemptTime,proto3,oneof"`
	xxx_hidden_StartedTime        *timestamp.Timestamp   `protobuf:"bytes,6,opt,name=started_time,json=startedTime,proto3,oneof"`
...
func (x *Cronjob) GetLastCompletedEvent() *CronjobCompletedEvent {
	if x != nil {
		return x.xxx_hidden_LastCompletedEvent
	}
	return nil
}
...
func (x *Cronjob) HasLastCompletedEvent() bool {
	...
	return x.xxx_hidden_LastCompletedEvent != nil
}
...
func (x *Cronjob) ClearLastCompletedEvent() {
	x.xxx_hidden_LastCompletedEvent = nil
}
...
type CronjobData struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_UpdatedAt *timestamp.Timestamp   `protobuf:"bytes,1,opt,name=updated_at,json=updatedAt,proto3"`
	xxx_hidden_Data      *anypb.Any             `protobuf:"bytes,2,opt,name=data,proto3,oneof"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type CronjobLockOwnerState struct {
	...
	xxx_hidden_UpdatedAt *timestamp.Timestamp   `protobuf:"bytes,2,opt,name=updated_at,json=updatedAt,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type CronjobSchedulerEvent struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Cronjob *Cronjob               `protobuf:"bytes,1,opt,name=cronjob,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *CronjobSchedulerEvent) GetCronjob() *Cronjob {
	if x != nil {
		return x.xxx_hidden_Cronjob
	}
	return nil
}

func (x *CronjobSchedulerEvent) SetCronjob(v *Cronjob) {
	x.xxx_hidden_Cronjob = v
}
...
func (x *CronjobSchedulerEvent) HasCronjob() bool {
	...
	return x.xxx_hidden_Cronjob != nil
}

func (x *CronjobSchedulerEvent) ClearCronjob() {
	x.xxx_hidden_Cronjob = nil
}
...
func (b0 CronjobSchedulerEvent_builder) Build() *CronjobSchedulerEvent {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Cronjob = b.Cronjob
	return m0
}
...
type CronjobCompletedEvent struct {
	...
	xxx_hidden_Elapsed      *durationpb.Duration   `protobuf:"bytes,4,opt,name=elapsed,proto3"`
	xxx_hidden_Data         *CronjobData           `protobuf:"bytes,5,opt,name=data,proto3,oneof"`
	xxx_hidden_NodeName     string                 `protobuf:"bytes,6,opt,name=node_name,json=nodeName,proto3"`
	xxx_hidden_ErrorMessage *string                `protobuf:"bytes,8,opt,name=error_message,json=errorMessage,proto3,oneof"`
...
type GenericCronData struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Attributes map[string]string      `protobuf:"bytes,1,rep,name=attributes,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
