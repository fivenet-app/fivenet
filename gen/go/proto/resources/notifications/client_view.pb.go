...
const file_resources_notifications_client_view_proto_rawDesc = "" +
	"\n" +
	")resources/notifications/client_view.proto\x12\x17resources.notifications\x1a\x1cgoogle/protobuf/struct.proto\"a\n" +
	"\n" +
	"ClientView\x127\n" +
	"\x04type\x18\x01 \x01(\x0e2#.resources.notifications.ObjectTypeR\x04type\x12\x13\n" +
	"\x02id\x18\x02 \x01(\x03H\x00R\x02id\x88\x01\x01B\x05\n" +
	"\x03_id\"\xaf\x02\n" +
	"\vObjectEvent\x127\n" +
	"\x04type\x18\x01 \x01(\x0e2#.resources.notifications.ObjectTypeR\x04type\x12\x13\n" +
	"\x02id\x18\x02 \x01(\x03H\x00R\x02id\x88\x01\x01\x12G\n" +
	"\n" +
	"event_type\x18\x03 \x01(\x0e2(.resources.notifications.ObjectEventTypeR\teventType\x12\x1c\n" +
