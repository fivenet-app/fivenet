...
const file_resources_notifications_events_proto_rawDesc = "" +
	"\n" +
	"$resources/notifications/events.proto\x12\x17resources.notifications\x1a)resources/clientconfig/clientconfig.proto\x1a\x1eresources/jobs/job_props.proto\x1a+resources/notifications/notifications.proto\x1a\"resources/userinfo/user_info.proto\"\x96\x02\n" +
	"\tUserEvent\x12%\n" +
	...
	"\x04data\"K\n" +
	"\bJobEvent\x127\n" +
	"\tjob_props\x18\x01 \x01(\v2\x18.resources.jobs.JobPropsH\x00R\bjobPropsB\x06\n" +
	"\x04data\">\n" +
	"\rJobGradeEvent\x12%\n" +
	...
	"\x04dataBYZWgithub.com/fivenet-app/fivenet/v2025/gen/go/proto/resources/notifications;notificationsb\x06proto3"
