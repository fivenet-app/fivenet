...
type UserEvent struct {
	...
	xxx_hidden_UnreadCount int64                  `protobuf:"varint,7,opt,name=unread_count,json=unreadCount,proto3,oneof"`
	xxx_hidden_Data        isUserEvent_Data       `protobuf_oneof:"data"`
...
func (x *UserEvent) GetRefreshToken() bool {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*userEvent_RefreshToken); ok {
...
func (x *UserEvent) GetNotification() *notifications.Notification {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*userEvent_Notification); ok {
...
func (x *UserEvent) GetNotificationsReadCount() int64 {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*userEvent_NotificationsReadCount); ok {
...
func (x *UserEvent) GetUserInfoChanged() *userinfo.UserInfoChanged {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*userEvent_UserInfoChanged); ok {
...
func (x *UserEvent) GetNotificationsUnreadCount() int64 {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*userEvent_NotificationsUnreadCount); ok {
...
func (x *UserEvent) SetNotification(v *notifications.Notification) {
	...
	x.xxx_hidden_Data = &userEvent_Notification{v}
}

func (x *UserEvent) SetNotificationsReadCount(v int64) {
	x.xxx_hidden_Data = &userEvent_NotificationsReadCount{v}
}
...
func (x *UserEvent) SetNotificationsUnreadCount(v int64) {
	x.xxx_hidden_Data = &userEvent_NotificationsUnreadCount{v}
}
...
func (x *UserEvent) HasRefreshToken() bool {
	...
	_, ok := x.xxx_hidden_Data.(*userEvent_RefreshToken)
	return ok
}
...
func (x *UserEvent) HasNotification() bool {
	...
	_, ok := x.xxx_hidden_Data.(*userEvent_Notification)
	return ok
}
...
func (x *UserEvent) HasNotificationsReadCount() bool {
	...
	_, ok := x.xxx_hidden_Data.(*userEvent_NotificationsReadCount)
	return ok
}
...
func (x *UserEvent) HasUserInfoChanged() bool {
	...
	_, ok := x.xxx_hidden_Data.(*userEvent_UserInfoChanged)
	return ok
}
...
func (x *UserEvent) HasNotificationsUnreadCount() bool {
	...
	_, ok := x.xxx_hidden_Data.(*userEvent_NotificationsUnreadCount)
	return ok
}

func (x *UserEvent) ClearUnreadCount() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_UnreadCount = 0
}
...
func (x *UserEvent) ClearRefreshToken() {
	if _, ok := x.xxx_hidden_Data.(*userEvent_RefreshToken); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *UserEvent) ClearNotification() {
	if _, ok := x.xxx_hidden_Data.(*userEvent_Notification); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *UserEvent) ClearNotificationsReadCount() {
	if _, ok := x.xxx_hidden_Data.(*userEvent_NotificationsReadCount); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *UserEvent) ClearUserInfoChanged() {
	if _, ok := x.xxx_hidden_Data.(*userEvent_UserInfoChanged); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (x *UserEvent) ClearNotificationsUnreadCount() {
	if _, ok := x.xxx_hidden_Data.(*userEvent_NotificationsUnreadCount); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (b0 UserEvent_builder) Build() *UserEvent {
	...
	b, x := &b0, m0
	_, _ = b, x
	if b.UnreadCount != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 2)
		x.xxx_hidden_UnreadCount = *b.UnreadCount
	}
	if b.RefreshToken != nil {
		x.xxx_hidden_Data = &userEvent_RefreshToken{*b.RefreshToken}
	}
	if b.Notification != nil {
		x.xxx_hidden_Data = &userEvent_Notification{b.Notification}
	}
	if b.NotificationsReadCount != nil {
		x.xxx_hidden_Data = &userEvent_NotificationsReadCount{*b.NotificationsReadCount}
	}
	...
	if b.NotificationsUnreadCount != nil {
		x.xxx_hidden_Data = &userEvent_NotificationsUnreadCount{*b.NotificationsUnreadCount}
	}
	return m0
}
...
type JobEvent struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Data isJobEvent_Data        `protobuf_oneof:"data"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *JobEvent) GetJobProps() *props.JobProps {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*jobEvent_JobProps); ok {
			return x.JobProps
		}
	}
	return nil
...
func (x *JobEvent) SetJobProps(v *props.JobProps) {
	...
	x.xxx_hidden_Data = &jobEvent_JobProps{v}
}
...
func (x *JobEvent) HasJobProps() bool {
	...
	_, ok := x.xxx_hidden_Data.(*jobEvent_JobProps)
	return ok
}
...
func (x *JobEvent) ClearJobProps() {
	if _, ok := x.xxx_hidden_Data.(*jobEvent_JobProps); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (b0 JobEvent_builder) Build() *JobEvent {
	...
	_, _ = b, x
	if b.JobProps != nil {
		x.xxx_hidden_Data = &jobEvent_JobProps{b.JobProps}
	}
	return m0
}
...
type JobGradeEvent struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Data isJobGradeEvent_Data   `protobuf_oneof:"data"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *JobGradeEvent) GetRefreshToken() bool {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*jobGradeEvent_RefreshToken); ok {
			return x.RefreshToken
		}
	}
	return false
...
func (x *JobGradeEvent) SetRefreshToken(v bool) {
	x.xxx_hidden_Data = &jobGradeEvent_RefreshToken{v}
}
...
func (x *JobGradeEvent) HasRefreshToken() bool {
	...
	_, ok := x.xxx_hidden_Data.(*jobGradeEvent_RefreshToken)
	return ok
}
...
func (x *JobGradeEvent) ClearRefreshToken() {
	if _, ok := x.xxx_hidden_Data.(*jobGradeEvent_RefreshToken); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (b0 JobGradeEvent_builder) Build() *JobGradeEvent {
	...
	_, _ = b, x
	if b.RefreshToken != nil {
		x.xxx_hidden_Data = &jobGradeEvent_RefreshToken{*b.RefreshToken}
	}
	return m0
}
...
type SystemEvent struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Data isSystemEvent_Data     `protobuf_oneof:"data"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SystemEvent) GetClientConfig() *clientconfig.ClientConfig {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*systemEvent_ClientConfig); ok {
...
func (x *SystemEvent) HasClientConfig() bool {
	...
	_, ok := x.xxx_hidden_Data.(*systemEvent_ClientConfig)
	return ok
}
...
func (x *SystemEvent) ClearClientConfig() {
	if _, ok := x.xxx_hidden_Data.(*systemEvent_ClientConfig); ok {
		x.xxx_hidden_Data = nil
	}
}
