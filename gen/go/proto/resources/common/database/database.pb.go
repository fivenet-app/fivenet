...
const file_resources_common_database_database_proto_rawDesc = "" +
	"\n" +
	"(resources/common/database/database.proto\x12\x19resources.common.database\x1a#resources/timestamp/timestamp.proto\x1a\x17validate/validate.proto\"m\n" +
	"\x11PaginationRequest\x12\x1f\n" +
	"\x06offset\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02(\x00R\x06offset\x12)\n" +
	"\tpage_size\x18\x02 \x01(\x03B\a\xfaB\x04\"\x02(\x00H\x00R\bpageSize\x88\x01\x01B\f\n" +
	"\n" +
	"_page_size\"|\n" +
	...
	"\x04Sort\x12!\n" +
	"\x06column\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x01\x18@R\x06column\x12.\n" +
