...
var file_resources_common_database_database_proto_goTypes = []interface{}{
...
func file_resources_common_database_database_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_common_database_database_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_common_database_database_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_common_database_database_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Sort); i {
			case 0:
				return &v.state
			case 1:
		...
		file_resources_common_database_database_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_common_database_database_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
