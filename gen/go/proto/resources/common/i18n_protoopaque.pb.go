...
type I18NItem struct {
	...
	xxx_hidden_Parameters map[string]string      `protobuf:"bytes,2,rep,name=parameters,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
