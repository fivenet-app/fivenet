...
const file_resources_common_content_content_proto_rawDesc = "" +
	"\n" +
	"&resources/common/content/content.proto\x12\x18resources.common.content\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xc1\x01\n" +
	"\aContent\x12\x1d\n" +
	"\aversion\x18\x01 \x01(\tH\x00R\aversion\x88\x01\x01\x12A\n" +
	"\acontent\x18\x02 \x01(\v2\".resources.common.content.JSONNodeH\x01R\acontent\x88\x01\x01\x12,\n" +
	"\vraw_content\x18\x03 \x01(\tB\x06\xda\xf3\x18\x02\b\x01H\x02R\n" +
	"rawContent\x88\x01\x01B\n" +
	"\n" +
	"\b_versionB\n" +
	"\n" +
	"\b_contentB\x0e\n" +
	"\f_raw_content\"\x9b\x03\n" +
	"\bJSONNode\x126\n" +
	"\x04type\x18\x01 \x01(\x0e2\".resources.common.content.NodeTypeR\x04type\x12&\n" +
