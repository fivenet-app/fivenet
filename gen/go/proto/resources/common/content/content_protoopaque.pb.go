...
type Content struct {
	...
	xxx_hidden_ContentType ContentType            `protobuf:"varint,2,opt,name=content_type,json=contentType,proto3,enum=resources.common.content.ContentType"`
	xxx_hidden_RawHtml     *string                `protobuf:"bytes,3,opt,name=raw_html,json=rawHtml,proto3,oneof"`
	xxx_hidden_Content     *RichTextHtmlNode      `protobuf:"bytes,4,opt,name=content,proto3,oneof"`
	xxx_hidden_TiptapJson  *structpb.Struct       `protobuf:"bytes,5,opt,name=tiptap_json,json=tiptapJson,proto3"`
...
func (x *Content) HasTiptapJson() bool {
	...
	return x.xxx_hidden_TiptapJson != nil
}

func (x *Content) ClearRawHtml() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_RawHtml = nil
}
...
type RichTextHtmlNode struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Type        NodeType               `protobuf:"varint,1,opt,name=type,proto3,enum=resources.common.content.NodeType"`
	xxx_hidden_Id          *string                `protobuf:"bytes,2,opt,name=id,proto3,oneof"`
	xxx_hidden_Tag         string                 `protobuf:"bytes,3,opt,name=tag,proto3"`
	xxx_hidden_Attrs       map[string]string      `protobuf:"bytes,4,rep,name=attrs,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Text        *string                `protobuf:"bytes,5,opt,name=text,proto3,oneof"`
	xxx_hidden_Content     *[]*RichTextHtmlNode   `protobuf:"bytes,6,rep,name=content,proto3"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ExtractedContent struct {
	...
	xxx_hidden_WordCount    uint32                 `protobuf:"varint,2,opt,name=word_count,json=wordCount,proto3"`
	xxx_hidden_FirstHeading string                 `protobuf:"bytes,3,opt,name=first_heading,json=firstHeading,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
