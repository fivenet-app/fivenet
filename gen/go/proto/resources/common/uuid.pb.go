...
const file_resources_common_uuid_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/common/uuid.proto\x12\x10resources.common\x1a\x17validate/validate.proto\"$\n" +
	"\x04UUID\x12\x1c\n" +
	"\x04uuid\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\x04uuidBEZCgithub.com/fivenet-app/fivenet/v2025/gen/go/proto/resources/common;commonb\x06proto3"
