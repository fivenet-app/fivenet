...
var file_resources_common_uuid_proto_rawDesc = []byte{
...
var (
	...
	file_resources_common_uuid_proto_rawDescData = file_resources_common_uuid_proto_rawDesc
)

func file_resources_common_uuid_proto_rawDescGZIP() []byte {
	file_resources_common_uuid_proto_rawDescOnce.Do(func() {
		file_resources_common_uuid_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_common_uuid_proto_rawDescData)
	})
...
var file_resources_common_uuid_proto_goTypes = []interface{}{
...
func file_resources_common_uuid_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_common_uuid_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UUID); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_common_uuid_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_resources_common_uuid_proto_rawDesc = nil
