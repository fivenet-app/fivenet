...
const file_resources_centrum_attributes_proto_rawDesc = "" +
	"\n" +
	"\"resources/centrum/attributes.proto\x12\x11resources.centrum\x1a!codegen/dbscanner/dbscanner.proto\"N\n" +
	"\x0eUnitAttributes\x124\n" +
	"\x04list\x18\x01 \x03(\x0e2 .resources.centrum.UnitAttributeR\x04list:\x06\xe2\xf3\x18\x02\b\x01\"V\n" +
	"\x12DispatchAttributes\x128\n" +
	"\x04list\x18\x01 \x03(\x0e2$.resources.centrum.DispatchAttributeR\x04list:\x06\xe2\xf3\x18\x02\b\x01*v\n" +
