...
const file_resources_centrum_units_proto_rawDesc = "" +
	"\n" +
	"\x1dresources/centrum/units.proto\x12\x11resources.centrum\x1a!codegen/sanitizer/sanitizer.proto\x1a\"resources/centrum/attributes.proto\x1a$resources/centrum/units_access.proto\x1a\x1fresources/jobs/colleagues.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xc2\x06\n" +
	"\x04Unit\x121\n" +
	...
	"\binitials\x18\x06 \x01(\tB\x06\xda\xf3\x18\x02\b\x01R\binitials\x12'\n" +
	"\x05color\x18\a \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x05color\x12*\n" +
	"\x04icon\x18\x10 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x03R\x04icon\x88\x01\x01\x12-\n" +
	...
	"\x03job\x18\x02 \x01(\tR\x03job\x127\n" +
	"\x05users\x18\x03 \x03(\v2!.resources.centrum.UnitAssignmentR\x05users\"\xcf\x01\n" +
	"\x0eUnitAssignment\x12?\n" +
	"\aunit_id\x18\x01 \x01(\x03B&\x9a\x84\x9e\x03!sql:\"primary_key\" alias:\"unit_id\"R\x06unitId\x12?\n" +
	"\auser_id\x18\x02 \x01(\x05B&\x9a\x84\x9e\x03!sql:\"primary_key\" alias:\"user_id\"R\x06userId\x122\n" +
	...
	"\x04unit\x18\x04 \x01(\v2\x17.resources.centrum.UnitH\x01R\x04unit\x88\x01\x01\x125\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1d.resources.centrum.StatusUnitR\x06status\x12#\n" +
	...
	"\auser_id\x18\b \x01(\x05H\x04R\x06userId\x88\x01\x01\x122\n" +
	...
	"\n" +
	"creator_id\x18\r \x01(\x05H\tR\tcreatorId\x88\x01\x01\x128\n" +
