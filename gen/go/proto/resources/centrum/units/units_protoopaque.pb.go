...
const file_resources_centrum_units_units_proto_rawDesc = "" +
	"\n" +
	"#resources/centrum/units/units.proto\x12\x17resources.centrum.units\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1dresources/access/access.proto\x1a*resources/jobs/colleagues/colleagues.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xc7\a\n" +
	"\x04Unit\x121\n" +
	...
	"\n" +
	"sort_order\x18\x11 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tsortOrder\x12#\n" +
	...
	"\x04icon\x18\x10 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01H\x03R\x04icon\x88\x01\x01\x125\n" +
	"\vdescription\x18\b \x01(\tB\x0e\xda\xf3\x18\x02\b\x01\xbaH\x05r\x03\x18\xff\x01H\x04R\vdescription\x88\x01\x01\x12@\n" +
	"\x06status\x18\t \x01(\v2#.resources.centrum.units.UnitStatusH\x05R\x06status\x88\x01\x01\x12G\n" +
	"\x05users\x18\v \x03(\v2'.resources.centrum.units.UnitAssignmentB\b\xbaH\x05\x92\x01\x02\x10\x1eR\x05users\x12L\n" +
	"\n" +
	...
	"\a_statusB\r\n" +
	"\v_attributesB\x0e\n" +
	"\f_home_postal\"\x97\x01\n" +
	"\x0fUnitAssignments\x12 \n" +
	"\aunit_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\x06unitId\x12\x19\n" +
	"\x03job\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x18\x14R\x03job\x12G\n" +
	"\x05users\x18\x03 \x03(\v2'.resources.centrum.units.UnitAssignmentB\b\xbaH\x05\x92\x01\x02\x10\x1eR\x05users\"\xe8\x01\n" +
	"\x0eUnitAssignment\x12F\n" +
	"\aunit_id\x18\x01 \x01(\x03B-\x9a\x84\x9e\x03!sql:\"primary_key\" alias:\"unit_id\"\xbaH\x04\"\x02 \x00R\x06unitId\x12F\n" +
	"\auser_id\x18\x02 \x01(\x05B-\x9a\x84\x9e\x03!sql:\"primary_key\" alias:\"user_id\"\xbaH\x04\x1a\x02(\x00R\x06userId\x12=\n" +
	...
	"\x04unit\x18\x04 \x01(\v2\x1d.resources.centrum.units.UnitH\x01R\x04unit\x88\x01\x01\x12E\n" +
	"\x06status\x18\x05 \x01(\x0e2#.resources.centrum.units.StatusUnitB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06status\x12+\n" +
	"\x06reason\x18\x06 \x01(\tB\x0e\xda\xf3\x18\x02\b\x01\xbaH\x05r\x03\x18\xff\x01H\x02R\x06reason\x88\x01\x01\x12&\n" +
	"\x04code\x18\a \x01(\tB\r\xda\xf3\x18\x02\b\x01\xbaH\x04r\x02\x18\x14H\x03R\x04code\x88\x01\x01\x12%\n" +
	"\auser_id\x18\b \x01(\x05B\a\xbaH\x04\x1a\x02 \x00H\x04R\x06userId\x88\x01\x01\x12=\n" +
	...
	"\x06postal\x18\f \x01(\tB\r\xda\xf3\x18\x02\b\x01\xbaH\x04r\x02\x180H\bR\x06postal\x88\x01\x01\x12+\n" +
	"\n" +
	"creator_id\x18\r \x01(\x05B\a\xbaH\x04\x1a\x02 \x00H\tR\tcreatorId\x88\x01\x01\x12C\n" +
	"\acreator\x18\x0e \x01(\v2$.resources.jobs.colleagues.ColleagueH\n" +
	"R\acreator\x88\x01\x01\x12-\n" +
	"\vcreator_job\x18\x0f \x01(\tB\a\xbaH\x04r\x02\x18\x14H\vR\n" +
	...
	"\b_creatorB\x0e\n" +
	"\f_creator_job\"e\n" +
	"\x0eUnitAttributes\x12K\n" +
	"\x04list\x18\x01 \x03(\x0e2&.resources.centrum.units.UnitAttributeB\x0f\xbaH\f\x92\x01\t\x10\x03\"\x05\x82\x01\x02\x10\x01R\x04list:\x06\xe2\xf3\x18\x02\b\x01*\xe4\x01\n" +
	"\n" +
	"StatusUnit\x12\x1b\n" +
