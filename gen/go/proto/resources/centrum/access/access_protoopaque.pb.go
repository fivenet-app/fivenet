...
const file_resources_centrum_access_access_proto_rawDesc = "" +
	"\n" +
	"%resources/centrum/access/access.proto\x12\x18resources.centrum.access\x1a!codegen/dbscanner/dbscanner.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"x\n" +
	"\rCentrumAccess\x12_\n" +
	"\x04jobs\x18\x01 \x03(\v2*.resources.centrum.access.CentrumJobAccessB\x1f\x9a\x84\x9e\x03\x12alias:\"job_access\"\xbaH\x05\x92\x01\x02\x10\n" +
	"R\x04jobs:\x06\xe2\xf3\x18\x02\b\x01\"\xac\x04\n" +
	...
	"\x0fjob_grade_label\x18\a \x01(\tB\a\xbaH\x04r\x02\x182H\x02R\rjobGradeLabel\x88\x01\x01\x12N\n" +
	"\x06access\x18\b \x01(\x0e2,.resources.centrum.access.CentrumAccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06access\x12D\n" +
	"\vaccepted_at\x18\n" +
