...
const file_resources_qualifications_access_proto_rawDesc = "" +
	"\n" +
	"%resources/qualifications/access.proto\x12\x18resources.qualifications\x1a#resources/timestamp/timestamp.proto\x1a\x17validate/validate.proto\"[\n" +
	"\x13QualificationAccess\x12D\n" +
	"\x04jobs\x18\x01 \x03(\v20.resources.qualifications.QualificationJobAccessR\x04jobs\"\xad\x03\n" +
	"\x16QualificationJobAccess\x12\x0e\n" +
	...
	"\tjob_label\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x182H\x01R\bjobLabel\x88\x01\x01\x12,\n" +
	"\rminimum_grade\x18\a \x01(\x05B\a\xfaB\x04\x1a\x02(\x00R\fminimumGrade\x124\n" +
	"\x0fjob_grade_label\x18\b \x01(\tB\a\xfaB\x04r\x02\x182H\x02R\rjobGradeLabel\x88\x01\x01\x12G\n" +
	"\x06access\x18\t \x01(\x0e2%.resources.qualifications.AccessLevelB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06accessB\r\n" +
	"\v_created_atB\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
	...
	"\x11ACCESS_LEVEL_EDIT\x10\x06BUZSgithub.com/fivenet-app/fivenet/gen/go/proto/resources/qualifications;qualificationsb\x06proto3"
