...
const file_resources_qualifications_exam_proto_rawDesc = "" +
	...
	"\vdescription\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\x80\bH\x02R\vdescription\x88\x01\x01\x12H\n" +
	"\x04data\x18\a \x01(\v2*.resources.qualifications.ExamQuestionDataB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04data\x12M\n" +
	"\x06answer\x18\b \x01(\v20.resources.qualifications.ExamQuestionAnswerDataH\x03R\x06answer\x88\x01\x01\x12$\n" +
	"\x06points\x18\t \x01(\x05B\a\xfaB\x04\x1a\x02(\x00H\x04R\x06points\x88\x01\x01B\r\n" +
	"\v_created_atB\r\n" +
	"\v_updated_atB\x0e\n" +
	"\f_descriptionB\t\n" +
	"\a_answerB\t\n" +
	...
	"\achoices\x18\x01 \x03(\tB\b\xfaB\x05\x92\x01\x02\x10\n" +
	"R\achoices\"p\n" +
	...
	"\tresponses\x18\x03 \x03(\v2&.resources.qualifications.ExamResponseB\b\xfaB\x05\x92\x01\x02\x102R\tresponses\"\xd4\x01\n" +
	...
	"\bresponse\x18\x04 \x01(\v2*.resources.qualifications.ExamResponseDataR\bresponse\"\xc0\x03\n" +
	...
	"\x0fmultiple_choice\x18\a \x01(\v24.resources.qualifications.ExamResponseMultipleChoiceH\x00R\x0emultipleChoiceB\x0f\n" +
	"\bresponse\x12\x03\xf8B\x01\"\x17\n" +
	"\x15ExamResponseSeparator\")\n" +
	"\x11ExamResponseYesNo\x12\x14\n" +
	"\x05value\x18\x01 \x01(\bR\x05value\"1\n" +
	"\x10ExamResponseText\x12\x1d\n" +
	"\x04text\x18\x01 \x01(\tB\t\xfaB\x06r\x04(\xa0\xc2\x1eR\x04text\"<\n" +
	"\x18ExamResponseSingleChoice\x12 \n" +
	"\x06choice\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06choice\"@\n" +
	"\x1aExamResponseMultipleChoice\x12\"\n" +
	"\achoices\x18\x01 \x03(\tB\b\xfaB\x05\x92\x01\x02\x10\n" +
	"R\achoices\"d\n" +
	"\vExamGrading\x12U\n" +
	"\tresponses\x18\x01 \x03(\v2-.resources.qualifications.ExamGradingResponseB\b\xfaB\x05\x92\x01\x02\x102R\tresponses\"\x8a\x01\n" +
	"\x13ExamGradingResponse\x12\x1f\n" +
	"\vquestion_id\x18\x01 \x01(\x04R\n" +
	"questionId\x12'\n" +
	"\x06points\x18\x02 \x01(\x02B\x0f\xfaB\f\n" +
	"\n" +
