...
const file_resources_qualifications_exam_proto_rawDesc = "" +
	"\n" +
	"#resources/qualifications/exam.proto\x12\x18resources.qualifications\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x19resources/file/file.proto\x1a#resources/timestamp/timestamp.proto\"U\n" +
	"\rExamQuestions\x12D\n" +
	"\tquestions\x18\x01 \x03(\v2&.resources.qualifications.ExamQuestionR\tquestions\"\xba\x04\n" +
	...
	"\x05title\x18\x05 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x05title\x128\n" +
	"\vdescription\x18\x06 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x02R\vdescription\x88\x01\x01\x12>\n" +
	"\x04data\x18\a \x01(\v2*.resources.qualifications.ExamQuestionDataR\x04data\x12M\n" +
	"\x06answer\x18\b \x01(\v20.resources.qualifications.ExamQuestionAnswerDataH\x03R\x06answer\x88\x01\x01\x12\x1b\n" +
	...
	"\x0fmultiple_choice\x18\x05 \x01(\v24.resources.qualifications.ExamQuestionMultipleChoiceH\x00R\x0emultipleChoice:\x06\xe2\xf3\x18\x02\b\x01B\x06\n" +
	"\x04data\"\x17\n" +
	...
	"\n" +
	"max_length\x18\x02 \x01(\x05R\tmaxLength\"G\n" +
	"\x18ExamQuestionSingleChoice\x12+\n" +
	"\achoices\x18\x01 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\achoices\"n\n" +
	"\x1aExamQuestionMultipleChoice\x12+\n" +
	"\achoices\x18\x01 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\achoices\x12\x19\n" +
	"\x05limit\x18\x02 \x01(\x05H\x00R\x05limit\x88\x01\x01B\b\n" +
	"\x06_limit\"\x95\x03\n" +
	"\x16ExamQuestionAnswerData\x12\x1d\n" +
	"\n" +
	"answer_key\x18\x01 \x01(\tR\tanswerKey\x12C\n" +
	...
	"\rExamResponses\x12)\n" +
	"\x10qualification_id\x18\x01 \x01(\x03R\x0fqualificationId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x05R\x06userId\x12D\n" +
	"\tresponses\x18\x03 \x03(\v2&.resources.qualifications.ExamResponseR\tresponses:\x06\xe2\xf3\x18\x02\b\x01\"\xd4\x01\n" +
	...
	"\bresponse\x18\x04 \x01(\v2*.resources.qualifications.ExamResponseDataR\bresponse\"\xbb\x03\n" +
	"\x10ExamResponseData\x12O\n" +
	"\tseparator\x18\x03 \x01(\v2/.resources.qualifications.ExamResponseSeparatorH\x00R\tseparator\x12C\n" +
	"\x05yesno\x18\x04 \x01(\v2+.resources.qualifications.ExamResponseYesNoH\x00R\x05yesno\x12I\n" +
	"\tfree_text\x18\x05 \x01(\v2*.resources.qualifications.ExamResponseTextH\x00R\bfreeText\x12Y\n" +
	"\rsingle_choice\x18\x06 \x01(\v22.resources.qualifications.ExamResponseSingleChoiceH\x00R\fsingleChoice\x12_\n" +
	"\x0fmultiple_choice\x18\a \x01(\v24.resources.qualifications.ExamResponseMultipleChoiceH\x00R\x0emultipleChoiceB\n" +
	"\n" +
	"\bresponse\"\x17\n" +
	...
	"\x04text\x18\x01 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x04text\"E\n" +
	"\x18ExamResponseSingleChoice\x12)\n" +
	"\x06choice\x18\x01 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x06choice\"I\n" +
	"\x1aExamResponseMultipleChoice\x12+\n" +
	"\achoices\x18\x01 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\achoices\"b\n" +
	"\vExamGrading\x12K\n" +
	"\tresponses\x18\x01 \x03(\v2-.resources.qualifications.ExamGradingResponseR\tresponses:\x06\xe2\xf3\x18\x02\b\x01\"y\n" +
