...
const file_resources_mailer_message_proto_rawDesc = "" +
	"\n" +
	"\x1eresources/mailer/message.proto\x12\x10resources.mailer\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a&resources/common/content/content.proto\x1a\x1cresources/mailer/email.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xa6\x05\n" +
	"\aMessage\x12\x0e\n" +
	...
	"\x05title\x18\b \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x05title\x12C\n" +
	...
	"\f_creator_job\"\\\n" +
	"\vMessageData\x12E\n" +
	"\vattachments\x18\x01 \x03(\v2#.resources.mailer.MessageAttachmentR\vattachments:\x06\xe2\xf3\x18\x02\b\x01\"f\n" +
	"\x11MessageAttachment\x12I\n" +
	"\bdocument\x18\x01 \x01(\v2+.resources.mailer.MessageAttachmentDocumentH\x00R\bdocumentB\x06\n" +
	"\x04data\"P\n" +
