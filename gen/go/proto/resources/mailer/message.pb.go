...
var file_resources_mailer_message_proto_rawDesc = []byte{
	...
	0x80, 0x10, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x36, 0x0a, 0x04, 0x64,
	...
	0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x44, 0x61, 0x74, 0x61, 0x42, 0x45, 0x5a, 0x43,
...
var file_resources_mailer_message_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_resources_mailer_message_proto_depIdxs = []int32{
	2, // 0: resources.mailer.Message.created_at:type_name -> resources.timestamp.Timestamp
	2, // 1: resources.mailer.Message.updated_at:type_name -> resources.timestamp.Timestamp
	2, // 2: resources.mailer.Message.deleted_at:type_name -> resources.timestamp.Timestamp
	1, // 3: resources.mailer.Message.data:type_name -> resources.mailer.MessageData
	3, // 4: resources.mailer.Message.creator:type_name -> resources.users.UserShort
