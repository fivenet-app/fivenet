...
// Validate checks the field values on EmailShort with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *EmailShort) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on EmailShort with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in EmailShortMultiError, or
// nil if none found.
func (m *EmailShort) ValidateAll() error {
	return m.validate(true)
}

func (m *EmailShort) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, EmailShortValidationError{
					field:  "CreatedAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return EmailShortValidationError{
				field:  "CreatedAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return EmailShortMultiError(errors)
	}

	return nil
}

// EmailShortMultiError is an error wrapping multiple validation errors
// returned by EmailShort.ValidateAll() if the designated constraints aren't met.
type EmailShortMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m EmailShortMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m EmailShortMultiError) AllErrors() []error { return m }

// EmailShortValidationError is the validation error returned by
// EmailShort.Validate if the designated constraints aren't met.
type EmailShortValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e EmailShortValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e EmailShortValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e EmailShortValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e EmailShortValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e EmailShortValidationError) ErrorName() string { return "EmailShortValidationError" }

// Error satisfies the builtin error interface
func (e EmailShortValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = EmailShortValidationError{}
