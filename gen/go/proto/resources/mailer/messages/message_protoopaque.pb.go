...
type Message struct {
	...
	xxx_hidden_SenderId    int64                  `protobuf:"varint,3,opt,name=sender_id,json=senderId,proto3"`
	xxx_hidden_Sender      *emails.Email          `protobuf:"bytes,4,opt,name=sender,proto3,oneof"`
	xxx_hidden_CreatedAt   *timestamp.Timestamp   `protobuf:"bytes,5,opt,name=created_at,json=createdAt,proto3"`
	xxx_hidden_UpdatedAt   *timestamp.Timestamp   `protobuf:"bytes,6,opt,name=updated_at,json=updatedAt,proto3,oneof"`
	xxx_hidden_DeletedAt   *timestamp.Timestamp   `protobuf:"bytes,7,opt,name=deleted_at,json=deletedAt,proto3,oneof"`
	...
	xxx_hidden_Data        *MessageData           `protobuf:"bytes,10,opt,name=data,proto3,oneof"`
	xxx_hidden_CreatorId   int32                  `protobuf:"varint,11,opt,name=creator_id,json=creatorId,proto3,oneof"`
	xxx_hidden_CreatorJob  *string                `protobuf:"bytes,12,opt,name=creator_job,json=creatorJob,proto3,oneof"`
...
type MessageData struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Attachments *[]*MessageAttachment  `protobuf:"bytes,1,rep,name=attachments,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type MessageAttachment struct {
	state           protoimpl.MessageState   `protogen:"opaque.v1"`
	xxx_hidden_Data isMessageAttachment_Data `protobuf_oneof:"data"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *MessageAttachment) GetDocument() *MessageAttachmentDocument {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*messageAttachment_Document); ok {
			return x.Document
		}
	}
	return nil
...
func (x *MessageAttachment) SetDocument(v *MessageAttachmentDocument) {
	...
	x.xxx_hidden_Data = &messageAttachment_Document{v}
}
...
func (x *MessageAttachment) HasDocument() bool {
	...
	_, ok := x.xxx_hidden_Data.(*messageAttachment_Document)
	return ok
}
...
func (x *MessageAttachment) ClearDocument() {
	if _, ok := x.xxx_hidden_Data.(*messageAttachment_Document); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (b0 MessageAttachment_builder) Build() *MessageAttachment {
	...
	_, _ = b, x
	if b.Document != nil {
		x.xxx_hidden_Data = &messageAttachment_Document{b.Document}
	}
	return m0
}
