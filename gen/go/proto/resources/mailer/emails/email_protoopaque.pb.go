...
const file_resources_mailer_emails_email_proto_rawDesc = "" +
	"\n" +
	"#resources/mailer/emails/email.proto\x12\x17resources.mailer.emails\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1dresources/access/access.proto\x1a(resources/mailer/settings/settings.proto\x1a#resources/timestamp/timestamp.proto\x1a resources/users/short/user.proto\"\x83\x06\n" +
	"\x05Email\x12\x0e\n" +
	...
	"\x05label\x18\v \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01H\x06R\x05label\x88\x01\x01\x120\n" +
