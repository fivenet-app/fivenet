...
func (x *MailerEvent) GetEmailUpdate() *Email {
	if x, ok := x.GetData().(*MailerEvent_EmailUpdate); ok {
...
func (x *MailerEvent) GetEmailDelete() uint64 {
	if x, ok := x.GetData().(*MailerEvent_EmailDelete); ok {
...
func (x *MailerEvent) GetThreadStateUpdate() *ThreadState {
	if x, ok := x.GetData().(*MailerEvent_ThreadStateUpdate); ok {
...
type MailerEvent_ThreadUpdate struct {
	ThreadUpdate *Thread `protobuf:"bytes,3,opt,name=thread_update,json=threadUpdate,proto3,oneof"`
}

type MailerEvent_ThreadDelete struct {
	ThreadDelete uint64 `protobuf:"varint,4,opt,name=thread_delete,json=threadDelete,proto3,oneof"`
}

type MailerEvent_MessageUpdate struct {
	MessageUpdate *Message `protobuf:"bytes,5,opt,name=message_update,json=messageUpdate,proto3,oneof"`
}

type MailerEvent_MessageDelete struct {
	MessageDelete uint64 `protobuf:"varint,6,opt,name=message_delete,json=messageDelete,proto3,oneof"`
}

type MailerEvent_ThreadStateUpdate struct {
	ThreadStateUpdate *ThreadState `protobuf:"bytes,7,opt,name=thread_state_update,json=threadStateUpdate,proto3,oneof"`
}
...
var file_resources_mailer_events_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_resources_mailer_events_proto_goTypes = []any{
	...
	(*Thread)(nil),      // 2: resources.mailer.Thread
...
var file_resources_mailer_events_proto_depIdxs = []int32{
	...
	2, // 1: resources.mailer.MailerEvent.thread_update:type_name -> resources.mailer.Thread
	3, // 2: resources.mailer.MailerEvent.message_update:type_name -> resources.mailer.Message
