...
type Access struct {
	...
	Users          []*UserAccess          `protobuf:"bytes,2,rep,name=users,proto3" json:"users,omitempty" alias:"citizen_access"`                   // @gotags: alias:"citizen_access"
...
const file_resources_mailer_access_proto_rawDesc = "" +
	"\n" +
	"\x1dresources/mailer/access.proto\x12\x10resources.mailer\x1a-resources/qualifications/qualifications.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x17validate/validate.proto\"\xda\x01\n" +
	"\x06Access\x129\n" +
	"\x04jobs\x18\x01 \x03(\v2\x1b.resources.mailer.JobAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\x04jobs\x12<\n" +
	"\x05users\x18\x02 \x03(\v2\x1c.resources.mailer.UserAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\x05users\x12W\n" +
	"\x0equalifications\x18\x03 \x03(\v2%.resources.mailer.QualificationAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\x0equalifications\"\x98\x03\n" +
	"\tJobAccess\x12\x0e\n" +
	...
	"\x0fjob_grade_label\x18\b \x01(\tB\a\xfaB\x04r\x02\x182H\x02R\rjobGradeLabel\x88\x01\x01\x12?\n" +
	"\x06access\x18\t \x01(\x0e2\x1d.resources.mailer.AccessLevelB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06accessB\r\n" +
	"\v_created_atB\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
	...
	"\x06access\x18\x06 \x01(\x0e2\x1d.resources.mailer.AccessLevelB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06accessB\r\n" +
	"\v_created_atB\a\n" +
	"\x05_user\"\xec\x02\n" +
