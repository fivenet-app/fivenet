...
type ThreadJobAccess struct {
	...
	Access        AccessLevel          `protobuf:"varint,8,opt,name=access,proto3,enum=resources.mailer.AccessLevel" json:"access,omitempty"`
}
...
var file_resources_mailer_access_proto_rawDesc = []byte{
	...
	0x0c, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x3f, 0x0a,
	0x04, 0x6a, 0x6f, 0x62, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x6d, 0x61, 0x69, 0x6c, 0x65, 0x72, 0x2e, 0x54,
	0x68, 0x72, 0x65, 0x61, 0x64, 0x4a, 0x6f, 0x62, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x42, 0x08,
	0xfa, 0x42, 0x05, 0x92, 0x01, 0x02, 0x10, 0x14, 0x52, 0x04, 0x6a, 0x6f, 0x62, 0x73, 0x12, 0x42,
	...
	0x2e, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x55, 0x73, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x92, 0x01, 0x02, 0x10, 0x14, 0x52, 0x05, 0x75, 0x73, 0x65,
	0x72, 0x73, 0x22, 0xa6, 0x03, 0x0a, 0x0f, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x4a, 0x6f, 0x62,
	...
	0x65, 0x73, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x72, 0x65, 0x73, 0x6f,
	...
	0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0xbb, 0x02, 0x0a, 0x10,
	0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x55, 0x73, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	...
	0x42, 0x07, 0x0a, 0x05, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x2a, 0xa7, 0x01, 0x0a, 0x0b, 0x41, 0x63,
	...
	0x4c, 0x5f, 0x56, 0x49, 0x45, 0x57, 0x10, 0x02, 0x12, 0x18, 0x0a, 0x14, 0x41, 0x43, 0x43, 0x45,
	0x53, 0x53, 0x5f, 0x4c, 0x45, 0x56, 0x45, 0x4c, 0x5f, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45,
	0x10, 0x03, 0x12, 0x17, 0x0a, 0x13, 0x41, 0x43, 0x43, 0x45, 0x53, 0x53, 0x5f, 0x4c, 0x45, 0x56,
	0x45, 0x4c, 0x5f, 0x4d, 0x41, 0x4e, 0x41, 0x47, 0x45, 0x10, 0x04, 0x12, 0x16, 0x0a, 0x12, 0x41,
	0x43, 0x43, 0x45, 0x53, 0x53, 0x5f, 0x4c, 0x45, 0x56, 0x45, 0x4c, 0x5f, 0x41, 0x44, 0x4d, 0x49,
	0x4e, 0x10, 0x05, 0x42, 0x45, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_resources_mailer_access_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_resources_mailer_access_proto_goTypes = []any{
	(AccessLevel)(0),            // 0: resources.mailer.AccessLevel
	(*ThreadAccess)(nil),        // 1: resources.mailer.ThreadAccess
	(*ThreadJobAccess)(nil),     // 2: resources.mailer.ThreadJobAccess
	(*ThreadUserAccess)(nil),    // 3: resources.mailer.ThreadUserAccess
...
var file_resources_mailer_access_proto_depIdxs = []int32{
	2, // 0: resources.mailer.ThreadAccess.jobs:type_name -> resources.mailer.ThreadJobAccess
	3, // 1: resources.mailer.ThreadAccess.users:type_name -> resources.mailer.ThreadUserAccess
	4, // 2: resources.mailer.ThreadJobAccess.created_at:type_name -> resources.timestamp.Timestamp
	0, // 3: resources.mailer.ThreadJobAccess.access:type_name -> resources.mailer.AccessLevel
	4, // 4: resources.mailer.ThreadUserAccess.created_at:type_name -> resources.timestamp.Timestamp
	5, // 5: resources.mailer.ThreadUserAccess.user:type_name -> resources.users.UserShort
	0, // 6: resources.mailer.ThreadUserAccess.access:type_name -> resources.mailer.AccessLevel
