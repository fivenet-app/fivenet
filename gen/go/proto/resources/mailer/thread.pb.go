...
const file_resources_mailer_thread_proto_rawDesc = "" +
	"\n" +
	"\x1dresources/mailer/thread.proto\x12\x10resources.mailer\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1cresources/mailer/email.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x13tagger/tagger.proto\"\xd3\x05\n" +
	"\x06Thread\x12\x0e\n" +
	...
	"\acreator\x18\b \x01(\v2\x1a.resources.users.UserShortB\x14\x9a\x84\x9e\x03\x0falias:\"creator\"H\x04R\acreator\x88\x01\x01\x12\x1e\n" +
	"\x05title\x18\t \x01(\tB\b\xda\xf3\x18\x04\b\x01\x18\x01R\x05title\x12F\n" +
	"\n" +
	"recipients\x18\n" +
