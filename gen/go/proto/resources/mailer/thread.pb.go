...
var file_resources_mailer_thread_proto_goTypes = []interface{}{
...
func file_resources_mailer_thread_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_mailer_thread_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Thread); i {
			case 0:
				return &v.state
			case 1:
		...
		file_resources_mailer_thread_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ThreadRecipientEmail); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_resources_mailer_thread_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ThreadState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_resources_mailer_thread_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_resources_mailer_thread_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_resources_mailer_thread_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
