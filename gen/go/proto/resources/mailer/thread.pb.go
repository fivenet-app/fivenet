...
const file_resources_mailer_thread_proto_rawDesc = "" +
	"\n" +
	"\x1dresources/mailer/thread.proto\x12\x10resources.mailer\x1a\x1cresources/mailer/email.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x17validate/validate.proto\"\xb7\x05\n" +
	"\x06Thread\x12\x0e\n" +
	...
	"\x05title\x18\t \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x03\x18\xff\x01R\x05title\x12P\n" +
	"\n" +
	"recipients\x18\n" +
	" \x03(\v2&.resources.mailer.ThreadRecipientEmailB\b\xfaB\x05\x92\x01\x02\x10\x14R\n" +
	"recipients\x128\n" +
	"\x05state\x18\v \x01(\v2\x1d.resources.mailer.ThreadStateH\x05R\x05state\x88\x01\x01B\r\n" +
	"\v_updated_atB\r\n" +
	"\v_deleted_atB\x10\n" +
	"\x0e_creator_emailB\r\n" +
	"\v_creator_idB\n" +
	...
	"\b_creatorB\b\n" +
	"\x06_state\"\xef\x01\n" +
	"\x14ThreadRecipientEmail\x12\x0e\n" +
