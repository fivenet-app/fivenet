...
const file_resources_mailer_template_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/mailer/template.proto\x12\x10resources.mailer\x1a#resources/timestamp/timestamp.proto\x1a\x17validate/validate.proto\"\xdd\x03\n" +
	"\bTemplate\x12\x0e\n" +
	...
	"\xfaB\ar\x05\x10\x03\x18\x80PR\acontent\x12-\n" +
	"\vcreator_job\x18\t \x01(\tB\a\xfaB\x04r\x02\x18(H\x02R\n" +
	"creatorJob\x88\x01\x01\x12+\n" +
	"\n" +
	"creator_id\x18\n" +
	" \x01(\x05B\a\xfaB\x04\x1a\x02 \x00H\x03R\tcreatorId\x88\x01\x01B\r\n" +
	"\v_updated_atB\r\n" +
	"\v_deleted_atB\x0e\n" +
	"\f_creator_jobB\r\n" +
