...
const file_resources_mailer_email_proto_rawDesc = "" +
	"\n" +
	"\x1cresources/mailer/email.proto\x12\x10resources.mailer\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1dresources/mailer/access.proto\x1a\x1fresources/mailer/settings.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\"\xe3\x05\n" +
	"\x05Email\x12\x0e\n" +
	...
	"\auser_id\x18\a \x01(\x05H\x03R\x06userId\x88\x01\x01\x123\n" +
	"\x04user\x18\b \x01(\v2\x1a.resources.users.UserShortH\x04R\x04user\x88\x01\x01\x12'\n" +
	"\x05email\x18\t \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x05email\x12H\n" +
	"\remail_changed\x18\n" +
	" \x01(\v2\x1e.resources.timestamp.TimestampH\x05R\femailChanged\x88\x01\x01\x12,\n" +
	"\x05label\x18\v \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x06R\x05label\x88\x01\x01\x120\n" +
