...
var file_resources_mailer_email_proto_goTypes = []interface{}{
...
func file_resources_mailer_email_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_mailer_email_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Email); i {
			case 0:
				return &v.state
			case 1:
	...
	file_resources_mailer_email_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
