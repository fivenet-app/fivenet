...
const file_resources_mailer_threads_thread_proto_rawDesc = "" +
	"\n" +
	"%resources/mailer/threads/thread.proto\x12\x18resources.mailer.threads\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/mailer/emails/email.proto\x1a#resources/timestamp/timestamp.proto\x1a resources/users/short/user.proto\x1a\x13tagger/tagger.proto\"\x8d\x06\n" +
	"\x06Thread\x12\x0e\n" +
	...
	"\x05title\x18\t \x01(\tB\x12\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\ar\x05\x10\x03\x18\xff\x01R\x05title\x12X\n" +
	"\n" +
	"recipients\x18\n" +
	" \x03(\v2..resources.mailer.threads.ThreadRecipientEmailB\b\xbaH\x05\x92\x01\x02\x10\x14R\n" +
	"recipients\x12[\n" +
