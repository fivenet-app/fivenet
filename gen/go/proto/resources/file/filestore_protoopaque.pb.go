...
const file_resources_file_filestore_proto_rawDesc = "" +
	"\n" +
	"\x1eresources/file/filestore.proto\x12\x0eresources.file\x1a\x1ccodegen/audit/redacted.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x19resources/file/file.proto\"|\n" +
	"\x11UploadFileRequest\x120\n" +
	"\x04meta\x18\x01 \x01(\v2\x1a.resources.file.UploadMetaH\x00R\x04meta\x12#\n" +
	"\x04data\x18\x02 \x01(\fB\r\xf0\xf3\x18\x01\xbaH\x06z\x04\x18\x80\x80\bH\x00R\x04dataB\x10\n" +
	"\apayload\x12\x05\xbaH\x02\b\x01\"\xe3\x01\n" +
	"\n" +
	"UploadMeta\x12\x1b\n" +
