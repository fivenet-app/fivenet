...
const file_resources_file_file_proto_rawDesc = "" +
	"\n" +
	"\x19resources/file/file.proto\x12\x0eresources.file\x1a\x19resources/file/meta.proto\x1a#resources/timestamp/timestamp.proto\x1a\x17validate/validate.proto\"\xc4\x02\n" +
	"\x04File\x12)\n" +
	"\tparent_id\x18\x01 \x01(\x04B\a\xfaB\x042\x02 \x00H\x00R\bparentId\x88\x01\x01\x12\x17\n" +
	"\x02id\x18\x02 \x01(\x04B\a\xfaB\x042\x02 \x00R\x02id\x12\x1b\n" +
