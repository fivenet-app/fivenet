...
type FileMeta struct {
	...
	xxx_hidden_Meta isFileMeta_Meta        `protobuf_oneof:"meta"`
...
func (x *FileMeta) GetImage() *ImageMeta {
	if x != nil {
		if x, ok := x.xxx_hidden_Meta.(*fileMeta_Image); ok {
			return x.Image
		}
	}
	return nil
...
func (x *FileMeta) SetImage(v *ImageMeta) {
	...
	x.xxx_hidden_Meta = &fileMeta_Image{v}
}
...
func (x *FileMeta) HasImage() bool {
	...
	_, ok := x.xxx_hidden_Meta.(*fileMeta_Image)
	return ok
}
...
func (x *FileMeta) ClearImage() {
	if _, ok := x.xxx_hidden_Meta.(*fileMeta_Image); ok {
		x.xxx_hidden_Meta = nil
	}
}
...
type FileMeta_builder struct {
	...
	// Fields of oneof xxx_hidden_Meta:
	Image *ImageMeta
	// -- end of xxx_hidden_Meta
}
...
func (b0 FileMeta_builder) Build() *FileMeta {
	...
	_, _ = b, x
	if b.Image != nil {
		x.xxx_hidden_Meta = &fileMeta_Image{b.Image}
	}
	return m0
}
...
type ImageMeta struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Width  int64                  `protobuf:"varint,1,opt,name=width,proto3"`
	xxx_hidden_Height int64                  `protobuf:"varint,2,opt,name=height,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
