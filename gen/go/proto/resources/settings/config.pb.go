...
const file_resources_settings_config_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/settings/config.proto\x12\x12resources.settings\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fresources/settings/banner.proto\"\x9b\x04\n" +
	"\tAppConfig\x12\x1d\n" +
	...
	"\x05Perms\x122\n" +
	"\adefault\x18\x01 \x03(\v2\x18.resources.settings.PermR\adefault\"\\\n" +
	"\x04Perm\x12-\n" +
	"\bcategory\x18\x01 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\bcategory\x12%\n" +
	"\x04name\x18\x02 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x04name\"Y\n" +
	"\aWebsite\x12/\n" +
	"\x05links\x18\x01 \x01(\v2\x19.resources.settings.LinksR\x05links\x12\x1d\n" +
	"\n" +
	"stats_page\x18\x02 \x01(\bR\tstatsPage\"\x97\x01\n" +
	"\x05Links\x12=\n" +
	"\x0eprivacy_policy\x18\x01 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x00R\rprivacyPolicy\x88\x01\x01\x120\n" +
	"\aimprint\x18\x02 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x01R\aimprint\x88\x01\x01B\x11\n" +
	"\x0f_privacy_policyB\n" +
	"\n" +
	"\b_imprint\"\xbb\x01\n" +
	"\aJobInfo\x12H\n" +
	"\x0eunemployed_job\x18\x01 \x01(\v2!.resources.settings.UnemployedJobR\runemployedJob\x122\n" +
	"\vpublic_jobs\x18\x02 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\n" +
	"publicJobs\x122\n" +
	"\vhidden_jobs\x18\x03 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\n" +
	"hiddenJobs\"9\n" +
	...
	"\x0fdb_refresh_time\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rdbRefreshTime\"\xa3\x03\n" +
	"\aDiscord\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12>\n" +
	"\rsync_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\fsyncInterval\x125\n" +
	"\n" +
	"invite_url\x18\x03 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x00R\tinviteUrl\x88\x01\x01\x124\n" +
	"\fignored_jobs\x18\x04 \x03(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\vignoredJobs\x12N\n" +
	"\fbot_presence\x18\x05 \x01(\v2&.resources.settings.DiscordBotPresenceH\x01R\vbotPresence\x88\x01\x01\x12-\n" +
	"\x06bot_id\x18\x06 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x02R\x05botId\x88\x01\x01\x12'\n" +
	...
	"\x0ebanner_message\x18\x02 \x01(\v2!.resources.settings.BannerMessageR\rbannerMessage\"\x8a\x01\n" +
	"\aDisplay\x127\n" +
	"\vintl_locale\x18\x01 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x00R\n" +
	"intlLocale\x88\x01\x01\x126\n" +
	"\rcurrency_name\x18\x02 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\fcurrencyNameB\x0e\n" +
