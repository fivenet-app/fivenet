...
const file_resources_settings_config_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/settings/config.proto\x12\x12resources.settings\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fresources/settings/banner.proto\x1a\x17validate/validate.proto\"\xe3\x03\n" +
	"\tAppConfig\x12\x1d\n" +
	...
	"\x05Perms\x12<\n" +
	"\adefault\x18\x01 \x03(\v2\x18.resources.settings.PermB\b\xfaB\x05\x92\x01\x02\x10dR\adefault\"J\n" +
	"\x04Perm\x12$\n" +
	"\bcategory\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\bcategory\x12\x1c\n" +
	"\x04name\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xff\x01R\x04name\"Y\n" +
	"\aWebsite\x12/\n" +
	...
	"\b_imprint\"\xb3\x01\n" +
	"\aJobInfo\x12R\n" +
	"\x0eunemployed_job\x18\x01 \x01(\v2!.resources.settings.UnemployedJobB\b\xfaB\x05\x8a\x01\x02\x10\x01R\runemployedJob\x12)\n" +
