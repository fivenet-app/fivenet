...
const file_resources_settings_banner_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/settings/banner.proto\x12\x12resources.settings\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\x85\x03\n" +
	"\rBannerMessage\x12\x1f\n" +
	"\x02id\x18\x01 \x01(\tB\x0f\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x04r\x02\x18@R\x02id\x12)\n" +
	"\x05title\x18\x02 \x01(\tB\x13\xda\xf3\x18\x02\b\x01\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x03\x18\x80\x04R\x05title\x12)\n" +
	"\x04icon\x18\x03 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01H\x00R\x04icon\x88\x01\x01\x12*\n" +
	"\x05color\x18\x04 \x01(\tB\x0f\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x04r\x02\x18\fH\x01R\x05color\x88\x01\x01\x12T\n" +
	"\n" +
