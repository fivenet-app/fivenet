...
const file_resources_settings_config_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/settings/config.proto\x12\x12resources.settings\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fresources/settings/banner.proto\x1a\x1dresources/settings/data.proto\x1a\x13tagger/tagger.proto\"\xed\x05\n" +
	"\tAppConfig\x12\x18\n" +
	...
	"\x05Perms\x12<\n" +
	"\adefault\x18\x01 \x03(\v2\x18.resources.settings.PermB\b\xbaH\x05\x92\x01\x02\x10dR\adefault\"Z\n" +
	"\x04Perm\x12,\n" +
