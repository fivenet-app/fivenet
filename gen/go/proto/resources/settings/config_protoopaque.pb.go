...
type AppConfig struct {
	...
	xxx_hidden_SetupComplete bool                   `protobuf:"varint,15,opt,name=setup_complete,json=setupComplete,proto3,oneof"`
...
type Auth struct {
	...
	xxx_hidden_JobAdminGroups    []string               `protobuf:"bytes,3,rep,name=job_admin_groups,json=jobAdminGroups,proto3"`
	xxx_hidden_JobAdminUsers     []string               `protobuf:"bytes,4,rep,name=job_admin_users,json=jobAdminUsers,proto3"`
	xxx_hidden_ConfigAdminGroups []string               `protobuf:"bytes,5,rep,name=config_admin_groups,json=configAdminGroups,proto3"`
	xxx_hidden_ConfigAdminUsers  []string               `protobuf:"bytes,6,rep,name=config_admin_users,json=configAdminUsers,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *Auth) GetJobAdminGroups() []string {
	if x != nil {
		return x.xxx_hidden_JobAdminGroups
	}
	return nil
}
...
func (x *Auth) GetJobAdminUsers() []string {
	if x != nil {
		return x.xxx_hidden_JobAdminUsers
	}
	return nil
}
...
func (x *Auth) GetConfigAdminGroups() []string {
	if x != nil {
		return x.xxx_hidden_ConfigAdminGroups
	}
	return nil
}
...
func (x *Auth) GetConfigAdminUsers() []string {
	if x != nil {
		return x.xxx_hidden_ConfigAdminUsers
	}
	return nil
}
...
func (x *Auth) SetJobAdminGroups(v []string) {
	x.xxx_hidden_JobAdminGroups = v
}

func (x *Auth) SetJobAdminUsers(v []string) {
	x.xxx_hidden_JobAdminUsers = v
}

func (x *Auth) SetConfigAdminGroups(v []string) {
	x.xxx_hidden_ConfigAdminGroups = v
}

func (x *Auth) SetConfigAdminUsers(v []string) {
	x.xxx_hidden_ConfigAdminUsers = v
}
...
func (b0 Auth_builder) Build() *Auth {
	...
	x.xxx_hidden_JobAdminGroups = b.JobAdminGroups
	x.xxx_hidden_JobAdminUsers = b.JobAdminUsers
	x.xxx_hidden_ConfigAdminGroups = b.ConfigAdminGroups
	x.xxx_hidden_ConfigAdminUsers = b.ConfigAdminUsers
	return m0
}
...
const file_resources_settings_config_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/settings/config.proto\x12\x12resources.settings\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fresources/settings/banner.proto\x1a\x1dresources/settings/data.proto\x1a\x13tagger/tagger.proto\"\xb5\x06\n" +
	"\tAppConfig\x12!\n" +
	"\aversion\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x18dR\aversion\x12*\n" +
	...
	"\x0f_setup_complete\"\xc3\x02\n" +
	"\x04Auth\x12%\n" +
	"\x0esignup_enabled\x18\x01 \x01(\bR\rsignupEnabled\x12$\n" +
	"\x0elast_char_lock\x18\x02 \x01(\bR\flastCharLock\x128\n" +
	"\x10job_admin_groups\x18\x03 \x03(\tB\x0e\xbaH\v\x92\x01\b\x10\n" +
	"\"\x04r\x02\x18@R\x0ejobAdminGroups\x126\n" +
	"\x0fjob_admin_users\x18\x04 \x03(\tB\x0e\xbaH\v\x92\x01\b\x10\n" +
	"\"\x04r\x02\x18@R\rjobAdminUsers\x12>\n" +
	"\x13config_admin_groups\x18\x05 \x03(\tB\x0e\xbaH\v\x92\x01\b\x10\n" +
	"\"\x04r\x02\x18@R\x11configAdminGroups\x12<\n" +
	"\x12config_admin_users\x18\x06 \x03(\tB\x0e\xbaH\v\x92\x01\b\x10\n" +
	"\"\x04r\x02\x18@R\x10configAdminUsers\"E\n" +
	"\x05Perms\x12<\n" +
	"\adefault\x18\x01 \x03(\v2\x18.resources.settings.PermB\b\xbaH\x05\x92\x01\x02\x102R\adefault\"Z\n" +
	"\x04Perm\x12,\n" +
	"\bcategory\x18\x01 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01R\bcategory\x12$\n" +
	"\x04name\x18\x02 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\xff\x01R\x04name\"p\n" +
	"\aWebsite\x12/\n" +
	"\x05links\x18\x01 \x01(\v2\x19.resources.settings.LinksR\x05links\x124\n" +
	"\n" +
	"stats_page\x18\x02 \x01(\bB\x15\x9a\x84\x9e\x03\x10json:\"statsPage\"R\tstatsPage\"\x95\x01\n" +
	"\x05Links\x12<\n" +
	"\x0eprivacy_policy\x18\x01 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\xff\x01H\x00R\rprivacyPolicy\x88\x01\x01\x12/\n" +
	"\aimprint\x18\x02 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\xff\x01H\x01R\aimprint\x88\x01\x01B\x11\n" +
	"\x0f_privacy_policyB\n" +
	"\n" +
	"\b_imprint\"\xc1\x01\n" +
	"\aJobInfo\x12P\n" +
	"\x0eunemployed_job\x18\x01 \x01(\v2!.resources.settings.UnemployedJobB\x06\xbaH\x03\xc8\x01\x01R\runemployedJob\x121\n" +
	"\vpublic_jobs\x18\x02 \x03(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05\x92\x01\x02\x10dR\n" +
	"publicJobs\x121\n" +
	"\vhidden_jobs\x18\x03 \x03(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05\x92\x01\x02\x10dR\n" +
	"hiddenJobs\"K\n" +
	...
	"\x0fdb_refresh_time\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x15\xbaH\x12\xc8\x01\x01\xaa\x01\f\x1a\x02\b<2\x06\x10\x80ʵ\xee\x01R\rdbRefreshTime\"\xb6\x03\n" +
	"\aDiscord\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12T\n" +
	"\rsync_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x14\xbaH\x11\xc8\x01\x01\xaa\x01\v\x1a\x05\b\x80\xaa\xeaU2\x02\b<R\fsyncInterval\x124\n" +
	"\n" +
	"invite_url\x18\x03 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\xff\x01H\x00R\tinviteUrl\x88\x01\x01\x123\n" +
	"\fignored_jobs\x18\x04 \x03(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05\x92\x01\x02\x10dR\vignoredJobs\x12N\n" +
	"\fbot_presence\x18\x05 \x01(\v2&.resources.settings.DiscordBotPresenceH\x01R\vbotPresence\x88\x01\x01\x12,\n" +
	"\x06bot_id\x18\x06 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\xff\x01H\x02R\x05botId\x88\x01\x01\x12'\n" +
	"\x0fbot_permissions\x18\a \x01(\x03R\x0ebotPermissionsB\r\n" +
	"\v_invite_urlB\x0f\n" +
	"\r_bot_presenceB\t\n" +
	"\a_bot_id\"\xb9\x01\n" +
	"\x12DiscordBotPresence\x12H\n" +
	"\x04type\x18\x01 \x01(\x0e2*.resources.settings.DiscordBotPresenceTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04type\x12%\n" +
	...
	"\x0ebanner_message\x18\x02 \x01(\v2!.resources.settings.BannerMessageR\rbannerMessage\"\xa0\x01\n" +
	"\aDisplay\x12F\n" +
	"\vintl_locale\x18\x01 \x01(\tB%\xda\xf3\x18\x04\b\x01\x18\x01\x9a\x84\x9e\x03\x11json:\"intlLocale\"\xbaH\x04r\x02\x18 R\n" +
	"intlLocale\x12M\n" +
	"\rcurrency_name\x18\x02 \x01(\tB(\xda\xf3\x18\x04\b\x01\x18\x01\x9a\x84\x9e\x03\x13json:\"currencyName\"\xbaH\x05r\x03\x98\x01\x03R\fcurrencyName\"\x83\x01\n" +
	"\fQuickButtons\x12s\n" +
	...
	"\r_warn_message\"7\n" +
	"\aLivemap\x12,\n" +
	"\x12enable_cayo_perico\x18\x01 \x01(\bR\x10enableCayoPerico\"\xbd\x03\n" +
	"\x04Game\x12F\n" +
	" max_wanted_duration_user_enabled\x18\x04 \x01(\bR\x1cmaxWantedDurationUserEnabled\x12m\n" +
	"\x18max_wanted_duration_user\x18\x05 \x01(\v2\x19.google.protobuf.DurationB\x14\xbaH\x11\xaa\x01\x0e\"\x06\b\x80\x86\xb0\x96\x012\x04\b\x80\xa3\x05H\x00R\x15maxWantedDurationUser\x88\x01\x01\x12L\n" +
	"#max_wanted_duration_vehicle_enabled\x18\x06 \x01(\bR\x1fmaxWantedDurationVehicleEnabled\x12s\n" +
	"\x1bmax_wanted_duration_vehicle\x18\a \x01(\v2\x19.google.protobuf.DurationB\x14\xbaH\x11\xaa\x01\x0e\"\x06\b\x80\x86\xb0\x96\x012\x04\b\x80\xa3\x05H\x01R\x18maxWantedDurationVehicle\x88\x01\x01B\x1b\n" +
