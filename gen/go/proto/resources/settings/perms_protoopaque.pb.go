...
type PermsUpdate struct {
	...
	xxx_hidden_ToUpdate *[]*permissions.PermItem `protobuf:"bytes,1,rep,name=to_update,json=toUpdate,proto3"`
	xxx_hidden_ToRemove *[]*permissions.PermItem `protobuf:"bytes,2,rep,name=to_remove,json=toRemove,proto3"`
...
type AttrsUpdate struct {
	state               protoimpl.MessageState       `protogen:"opaque.v1"`
	xxx_hidden_ToUpdate *[]*attributes.RoleAttribute `protobuf:"bytes,1,rep,name=to_update,json=toUpdate,proto3"`
	xxx_hidden_ToRemove *[]*attributes.RoleAttribute `protobuf:"bytes,2,rep,name=to_remove,json=toRemove,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
