...
const file_resources_settings_banner_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/settings/banner.proto\x12\x12resources.settings\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xfd\x02\n" +
	"\rBannerMessage\x12!\n" +
	"\x02id\x18\x01 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x02id\x12\x1c\n" +
	"\x05title\x18\x02 \x01(\tB\x06\xda\xf3\x18\x02\b\x01R\x05title\x12*\n" +
	"\x04icon\x18\x03 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x00R\x04icon\x88\x01\x01\x12,\n" +
	"\x05color\x18\x04 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsH\x01R\x05color\x88\x01\x01\x12T\n" +
	"\n" +
