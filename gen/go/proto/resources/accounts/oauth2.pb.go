...
func (x *OAuth2Account) GetProfilePicture() string {
	if x != nil {
...
const file_resources_accounts_oauth2_proto_rawDesc = "" +
	"\n" +
	"\x1fresources/accounts/oauth2.proto\x12\x12resources.accounts\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xfa\x02\n" +
	...
	"\rprovider_name\x18\x03 \x01(\tB,\x9a\x84\x9e\x03'sql:\"primary_key\" alias:\"provider_name\"R\fproviderName\x12>\n" +
	...
	"\x0fprofile_picture\x18\a \x01(\tR\x0eprofilePictureB\r\n" +
	"\v_created_at\"x\n" +
	...
	"\x05_iconBOZMgithub.com/fivenet-app/fivenet/v2025/gen/go/proto/resources/accounts;accountsb\x06proto3"
