...
type OAuth2Account struct {
	...
	xxx_hidden_ProviderName string                 `protobuf:"bytes,3,opt,name=provider_name,json=providerName,proto3"`
	xxx_hidden_Provider     *OAuth2Provider        `protobuf:"bytes,4,opt,name=provider,proto3"`
	xxx_hidden_ExternalId   string                 `protobuf:"bytes,5,opt,name=external_id,json=externalId,proto3"`
	xxx_hidden_Username     string                 `protobuf:"bytes,6,opt,name=username,proto3"`
	xxx_hidden_Avatar       string                 `protobuf:"bytes,7,opt,name=avatar,proto3"`
...
func (x *OAuth2Account) Reset() {
	*x = OAuth2Account{}
	mi := &file_resources_accounts_oauth2_oauth2_proto_msgTypes[0]
...
type OAuth2Provider struct {
	...
	xxx_hidden_Homepage    string                 `protobuf:"bytes,3,opt,name=homepage,proto3"`
...
func (x *OAuth2Provider) Reset() {
	*x = OAuth2Provider{}
	mi := &file_resources_accounts_oauth2_oauth2_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_resources_accounts_oauth2_oauth2_proto_rawDesc = "" +
	"\n" +
	"&resources/accounts/oauth2/oauth2.proto\x12\x19resources.accounts.oauth2\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\x96\x03\n" +
	...
	"\rprovider_name\x18\x03 \x01(\tB4\x9a\x84\x9e\x03'sql:\"primary_key\" alias:\"provider_name\"\xbaH\x05r\x03\x18\xff\x01R\fproviderName\x12E\n" +
	"\bprovider\x18\x04 \x01(\v2).resources.accounts.oauth2.OAuth2ProviderR\bprovider\x12)\n" +
	"\vexternal_id\x18\x05 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x01R\n" +
	"externalId\x12$\n" +
	"\busername\x18\x06 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\busername\x12 \n" +
	"\x06avatar\x18\a \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01R\x06avatarB\r\n" +
	"\v_created_at\"x\n" +
...
var file_resources_accounts_oauth2_oauth2_proto_goTypes = []any{
	(*OAuth2Account)(nil),       // 0: resources.accounts.oauth2.OAuth2Account
	(*OAuth2Provider)(nil),      // 1: resources.accounts.oauth2.OAuth2Provider
	(*timestamp.Timestamp)(nil), // 2: resources.timestamp.Timestamp
}
var file_resources_accounts_oauth2_oauth2_proto_depIdxs = []int32{
	2, // 0: resources.accounts.oauth2.OAuth2Account.created_at:type_name -> resources.timestamp.Timestamp
	1, // 1: resources.accounts.oauth2.OAuth2Account.provider:type_name -> resources.accounts.oauth2.OAuth2Provider
...
func init() { file_resources_accounts_oauth2_oauth2_proto_init() }
func file_resources_accounts_oauth2_oauth2_proto_init() {
	if File_resources_accounts_oauth2_oauth2_proto != nil {
		return
	}
	file_resources_accounts_oauth2_oauth2_proto_msgTypes[0].OneofWrappers = []any{}
	file_resources_accounts_oauth2_oauth2_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_accounts_oauth2_oauth2_proto_rawDesc), len(file_resources_accounts_oauth2_oauth2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_accounts_oauth2_oauth2_proto_goTypes,
		DependencyIndexes: file_resources_accounts_oauth2_oauth2_proto_depIdxs,
		MessageInfos:      file_resources_accounts_oauth2_oauth2_proto_msgTypes,
	}.Build()
	File_resources_accounts_oauth2_oauth2_proto = out.File
	file_resources_accounts_oauth2_oauth2_proto_goTypes = nil
	file_resources_accounts_oauth2_oauth2_proto_depIdxs = nil
}
