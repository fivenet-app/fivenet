...
type UsersUpdateEvent struct {
	...
	Updated []*UserMarker `protobuf:"bytes,3,rep,name=updated,proto3" json:"updated,omitempty"`
}
...
func (x *UsersUpdateEvent) GetUpdated() []*UserMarker {
	if x != nil {
		return x.Updated
	}
	return nil
...
var file_resources_livemap_tracker_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x01, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x73, 0x55,
	...
	0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x12, 0x37, 0x0a, 0x07, 0x75, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6d, 0x61, 0x70, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x72, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
...
var file_resources_livemap_tracker_proto_depIdxs = []int32{
	...
	1, // 2: resources.livemap.UsersUpdateEvent.updated:type_name -> resources.livemap.UserMarker
