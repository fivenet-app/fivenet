...
type UserMarkerData struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_IsInVehicle      bool                   `protobuf:"varint,1,opt,name=is_in_vehicle,json=isInVehicle,proto3"`
	xxx_hidden_VehiclePlate     *string                `protobuf:"bytes,2,opt,name=vehicle_plate,json=vehiclePlate,proto3,oneof"`
	xxx_hidden_VehicleUpdatedAt *timestamp.Timestamp   `protobuf:"bytes,3,opt,name=vehicle_updated_at,json=vehicleUpdatedAt,proto3,oneof"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
