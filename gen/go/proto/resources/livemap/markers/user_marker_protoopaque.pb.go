...
type UserMarker struct {
	...
	xxx_hidden_Job         string                 `protobuf:"bytes,7,opt,name=job,proto3"`
	xxx_hidden_JobLabel    string                 `protobuf:"bytes,8,opt,name=job_label,json=jobLabel,proto3"`
	xxx_hidden_JobGrade    int32                  `protobuf:"varint,13,opt,name=job_grade,json=jobGrade,proto3,oneof"`
	xxx_hidden_User        *colleagues.Colleague  `protobuf:"bytes,9,opt,name=user,proto3"`
	xxx_hidden_UnitId      int64                  `protobuf:"varint,10,opt,name=unit_id,json=unitId,proto3,oneof"`
	xxx_hidden_Unit        *units.Unit            `protobuf:"bytes,11,opt,name=unit,proto3,oneof"`
	xxx_hidden_Hidden      bool                   `protobuf:"varint,12,opt,name=hidden,proto3"`
	xxx_hidden_Data        *UserMarkerData        `protobuf:"bytes,14,opt,name=data,proto3,oneof"`
...
type UserMarkerData struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_NameOverride     *NameOverride          `protobuf:"bytes,1,opt,name=name_override,json=nameOverride,proto3,oneof"`
	xxx_hidden_IsInVehicle      bool                   `protobuf:"varint,2,opt,name=is_in_vehicle,json=isInVehicle,proto3"`
	xxx_hidden_VehiclePlate     *string                `protobuf:"bytes,3,opt,name=vehicle_plate,json=vehiclePlate,proto3,oneof"`
	xxx_hidden_VehicleUpdatedAt *timestamp.Timestamp   `protobuf:"bytes,4,opt,name=vehicle_updated_at,json=vehicleUpdatedAt,proto3,oneof"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *UserMarkerData) GetNameOverride() *NameOverride {
	if x != nil {
		return x.xxx_hidden_NameOverride
	}
	return nil
}
...
func (x *UserMarkerData) GetIsInVehicle() bool {
	if x != nil {
		return x.xxx_hidden_IsInVehicle
	}
	return false
}
...
func (x *UserMarkerData) GetVehiclePlate() string {
	if x != nil {
		if x.xxx_hidden_VehiclePlate != nil {
			return *x.xxx_hidden_VehiclePlate
		}
		return ""
	}
	return ""
...
func (x *UserMarkerData) HasNameOverride() bool {
	...
	return x.xxx_hidden_NameOverride != nil
}
...
func (x *UserMarkerData) HasVehicleUpdatedAt() bool {
	...
	return x.xxx_hidden_VehicleUpdatedAt != nil
}

func (x *UserMarkerData) ClearNameOverride() {
	x.xxx_hidden_NameOverride = nil
}

func (x *UserMarkerData) ClearVehiclePlate() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_VehiclePlate = nil
}

func (x *UserMarkerData) ClearVehicleUpdatedAt() {
	x.xxx_hidden_VehicleUpdatedAt = nil
}
...
func (b0 UserMarkerData_builder) Build() *UserMarkerData {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_NameOverride = b.NameOverride
	x.xxx_hidden_IsInVehicle = b.IsInVehicle
	if b.VehiclePlate != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 4)
		x.xxx_hidden_VehiclePlate = b.VehiclePlate
	}
	x.xxx_hidden_VehicleUpdatedAt = b.VehicleUpdatedAt
	return m0
}

type NameOverride struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Firstname string                 `protobuf:"bytes,1,opt,name=firstname,proto3"`
	xxx_hidden_Lastname  string                 `protobuf:"bytes,2,opt,name=lastname,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
