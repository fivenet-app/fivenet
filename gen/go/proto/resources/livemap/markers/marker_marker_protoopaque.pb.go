...
type MarkerMarker struct {
	...
	xxx_hidden_X           float64                `protobuf:"fixed64,2,opt,name=x,proto3"`
	xxx_hidden_Y           float64                `protobuf:"fixed64,3,opt,name=y,proto3"`
	...
	xxx_hidden_Description *string                `protobuf:"bytes,9,opt,name=description,proto3,oneof"`
	xxx_hidden_Postal      *string                `protobuf:"bytes,10,opt,name=postal,proto3,oneof"`
	...
	xxx_hidden_Creator     *short.UserShort       `protobuf:"bytes,17,opt,name=creator,proto3,oneof"`
...
type MarkerData struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Data isMarkerData_Data      `protobuf_oneof:"data"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *MarkerData) GetCircle() *CircleMarker {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*markerData_Circle); ok {
			return x.Circle
		}
	}
	return nil
...
func (x *MarkerData) GetIcon() *IconMarker {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*markerData_Icon); ok {
			return x.Icon
		}
	}
	return nil
...
func (x *MarkerData) GetPolyline() *PolylineMarker {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*markerData_Polyline); ok {
			return x.Polyline
		}
	}
	return nil
...
func (x *MarkerData) SetCircle(v *CircleMarker) {
	...
	x.xxx_hidden_Data = &markerData_Circle{v}
}
...
func (x *MarkerData) SetPolyline(v *PolylineMarker) {
	...
	x.xxx_hidden_Data = &markerData_Polyline{v}
}
...
func (x *MarkerData) HasCircle() bool {
	...
	_, ok := x.xxx_hidden_Data.(*markerData_Circle)
	return ok
}
...
func (x *MarkerData) HasIcon() bool {
	...
	_, ok := x.xxx_hidden_Data.(*markerData_Icon)
	return ok
}
...
func (x *MarkerData) HasPolyline() bool {
	...
	_, ok := x.xxx_hidden_Data.(*markerData_Polyline)
	return ok
}
...
func (x *MarkerData) ClearCircle() {
	if _, ok := x.xxx_hidden_Data.(*markerData_Circle); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *MarkerData) ClearIcon() {
	if _, ok := x.xxx_hidden_Data.(*markerData_Icon); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (x *MarkerData) ClearPolyline() {
	if _, ok := x.xxx_hidden_Data.(*markerData_Polyline); ok {
		x.xxx_hidden_Data = nil
	}
}
...
func (b0 MarkerData_builder) Build() *MarkerData {
	...
	_, _ = b, x
	if b.Circle != nil {
		x.xxx_hidden_Data = &markerData_Circle{b.Circle}
	}
	if b.Icon != nil {
	...
	if b.Polyline != nil {
		x.xxx_hidden_Data = &markerData_Polyline{b.Polyline}
	}
	return m0
}
...
type IconMarker struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Icon string                 `protobuf:"bytes,1,opt,name=icon,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type PolygonMarker struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Points      *[]*livemap.Coords     `protobuf:"bytes,1,rep,name=points,proto3"`
	xxx_hidden_Opacity     float32                `protobuf:"fixed32,2,opt,name=opacity,proto3,oneof"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
...
const file_resources_livemap_markers_marker_marker_proto_rawDesc = "" +
	...
	"\x06public\x18\x12 \x01(\bH\aR\x06public\x88\x01\x01\x12Z\n" +
	...
	"\n" +
	"creator_id\x18\x10 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00H\bR\tcreatorId\x88\x01\x01\x12?\n" +
	...
	"\bpolyline\x18\a \x01(\v2).resources.livemap.markers.PolylineMarkerH\x00R\bpolyline:\b\xe2\xf3\x18\x04\b\x01\x10\x01B\r\n" +
	"\x04data\x12\x05\xbaH\x02\b\x01\"\xf3\x01\n" +
	"\fCircleMarker\x12\x16\n" +
	"\x06radius\x18\x01 \x01(\x05R\x06radius\x12.\n" +
	"\aopacity\x18\x02 \x01(\x02B\x0f\xbaH\f\n" +
	"\n" +
	"\x1d\x00\x00\x96B-\x00\x00\x80?H\x00R\aopacity\x88\x01\x01\x12\x1b\n" +
	"\x06stroke\x18\x03 \x01(\bH\x01R\x06stroke\x88\x01\x01\x121\n" +
	"\fstroke_width\x18\x04 \x01(\x05B\t\xbaH\x06\x1a\x04\x18\f(\x00H\x02R\vstrokeWidth\x88\x01\x01\x12\x19\n" +
	...
	"\b_opacity\"\x8a\x01\n" +
	"\rPolygonMarker\x12=\n" +
	"\x06points\x18\x01 \x03(\v2\x19.resources.livemap.CoordsB\n" +
	...
	"\n" +
	"\b_opacity\"O\n" +
	"\x0ePolylineMarker\x12=\n" +
	"\x06points\x18\x01 \x03(\v2\x19.resources.livemap.CoordsB\n" +
	"\xbaH\a\x92\x01\x04\b\x02\x10\x12R\x06points*\xba\x01\n" +
	"\n" +
	"MarkerType\x12\x1b\n" +
