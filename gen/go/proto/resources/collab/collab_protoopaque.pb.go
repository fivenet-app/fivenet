...
type ClientPacket struct {
	...
	xxx_hidden_Msg isClientPacket_Msg     `protobuf_oneof:"msg"`
...
func (x *ClientPacket) GetHello() *CollabInit {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*clientPacket_Hello); ok {
			return x.Hello
		}
	}
	return nil
...
func (x *ClientPacket) GetSyncStep() *SyncStep {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*clientPacket_SyncStep); ok {
			return x.SyncStep
		}
	}
	return nil
...
func (x *ClientPacket) GetYjsUpdate() *YjsUpdate {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*clientPacket_YjsUpdate); ok {
			return x.YjsUpdate
		}
	}
	return nil
...
func (x *ClientPacket) GetAwareness() *AwarenessPing {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*clientPacket_Awareness); ok {
			return x.Awareness
		}
	}
	return nil
...
func (x *ClientPacket) SetHello(v *CollabInit) {
	...
	x.xxx_hidden_Msg = &clientPacket_Hello{v}
}
...
func (x *ClientPacket) SetSyncStep(v *SyncStep) {
	...
	x.xxx_hidden_Msg = &clientPacket_SyncStep{v}
}
...
func (x *ClientPacket) SetYjsUpdate(v *YjsUpdate) {
	...
	x.xxx_hidden_Msg = &clientPacket_YjsUpdate{v}
}
...
func (x *ClientPacket) SetAwareness(v *AwarenessPing) {
	...
	x.xxx_hidden_Msg = &clientPacket_Awareness{v}
}
...
func (x *ClientPacket) HasHello() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*clientPacket_Hello)
	return ok
}
...
func (x *ClientPacket) HasSyncStep() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*clientPacket_SyncStep)
	return ok
}
...
func (x *ClientPacket) HasYjsUpdate() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*clientPacket_YjsUpdate)
	return ok
}
...
func (x *ClientPacket) HasAwareness() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*clientPacket_Awareness)
	return ok
}
...
func (x *ClientPacket) ClearHello() {
	if _, ok := x.xxx_hidden_Msg.(*clientPacket_Hello); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ClientPacket) ClearSyncStep() {
	if _, ok := x.xxx_hidden_Msg.(*clientPacket_SyncStep); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ClientPacket) ClearYjsUpdate() {
	if _, ok := x.xxx_hidden_Msg.(*clientPacket_YjsUpdate); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ClientPacket) ClearAwareness() {
	if _, ok := x.xxx_hidden_Msg.(*clientPacket_Awareness); ok {
		x.xxx_hidden_Msg = nil
	}
}
...
func (b0 ClientPacket_builder) Build() *ClientPacket {
	...
	_, _ = b, x
	if b.Hello != nil {
		x.xxx_hidden_Msg = &clientPacket_Hello{b.Hello}
	}
	if b.SyncStep != nil {
		x.xxx_hidden_Msg = &clientPacket_SyncStep{b.SyncStep}
	}
	if b.YjsUpdate != nil {
		x.xxx_hidden_Msg = &clientPacket_YjsUpdate{b.YjsUpdate}
	}
	if b.Awareness != nil {
		x.xxx_hidden_Msg = &clientPacket_Awareness{b.Awareness}
	}
	return m0
}
...
type CollabInit struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TargetId int64                  `protobuf:"varint,1,opt,name=target_id,json=targetId,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type SyncStep struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Step        int32                  `protobuf:"varint,1,opt,name=step,proto3"`
	xxx_hidden_Data        []byte                 `protobuf:"bytes,2,opt,name=data,proto3"`
	xxx_hidden_ReceiverId  uint64                 `protobuf:"varint,3,opt,name=receiver_id,json=receiverId,proto3,oneof"`
...
func (x *SyncStep) GetReceiverId() uint64 {
	if x != nil {
		return x.xxx_hidden_ReceiverId
	}
	return 0
}
...
func (b0 SyncStep_builder) Build() *SyncStep {
	...
	if b.ReceiverId != nil {
		...
		x.xxx_hidden_ReceiverId = *b.ReceiverId
	}
	return m0
}
...
type ServerPacket struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SenderId uint64                 `protobuf:"varint,1,opt,name=sender_id,json=senderId,proto3"`
	xxx_hidden_Msg      isServerPacket_Msg     `protobuf_oneof:"msg"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ServerPacket) GetHandshake() *CollabHandshake {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_Handshake); ok {
			return x.Handshake
		}
	}
	return nil
...
func (x *ServerPacket) GetSyncStep() *SyncStep {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_SyncStep); ok {
			return x.SyncStep
		}
	}
	return nil
...
func (x *ServerPacket) GetYjsUpdate() *YjsUpdate {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_YjsUpdate); ok {
			return x.YjsUpdate
		}
	}
	return nil
...
func (x *ServerPacket) GetAwareness() *AwarenessPing {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_Awareness); ok {
			return x.Awareness
		}
	}
	return nil
...
func (x *ServerPacket) GetTargetSaved() *TargetSaved {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_TargetSaved); ok {
...
func (x *ServerPacket) GetPromote() *FirstPromote {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_Promote); ok {
			return x.Promote
		}
	}
	return nil
...
func (x *ServerPacket) GetClientUpdate() *ClientUpdate {
	if x != nil {
		if x, ok := x.xxx_hidden_Msg.(*serverPacket_ClientUpdate); ok {
...
func (x *ServerPacket) SetHandshake(v *CollabHandshake) {
	...
	x.xxx_hidden_Msg = &serverPacket_Handshake{v}
}
...
func (x *ServerPacket) SetSyncStep(v *SyncStep) {
	...
	x.xxx_hidden_Msg = &serverPacket_SyncStep{v}
}
...
func (x *ServerPacket) SetYjsUpdate(v *YjsUpdate) {
	...
	x.xxx_hidden_Msg = &serverPacket_YjsUpdate{v}
}
...
func (x *ServerPacket) SetAwareness(v *AwarenessPing) {
	...
	x.xxx_hidden_Msg = &serverPacket_Awareness{v}
}
...
func (x *ServerPacket) SetTargetSaved(v *TargetSaved) {
	...
	x.xxx_hidden_Msg = &serverPacket_TargetSaved{v}
}
...
func (x *ServerPacket) SetPromote(v *FirstPromote) {
	...
	x.xxx_hidden_Msg = &serverPacket_Promote{v}
}
...
func (x *ServerPacket) SetClientUpdate(v *ClientUpdate) {
	...
	x.xxx_hidden_Msg = &serverPacket_ClientUpdate{v}
}
...
func (x *ServerPacket) HasHandshake() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_Handshake)
	return ok
}
...
func (x *ServerPacket) HasSyncStep() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_SyncStep)
	return ok
}
...
func (x *ServerPacket) HasYjsUpdate() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_YjsUpdate)
	return ok
}
...
func (x *ServerPacket) HasAwareness() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_Awareness)
	return ok
}
...
func (x *ServerPacket) HasTargetSaved() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_TargetSaved)
	return ok
}
...
func (x *ServerPacket) HasPromote() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_Promote)
	return ok
}
...
func (x *ServerPacket) HasClientUpdate() bool {
	...
	_, ok := x.xxx_hidden_Msg.(*serverPacket_ClientUpdate)
	return ok
}
...
func (x *ServerPacket) ClearHandshake() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_Handshake); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ServerPacket) ClearSyncStep() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_SyncStep); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ServerPacket) ClearYjsUpdate() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_YjsUpdate); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ServerPacket) ClearAwareness() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_Awareness); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ServerPacket) ClearTargetSaved() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_TargetSaved); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ServerPacket) ClearPromote() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_Promote); ok {
		x.xxx_hidden_Msg = nil
	}
}

func (x *ServerPacket) ClearClientUpdate() {
	if _, ok := x.xxx_hidden_Msg.(*serverPacket_ClientUpdate); ok {
		x.xxx_hidden_Msg = nil
	}
}
...
func (b0 ServerPacket_builder) Build() *ServerPacket {
	...
	if b.Handshake != nil {
		x.xxx_hidden_Msg = &serverPacket_Handshake{b.Handshake}
	}
	if b.SyncStep != nil {
		x.xxx_hidden_Msg = &serverPacket_SyncStep{b.SyncStep}
	}
	if b.YjsUpdate != nil {
		x.xxx_hidden_Msg = &serverPacket_YjsUpdate{b.YjsUpdate}
	}
	if b.Awareness != nil {
		x.xxx_hidden_Msg = &serverPacket_Awareness{b.Awareness}
	}
	if b.TargetSaved != nil {
		x.xxx_hidden_Msg = &serverPacket_TargetSaved{b.TargetSaved}
	}
	if b.Promote != nil {
		x.xxx_hidden_Msg = &serverPacket_Promote{b.Promote}
	}
	if b.ClientUpdate != nil {
		x.xxx_hidden_Msg = &serverPacket_ClientUpdate{b.ClientUpdate}
	}
	return m0
}
...
type CollabHandshake struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ClientId uint64                 `protobuf:"varint,1,opt,name=client_id,json=clientId,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type ClientUpdate struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Joined      bool                   `protobuf:"varint,1,opt,name=joined,proto3"`
	xxx_hidden_ClientId    uint64                 `protobuf:"varint,2,opt,name=client_id,json=clientId,proto3"`
