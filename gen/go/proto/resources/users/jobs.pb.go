...
var file_resources_users_jobs_proto_rawDesc = []byte{
	...
	0x42, 0x04, 0x1a, 0x02, 0x20, 0x00, 0x52, 0x09, 0x66, 0x72, 0x6f, 0x6d, 0x47, 0x72, 0x61, 0x64,
	0x65, 0x12, 0x22, 0x0a, 0x08, 0x74, 0x6f, 0x5f, 0x67, 0x72, 0x61, 0x64, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x05, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x1a, 0x02, 0x20, 0x00, 0x52, 0x07, 0x74, 0x6f,
...
func file_resources_users_jobs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_users_jobs_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Job); i {
			case 0:
				return &v.state
			case 1:
		...
		file_resources_users_jobs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_resources_users_jobs_proto_msgTypes[12].Exporter = func(v any, i int) any {
