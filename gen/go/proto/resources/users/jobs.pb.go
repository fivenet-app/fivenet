...
const file_resources_users_jobs_proto_rawDesc = "" +
	"\n" +
	"\x1aresources/users/jobs.proto\x12\x0fresources.users\x1a\x17validate/validate.proto\"t\n" +
	"\x03Job\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x182R\x04name\x12\x1d\n" +
	"\x05label\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x182R\x05label\x121\n" +
	"\x06grades\x18\x03 \x03(\v2\x19.resources.users.JobGradeR\x06grades\"~\n" +
	"\bJobGrade\x12'\n" +
	...
	"\t_job_nameBCZAgithub.com/fivenet-app/fivenet/gen/go/proto/resources/users;usersb\x06proto3"

var (
	file_resources_users_jobs_proto_rawDescOnce sync.Once
	file_resources_users_jobs_proto_rawDescData []byte
)

func file_resources_users_jobs_proto_rawDescGZIP() []byte {
	file_resources_users_jobs_proto_rawDescOnce.Do(func() {
		file_resources_users_jobs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_users_jobs_proto_rawDesc), len(file_resources_users_jobs_proto_rawDesc)))
	})
...
func file_resources_users_jobs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_users_jobs_proto_rawDesc), len(file_resources_users_jobs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
