...
const file_resources_users_activity_proto_rawDesc = "" +
	...
	"targetUser\x127\n" +
	"\x03key\x18\b \x01(\tB%\x9a\x84\x9e\x03\x19alias:\"user_activity.key\"\xbaH\x04r\x02\x18@R\x03key\x12A\n" +
	"\x06reason\x18\t \x01(\tB)\x9a\x84\x9e\x03\x1calias:\"user_activity.reason\"\xbaH\x05r\x03\x18\xff\x01R\x06reason\x12[\n" +
	"\x04data\x18\n" +
