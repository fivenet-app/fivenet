...
const file_resources_users_user_proto_rawDesc = "" +
	"\n" +
	"\x1aresources/users/user.proto\x12\x0fresources.users\x1a*resources/citizens/licenses/licenses.proto\x1a#resources/timestamp/timestamp.proto\x1a!resources/users/props/props.proto\x1a\x13tagger/tagger.proto\"\x80\t\n" +
	"\x04User\x12/\n" +
	"\auser_id\x18\x01 \x01(\x05B\x16\x9a\x84\x9e\x03\n" +
	"alias:\"id\"\xbaH\x04\x1a\x02 \x00R\x06userId\x12'\n" +
	"\n" +
	"identifier\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x18@R\n" +
	"identifier\x12\x1c\n" +
	...
	"\x0fjob_grade_label\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x182H\x01R\rjobGradeLabel\x88\x01\x01\x129\n" +
	"\x04jobs\x18\x14 \x03(\v2\x18.resources.users.UserJobB\v\xbaH\b\xd8\x01\x01\x92\x01\x02\x10\x03R\x04jobs\x12'\n" +
	...
	"R\vdateofbirth\x12 \n" +
	"\x03sex\x18\n" +
	" \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18\x02H\x02R\x03sex\x88\x01\x01\x12\x1b\n" +
	"\x06height\x18\v \x01(\x02H\x03R\x06height\x88\x01\x01\x12/\n" +
	"\fphone_number\x18\f \x01(\tB\a\xbaH\x04r\x02\x18\x14H\x04R\vphoneNumber\x88\x01\x01\x12N\n" +
	"\rphone_numbers\x18\x13 \x03(\v2\x1c.resources.users.PhoneNumberB\v\xbaH\b\xd8\x01\x01\x92\x01\x02\x10\x05R\fphoneNumbers\x12\"\n" +
	"\x05visum\x18\r \x01(\x05B\a\xbaH\x04\x1a\x02(\x00H\x05R\x05visum\x88\x01\x01\x12(\n" +
	"\bplaytime\x18\x0e \x01(\x05B\a\xbaH\x04\x1a\x02(\x00H\x06R\bplaytime\x88\x01\x01\x12W\n" +
	...
	"\x10_profile_picture\"\x9a\x02\n" +
	"\vPhoneNumber\x12 \n" +
	"\auser_id\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x06userId\x128\n" +
	"\x06number\x18\x02 \x01(\tB \x9a\x84\x9e\x03\x14alias:\"phone_number\"\xbaH\x04r\x02\x18\x14R\x06number\x12\x1d\n" +
	"\n" +
	...
	"\tjob_label\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x182H\x00R\bjobLabel\x88\x01\x01\x12\x1d\n" +
	"\x05grade\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x05grade\x12-\n" +
	"\vgrade_label\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x182H\x01R\n" +
