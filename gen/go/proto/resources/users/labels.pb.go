...
const file_resources_users_labels_proto_rawDesc = "" +
	...
	"R\x04list:\x06\xe2\xf3\x18\x02\b\x01\"\xc2\x01\n" +
	"\x05Label\x121\n" +
	...
	"\x04name\x18\x03 \x01(\tB\x0f\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x04r\x02\x180R\x04name\x129\n" +
	"\x05color\x18\x04 \x01(\tB#\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x18r\x162\x11^#[A-Fa-f0-9]{6}$\x98\x01\aR\x05colorB\x06\n" +
