...
const file_resources_users_labels_proto_rawDesc = "" +
	"\n" +
	"\x1cresources/users/labels.proto\x12\x0fresources.users\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x13tagger/tagger.proto\"<\n" +
	"\x06Labels\x12*\n" +
	"\x04list\x18\x01 \x03(\v2\x16.resources.users.LabelR\x04list:\x06\xe2\xf3\x18\x02\b\x01\"\xa9\x01\n" +
	"\x05Label\x121\n" +
	"\x02id\x18\x01 \x01(\x03B!\x9a\x84\x9e\x03\x1csql:\"primary_key\" alias:\"id\"R\x02id\x12\x15\n" +
	"\x03job\x18\x02 \x01(\tH\x00R\x03job\x88\x01\x01\x12%\n" +
	"\x04name\x18\x03 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x04name\x12'\n" +
	"\x05color\x18\x04 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x05colorB\x06\n" +
