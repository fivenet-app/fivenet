...
const file_resources_users_props_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/users/props.proto\x12\x0fresources.users\x1a!codegen/sanitizer/sanitizer.proto\x1a\x19resources/file/file.proto\x1a\x19resources/jobs/jobs.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1cresources/users/labels.proto\x1a\x13tagger/tagger.proto\"\xb5\b\n" +
	"\tUserProps\x12 \n" +
	...
	"\x05email\x18\x0f \x01(\tB\x11\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x06r\x04\x10\x06\x18PH\rR\x05email\x88\x01\x01B\r\n" +
	"\v_updated_atB\t\n" +
	"\a_wantedB\v\n" +
	"\t_job_nameB\x06\n" +
	"\x04_jobB\x13\n" +
