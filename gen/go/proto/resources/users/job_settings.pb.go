...
const file_resources_users_job_settings_proto_rawDesc = "" +
	"\n" +
	"\"resources/users/job_settings.proto\x12\x0fresources.users\x1a#resources/timestamp/timestamp.proto\x1a\x17validate/validate.proto\"\xbd\x04\n" +
	"\x13DiscordSyncSettings\x12\x17\n" +
	"\adry_run\x18\x01 \x01(\bR\x06dryRun\x12$\n" +
	"\x0euser_info_sync\x18\x02 \x01(\bR\fuserInfoSync\x12\\\n" +
	"\x17user_info_sync_settings\x18\x03 \x01(\v2%.resources.users.UserInfoSyncSettingsR\x14userInfoSyncSettings\x12\x1d\n" +
	"\n" +
	"status_log\x18\x04 \x01(\bR\tstatusLog\x12R\n" +
	"\x13status_log_settings\x18\x05 \x01(\v2\".resources.users.StatusLogSettingsR\x11statusLogSettings\x12!\n" +
	"\fjobs_absence\x18\x06 \x01(\bR\vjobsAbsence\x12X\n" +
	"\x15jobs_absence_settings\x18\a \x01(\v2$.resources.users.JobsAbsenceSettingsR\x13jobsAbsenceSettings\x12R\n" +
	"\x13group_sync_settings\x18\b \x01(\v2\".resources.users.GroupSyncSettingsR\x11groupSyncSettings\x12E\n" +
	"\x1aqualifications_role_format\x18\t \x01(\tB\a\xfaB\x04r\x02\x18@R\x18qualificationsRoleFormat\"R\n" +
	"\x12DiscordSyncChanges\x12<\n" +
	"\achanges\x18\x01 \x03(\v2\".resources.users.DiscordSyncChangeR\achanges\"[\n" +
	"\x11DiscordSyncChange\x122\n" +
	"\x04time\x18\x01 \x01(\v2\x1e.resources.timestamp.TimestampR\x04time\x12\x12\n" +
	"\x04plan\x18\x02 \x01(\tR\x04plan\"\xef\x03\n" +
	"\x14UserInfoSyncSettings\x122\n" +
	"\x15employee_role_enabled\x18\x01 \x01(\bR\x13employeeRoleEnabled\x129\n" +
	"\x14employee_role_format\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x18@R\x12employeeRoleFormat\x123\n" +
	"\x11grade_role_format\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18@R\x0fgradeRoleFormat\x12-\n" +
	"\x12unemployed_enabled\x18\x04 \x01(\bR\x11unemployedEnabled\x12^\n" +
	"\x0funemployed_mode\x18\x05 \x01(\x0e2+.resources.users.UserInfoSyncUnemployedModeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0eunemployedMode\x129\n" +
	"\x14unemployed_role_name\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18@R\x12unemployedRoleName\x12%\n" +
	"\x0esync_nicknames\x18\a \x01(\bR\rsyncNicknames\x12B\n" +
	"\rgroup_mapping\x18\b \x03(\v2\x1d.resources.users.GroupMappingR\fgroupMapping\"w\n" +
	"\fGroupMapping\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x18@R\x04name\x12&\n" +
	"\n" +
	"from_grade\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02(\x00R\tfromGrade\x12\"\n" +
	"\bto_grade\x18\x03 \x01(\x05B\a\xfaB\x04\x1a\x02(\x00R\atoGrade\"2\n" +
	"\x11StatusLogSettings\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\tR\tchannelId\"A\n" +
	"\x13JobsAbsenceSettings\x12*\n" +
	"\fabsence_role\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x18@R\vabsenceRole\"M\n" +
	"\x11GroupSyncSettings\x128\n" +
	"\x10ignored_role_ids\x18\x01 \x03(\tB\x0e\xfaB\v\x92\x01\b\x10\x19\"\x04r\x02\x18\x18R\x0eignoredRoleIds\"\x80\x01\n" +
	"\vJobSettings\x125\n" +
	"\x11absence_past_days\x18\x01 \x01(\x05B\t\xfaB\x06\x1a\x04\x18\x1f(\x00R\x0fabsencePastDays\x12:\n" +
	"\x13absence_future_days\x18\x02 \x01(\x05B\n" +
	"\xfaB\a\x1a\x05\x18\xba\x01(\x03R\x11absenceFutureDays*\xa3\x01\n" +
	...
	"#USER_INFO_SYNC_UNEMPLOYED_MODE_KICK\x10\x02BIZGgithub.com/fivenet-app/fivenet/v2025/gen/go/proto/resources/users;usersb\x06proto3"
