...
const (
	...
	UNIT_STATUS_USER_ADDED  UNIT_STATUS = 2
	UNIT_STATUS_ON_BREAK    UNIT_STATUS = 3
	UNIT_STATUS_BUSY        UNIT_STATUS = 4
)
...
type Unit struct {
	...
	Status      *UnitStatus          `protobuf:"bytes,8,opt,name=status,proto3,oneof" json:"status,omitempty"`
...
type UnitStatus struct {
	...
	User      *users.UserShort     `protobuf:"bytes,8,opt,name=user,proto3" json:"user,omitempty"`
	InSquad   *bool                `protobuf:"varint,9,opt,name=in_squad,json=inSquad,proto3,oneof" json:"in_squad,omitempty"`
...
func (x *UnitStatus) GetInSquad() bool {
	if x != nil && x.InSquad != nil {
		return *x.InSquad
	}
	return false
}

func (x *UnitStatus) GetX() float32 {
	if x != nil && x.X != nil {
		return *x.X
	}
	return 0
...
func (x *UnitStatus) GetY() float32 {
	if x != nil && x.Y != nil {
		return *x.Y
	}
	return 0
...
var file_resources_dispatch_units_proto_rawDesc = []byte{
	...
	0xeb, 0x03, 0x0a, 0x04, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	,
	...
	0x6e, 0x69, 0x74, 0x49, 0x64, 0x12, 0x42, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	...
	,
	...
	0x75, 0x73, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x1e, 0x0a, 0x08,
	0x69, 0x6e, 0x5f, 0x73, 0x71, 0x75, 0x61, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x48, 0x04,
	0x52, 0x07, 0x69, 0x6e, 0x53, 0x71, 0x75, 0x61, 0x64, 0x88, 0x01, 0x01, 0x12, 0x11, 0x0a, 0x01,
	0x78, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x02, 0x48, 0x05, 0x52, 0x01, 0x78, 0x88, 0x01, 0x01, 0x12,
	0x11, 0x0a, 0x01, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x02, 0x48, 0x06, 0x52, 0x01, 0x79, 0x88,
	...
	0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x69, 0x6e, 0x5f, 0x73, 0x71, 0x75, 0x61, 0x64, 0x42, 0x04, 0x0a,
	0x02, 0x5f, 0x78, 0x42, 0x04, 0x0a, 0x02, 0x5f, 0x79, 0x2a, 0x55, 0x0a, 0x0b, 0x55, 0x4e, 0x49,
	0x54, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e, 0x41, 0x56,
	0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x56, 0x41,
	0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x55, 0x53, 0x45, 0x52,
	0x5f, 0x41, 0x44, 0x44, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08, 0x4f, 0x4e, 0x5f, 0x42,
	0x52, 0x45, 0x41, 0x4b, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x55, 0x53, 0x59, 0x10, 0x04,
	...
	0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x3b, 0x64,
	0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_resources_dispatch_units_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_resources_dispatch_units_proto_goTypes = []interface{}{
	...
	(*UnitStatus)(nil),          // 2: resources.dispatch.UnitStatus
...
var file_resources_dispatch_units_proto_depIdxs = []int32{
	3, // 0: resources.dispatch.Unit.created_at:type_name -> resources.timestamp.Timestamp
	3, // 1: resources.dispatch.Unit.updated_at:type_name -> resources.timestamp.Timestamp
	2, // 2: resources.dispatch.Unit.status:type_name -> resources.dispatch.UnitStatus
	4, // 3: resources.dispatch.Unit.users:type_name -> resources.users.UserShort
	3, // 4: resources.dispatch.UnitStatus.created_at:type_name -> resources.timestamp.Timestamp
	0, // 5: resources.dispatch.UnitStatus.status:type_name -> resources.dispatch.UNIT_STATUS
	4, // 6: resources.dispatch.UnitStatus.user:type_name -> resources.users.UserShort
...
func file_resources_dispatch_units_proto_init() {
	...
	file_resources_dispatch_units_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
