...
type Label struct {
	...
	xxx_hidden_Access      *access.Access         `protobuf:"bytes,10,opt,name=access,proto3,oneof"`
...
const file_resources_citizens_labels_labels_proto_rawDesc = "" +
	"\n" +
	"&resources/citizens/labels/labels.proto\x12\x19resources.citizens.labels\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1dresources/access/access.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"P\n" +
	"\x06Labels\x12>\n" +
	"\x04list\x18\x01 \x03(\v2 .resources.citizens.labels.LabelB\b\xbaH\x05\x92\x01\x02\x10\n" +
	"R\x04list:\x06\xe2\xf3\x18\x02\b\x01\"\xf3\x05\n" +
	"\x05Label\x121\n" +
	...
	"\x06access\x18\n" +
	" \x01(\v2\x18.resources.access.AccessB\x06\xbaH\x03\xc8\x01\x01H\x05R\x06access\x88\x01\x01\x12B\n" +
	"\n" +
