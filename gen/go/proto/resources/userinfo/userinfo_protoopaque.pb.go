...
type UserInfo struct {
	...
	xxx_hidden_CanBeConfigAdmin bool                    `protobuf:"varint,12,opt,name=can_be_config_admin,json=canBeConfigAdmin,proto3"`
...
type AccountGroupsChanged struct {
	...
	xxx_hidden_CanBeConfigAdmin bool                    `protobuf:"varint,5,opt,name=can_be_config_admin,json=canBeConfigAdmin,proto3"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
