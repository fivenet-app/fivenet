...
type ClientConfig struct {
	...
	xxx_hidden_Website       *settings.Website      `protobuf:"bytes,5,opt,name=website,proto3"`
...
type Game struct {
	...
	xxx_hidden_Livemap                         *settings.Livemap      `protobuf:"bytes,3,opt,name=livemap,proto3"`
