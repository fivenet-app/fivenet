...
type AuditEntry struct {
	...
	xxx_hidden_TargetUserJob *string                `protobuf:"bytes,8,opt,name=target_user_job,json=targetUserJob,proto3,oneof"`
	xxx_hidden_Service       string                 `protobuf:"bytes,9,opt,name=service,proto3"`
	xxx_hidden_Method        string                 `protobuf:"bytes,10,opt,name=method,proto3"`
	xxx_hidden_Action        EventAction            `protobuf:"varint,11,opt,name=action,proto3,enum=resources.audit.EventAction"`
...
func (x *AuditEntry) GetTargetUserJob() string {
	if x != nil {
		if x.xxx_hidden_TargetUserJob != nil {
			return *x.xxx_hidden_TargetUserJob
		}
		return ""
	}
	return ""
...
func (x *AuditEntry) ClearTargetUserJob() {
	...
	x.xxx_hidden_TargetUserJob = nil
}
...
type AuditEntryMeta struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Meta map[string]string      `protobuf:"bytes,1,rep,name=meta,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_resources_audit_audit_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/audit/audit.proto\x12\x0fresources.audit\x1a!codegen/dbscanner/dbscanner.proto\x1a#resources/timestamp/timestamp.proto\x1a resources/users/short/user.proto\"\xc1\x05\n" +
	"\n" +
	"AuditEntry\x12\x0e\n" +
