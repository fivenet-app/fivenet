...
const file_resources_audit_audit_proto_rawDesc = "" +
	...
	"\x06method\x18\n" +
	" \x01(\tB\x13\x9a\x84\x9e\x03\x0ealias:\"method\"R\x06method\x12L\n" +
	"\x05state\x18\v \x01(\x0e2\x1a.resources.audit.EventTypeB\x1a\x9a\x84\x9e\x03\ralias:\"state\"\xbaH\x05\x82\x01\x02\x10\x01R\x05state\x12*\n" +
