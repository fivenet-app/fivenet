...
type AuditEntry struct {
	...
	UserId        int32                  `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" alias:"user_id"` // @gotags: alias:"user_id"
	...
	TargetUserJob *string                `protobuf:"bytes,8,opt,name=target_user_job,json=targetUserJob,proto3,oneof" json:"target_user_job,omitempty" alias:"target_user_job"` // @gotags: alias:"target_user_job"
	...
	State         EventType              `protobuf:"varint,11,opt,name=state,proto3,enum=resources.audit.EventType" json:"state,omitempty" alias:"state"`             // @gotags: alias:"state"
...
const file_resources_audit_audit_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/audit/audit.proto\x12\x0fresources.audit\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x17validate/validate.proto\"\xae\x04\n" +
	"\n" +
	"AuditEntry\x12\x0e\n" +
	...
	"\x06method\x18\n" +
	" \x01(\tR\x06method\x12:\n" +
	"\x05state\x18\v \x01(\x0e2\x1a.resources.audit.EventTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x05state\x12\x17\n" +
	"\x04data\x18\f \x01(\tH\x04R\x04data\x88\x01\x01B\a\n" +
	"\x05_userB\x11\n" +
