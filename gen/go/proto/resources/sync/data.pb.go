...
const file_resources_sync_data_proto_rawDesc = "" +
	...
	"\bDataJobs\x122\n" +
	"\x04jobs\x18\x01 \x03(\v2\x13.resources.jobs.JobB\t\xbaH\x06\x92\x01\x03\x10\xc8\x01R\x04jobs\"C\n" +
	"\tDataUsers\x126\n" +
	"\x05users\x18\x01 \x03(\v2\x15.resources.users.UserB\t\xbaH\x06\x92\x01\x03\x10\xf4\x03R\x05users\"R\n" +
	"\fDataVehicles\x12B\n" +
	"\bvehicles\x18\x01 \x03(\v2\x1b.resources.vehicles.VehicleB\t\xbaH\x06\x92\x01\x03\x10\xe8\aR\bvehicles\"O\n" +
	"\fDataLicenses\x12?\n" +
	"\blicenses\x18\x01 \x03(\v2\x18.resources.users.LicenseB\t\xbaH\x06\x92\x01\x03\x10\xc8\x01R\blicenses\"\x86\x01\n" +
	"\x11DataUserLocations\x12A\n" +
	"\x05users\x18\x01 \x03(\v2 .resources.sync.CitizenLocationsB\t\xbaH\x06\x92\x01\x03\x10\xd0\x0fR\x05users\x12 \n" +
