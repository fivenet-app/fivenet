...
const file_resources_sync_activity_activity_proto_rawDesc = "" +
	...
	"externalId\x12\x1a\n" +
	"\busername\x18\x04 \x01(\tR\busername\"\x83\x01\n" +
	"\tUserProps\x12+\n" +
	"\x06reason\x18\x01 \x01(\tB\x0e\xda\xf3\x18\x02\b\x01\xbaH\x05r\x03\x18\xff\x01H\x00R\x06reason\x88\x01\x01\x12>\n" +
	"\x05props\x18\x02 \x01(\v2 .resources.users.props.UserPropsB\x06\xbaH\x03\xc8\x01\x01R\x05propsB\t\n" +
	"\a_reason\"\x91\x01\n" +
	"\x0eColleagueProps\x12+\n" +
	"\x06reason\x18\x01 \x01(\tB\x0e\xda\xf3\x18\x02\b\x01\xbaH\x05r\x03\x18\xff\x01H\x00R\x06reason\x88\x01\x01\x12G\n" +
	"\x05props\x18\x02 \x01(\v2).resources.jobs.colleagues.ColleaguePropsB\x06\xbaH\x03\xc8\x01\x01R\x05propsB\t\n" +
	"\a_reason\"\x8a\x02\n" +
	"\n" +
	"UserUpdate\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x05R\x06userId\x12\x19\n" +
	"\x05group\x18\x02 \x01(\tH\x00R\x05group\x88\x01\x01\x12\x1e\n" +
	"\x03job\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x18\x14H\x01R\x03job\x88\x01\x01\x12)\n" +
	"\tjob_grade\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00H\x02R\bjobGrade\x88\x01\x01\x12!\n" +
	...
	"\x05start\x18\x03 \x01(\bR\x05start\"\xa7\x01\n" +
	"\rAccountUpdate\x12!\n" +
	"\alicense\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x18@R\alicense\x12\x19\n" +
