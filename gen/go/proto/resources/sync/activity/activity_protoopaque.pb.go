...
const file_resources_sync_activity_activity_proto_rawDesc = "" +
	...
	"\tUserProps\x12%\n" +
	"\x06reason\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01H\x00R\x06reason\x88\x01\x01\x12>\n" +
	"\x05props\x18\x02 \x01(\v2 .resources.users.props.UserPropsB\x06\xbaH\x03\xc8\x01\x01R\x05propsB\t\n" +
	"\a_reason\"\x8b\x01\n" +
	"\x0eColleagueProps\x12%\n" +
	"\x06reason\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01H\x00R\x06reason\x88\x01\x01\x12G\n" +
