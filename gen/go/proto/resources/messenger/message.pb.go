...
var file_resources_messenger_message_proto_goTypes = []interface{}{
...
func file_resources_messenger_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_messenger_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_messenger_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_messenger_message_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
