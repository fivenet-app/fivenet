...
type VehicleActivity struct {
	...
	xxx_hidden_Data            *VehicleActivityData   `protobuf:"bytes,10,opt,name=data,proto3"`
...
const file_resources_vehicles_activity_activity_proto_rawDesc = "" +
	"\n" +
	"*resources/vehicles/activity/activity.proto\x12\x1bresources.vehicles.activity\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\x1a resources/users/short/user.proto\x1a\x13tagger/tagger.proto\"\x98\x06\n" +
	...
	"\x05plate\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x18 R\x05plate\x12\x81\x01\n" +
	"\ractivity_type\x18\x04 \x01(\x0e20.resources.vehicles.activity.VehicleActivityTypeB*\x9a\x84\x9e\x03\x1dalias:\"vehicle_activity.type\"\xbaH\x05\x82\x01\x02\x10\x01R\factivityType\x12+\n" +
	"\n" +
	"creator_id\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00H\x01R\tcreatorId\x88\x01\x01\x12U\n" +
	"\acreator\x18\x06 \x01(\v2 .resources.users.short.UserShortB\x14\x9a\x84\x9e\x03\x0falias:\"creator\"H\x02R\acreator\x88\x01\x01\x12(\n" +
	...
	"\x06reason\x18\t \x01(\tB/\xda\xf3\x18\x02\b\x01\x9a\x84\x9e\x03\x1calias:\"user_activity.reason\"\xbaH\x05r\x03\x18\xff\x01H\x04R\x06reason\x88\x01\x01\x12D\n" +
	"\x04data\x18\n" +
