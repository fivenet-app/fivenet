...
const file_resources_wiki_activity_proto_rawDesc = "" +
	"\n" +
	"\x1dresources/wiki/activity.proto\x12\x0eresources.wiki\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x1bresources/wiki/access.proto\x1a\x17validate/validate.proto\"\xa2\x04\n" +
	...
	"\x06reason\x18\t \x01(\tB\b\xfaB\x05r\x03\x18\xff\x01H\x03R\x06reason\x88\x01\x01\x124\n" +
	"\x04data\x18\n" +
	...
	"\tto_create\x18\x01 \x03(\v2\x1d.resources.wiki.PageJobAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\btoCreate\x12D\n" +
	"\tto_update\x18\x02 \x03(\v2\x1d.resources.wiki.PageJobAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\btoUpdate\x12D\n" +
	"\tto_delete\x18\x03 \x03(\v2\x1d.resources.wiki.PageJobAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\btoDelete\"\xea\x01\n" +
