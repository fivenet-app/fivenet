...
const file_resources_wiki_page_proto_rawDesc = "" +
	...
	"\x04slug\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dH\x02R\x04slug\x88\x01\x01\x12 \n" +
	"\x05title\x18\x05 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x03\x18\x80\bR\x05title\x12*\n" +
	"\vdescription\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\vdescription\x12+\n" +
	"\n" +
	"creator_id\x18\a \x01(\x05B\a\xfaB\x04\x1a\x02 \x00H\x03R\tcreatorId\x88\x01\x01\x129\n" +
	"\acreator\x18\b \x01(\v2\x1a.resources.users.UserShortH\x04R\acreator\x88\x01\x01\x12R\n" +
	"\fcontent_type\x18\t \x01(\x0e2%.resources.common.content.ContentTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\vcontentType\x12\x12\n" +
	"\x04tags\x18\n" +
	...
	"\x04slug\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dH\x03R\x04slug\x88\x01\x01\x12\x14\n" +
	...
	"\x05_logoBAZ?github.com/fivenet-app/fivenet/gen/go/proto/resources/wiki;wikib\x06proto3"
