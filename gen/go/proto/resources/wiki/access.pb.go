...
const file_resources_wiki_access_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/wiki/access.proto\x12\x0eresources.wiki\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x13tagger/tagger.proto\"\xb8\x01\n" +
	"\n" +
	"PageAccess\x12R\n" +
	"\x04jobs\x18\x01 \x03(\v2\x1d.resources.wiki.PageJobAccessB\x1f\x9a\x84\x9e\x03\x12alias:\"job_access\"\xbaH\x05\x92\x01\x02\x10\x14R\x04jobs\x12V\n" +
	"\x05users\x18\x02 \x03(\v2\x1e.resources.wiki.PageUserAccessB \x9a\x84\x9e\x03\x13alias:\"user_access\"\xbaH\x05\x92\x01\x02\x10\x14R\x05users\"\x9a\x03\n" +
	...
	"\x06access\x18\b \x01(\x0e2\x1b.resources.wiki.AccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06accessB\r\n" +
	"\v_created_atB\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
	"\x10_job_grade_label\"\xaf\x02\n" +
	...
	"\x06access\x18\x06 \x01(\x0e2\x1b.resources.wiki.AccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06accessB\r\n" +
	"\v_created_atB\a\n" +
	"\x05_user*\x8c\x01\n" +
