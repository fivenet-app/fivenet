...
const file_resources_wiki_access_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/wiki/access.proto\x12\x0eresources.wiki\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x13tagger/tagger.proto\"\xa8\x01\n" +
	"\n" +
	"PageAccess\x12J\n" +
	"\x04jobs\x18\x01 \x03(\v2\x1d.resources.wiki.PageJobAccessB\x17\x9a\x84\x9e\x03\x12alias:\"job_access\"R\x04jobs\x12N\n" +
	"\x05users\x18\x02 \x03(\v2\x1e.resources.wiki.PageUserAccessB\x18\x9a\x84\x9e\x03\x13alias:\"user_access\"R\x05users\"\xec\x02\n" +
	...
	"\x0fjob_grade_label\x18\a \x01(\tH\x02R\rjobGradeLabel\x88\x01\x01\x123\n" +
	"\x06access\x18\b \x01(\x0e2\x1b.resources.wiki.AccessLevelR\x06accessB\r\n" +
	"\v_created_atB\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
	"\x10_job_grade_label\"\x9c\x02\n" +
	...
	"\x04user\x18\x05 \x01(\v2\x1a.resources.users.UserShortH\x01R\x04user\x88\x01\x01\x123\n" +
	"\x06access\x18\x06 \x01(\x0e2\x1b.resources.wiki.AccessLevelR\x06accessB\r\n" +
	"\v_created_atB\a\n" +
	"\x05_user*\x8c\x01\n" +
