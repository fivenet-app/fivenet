...
var file_resources_wiki_access_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x73, 0x22, 0xa2, 0x03, 0x0a, 0x0d, 0x50, 0x61, 0x67, 0x65, 0x4a, 0x6f, 0x62,
	...
	0x65, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x3d, 0x0a, 0x06, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x72, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x77, 0x69, 0x6b, 0x69, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73,
	...
	0x61, 0x64, 0x65, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0xb7, 0x02, 0x0a, 0x0e, 0x50, 0x61,
	0x67, 0x65, 0x55, 0x73, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x12, 0x0a, 0x02,
	...
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x42, 0x02, 0x30, 0x01, 0x52, 0x08, 0x74, 0x61, 0x72,
...
var file_resources_wiki_access_proto_goTypes = []interface{}{
...
func file_resources_wiki_access_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_wiki_access_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_wiki_access_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PageJobAccess); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_resources_wiki_access_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PageUserAccess); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_resources_wiki_access_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_resources_wiki_access_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
