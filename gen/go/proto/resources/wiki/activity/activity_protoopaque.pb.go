...
const file_resources_wiki_activity_activity_proto_rawDesc = "" +
	...
	"\x06reason\x18\t \x01(\tB\x0e\xda\xf3\x18\x02\b\x01\xbaH\x05r\x03\x18\xff\x01H\x03R\x06reason\x88\x01\x01\x12=\n" +
	"\x04data\x18\n" +
	...
	"\x05users\x18\x02 \x01(\v2,.resources.wiki.activity.PageAccessUsersDiffR\x05users\"\xe0\x01\n" +
	"\x12PageAccessJobsDiff\x12B\n" +
	...
	"\tto_delete\x18\x03 \x03(\v2\x1b.resources.access.JobAccessB\b\xbaH\x05\x92\x01\x02\x10\x14R\btoDelete\"\xe4\x01\n" +
	"\x13PageAccessUsersDiff\x12C\n" +
	...
	"\tto_delete\x18\x03 \x03(\v2\x1c.resources.access.UserAccessB\b\xbaH\x05\x92\x01\x02\x10\x14R\btoDelete*\x89\x02\n" +
