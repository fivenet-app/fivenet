...
type PageJobAccess struct {
	...
	Access        AccessLevel            `protobuf:"varint,8,opt,name=access,proto3,enum=resources.wiki.access.AccessLevel" json:"access,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PageUserAccess struct {
	...
	Access        AccessLevel            `protobuf:"varint,6,opt,name=access,proto3,enum=resources.wiki.access.AccessLevel" json:"access,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
