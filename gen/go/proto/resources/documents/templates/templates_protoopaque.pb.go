...
type Template struct {
	...
	xxx_hidden_JobAccess       *[]*access.JobAccess   `protobuf:"bytes,16,rep,name=job_access,json=jobAccess,proto3"`
	xxx_hidden_ContentAccess   *access.Access         `protobuf:"bytes,17,opt,name=content_access,json=contentAccess,proto3"`
