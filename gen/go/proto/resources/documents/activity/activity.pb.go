...
type DocAccessJobsDiff struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	ToCreate      []*access1.JobAccess   `protobuf:"bytes,1,rep,name=to_create,json=toCreate,proto3" json:"to_create,omitempty"`
	ToUpdate      []*access1.JobAccess   `protobuf:"bytes,2,rep,name=to_update,json=toUpdate,proto3" json:"to_update,omitempty"`
	ToDelete      []*access1.JobAccess   `protobuf:"bytes,3,rep,name=to_delete,json=toDelete,proto3" json:"to_delete,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DocAccessUsersDiff struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	ToCreate      []*access1.UserAccess  `protobuf:"bytes,1,rep,name=to_create,json=toCreate,proto3" json:"to_create,omitempty"`
	ToUpdate      []*access1.UserAccess  `protobuf:"bytes,2,rep,name=to_update,json=toUpdate,proto3" json:"to_update,omitempty"`
	ToDelete      []*access1.UserAccess  `protobuf:"bytes,3,rep,name=to_delete,json=toDelete,proto3" json:"to_delete,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
