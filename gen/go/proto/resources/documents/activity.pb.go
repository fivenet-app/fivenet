...
func (x *DocActivityData) GetRequestInfo() *DocRequestActivity {
	if x, ok := x.GetData().(*DocActivityData_RequestInfo); ok {
...
type DocActivityData_RequestInfo struct {
	RequestInfo *DocRequestActivity `protobuf:"bytes,3,opt,name=request_info,json=requestInfo,proto3,oneof"`
}
...
func (*DocActivityData_RequestInfo) isDocActivityData_Data() {}
...
type DocRequestActivity struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DocRequestActivity) Reset() {
	*x = DocRequestActivity{}
	if protoimpl.UnsafeEnabled {
...
func (x *DocRequestActivity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DocRequestActivity) ProtoMessage() {}

func (x *DocRequestActivity) ProtoReflect() protoreflect.Message {
	mi := &file_resources_documents_activity_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DocRequestActivity.ProtoReflect.Descriptor instead.
func (*DocRequestActivity) Descriptor() ([]byte, []int) {
	return file_resources_documents_activity_proto_rawDescGZIP(), []int{4}
}

func (x *DocRequestActivity) GetAccepted() bool {
	if x != nil {
		return x.Accepted
	}
	return false
...
var file_resources_documents_activity_proto_rawDesc = []byte{
	...
	0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xf1, 0x01, 0x0a, 0x0f, 0x44, 0x6f, 0x63, 0x41,
	...
	0x61, 0x6e, 0x67, 0x65, 0x64, 0x12, 0x4c, 0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74,
	0x73, 0x2e, 0x44, 0x6f, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69,
	0x76, 0x69, 0x74, 0x79, 0x48, 0x00, 0x52, 0x0b, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49,
	0x6e, 0x66, 0x6f, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xab, 0x01, 0x0a, 0x0a,
	...
	0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x22, 0x30, 0x0a, 0x12, 0x44, 0x6f, 0x63, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x12, 0x1a, 0x0a,
	0x08, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x2a, 0xe4, 0x05, 0x0a, 0x0f, 0x44, 0x6f,
...
var file_resources_documents_activity_proto_goTypes = []interface{}{
	...
	(*DocRequestActivity)(nil),  // 5: resources.documents.DocRequestActivity
...
var file_resources_documents_activity_proto_depIdxs = []int32{
	...
	5, // 6: resources.documents.DocActivityData.request_info:type_name -> resources.documents.DocRequestActivity
...
func file_resources_documents_activity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resources_documents_activity_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DocRequestActivity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_resources_documents_activity_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*DocActivityData_RequestInfo)(nil),
	}
