...
const file_resources_documents_templates_proto_rawDesc = "" +
	...
	"\vdescription\x18\a \x01(\tB\x06\xda\xf3\x18\x02\b\x01R\vdescription\x12#\n" +
	"\x05color\x18\b \x01(\tB\b\xda\xf3\x18\x04\b\x01\x18\x01H\x02R\x05color\x88\x01\x01\x12!\n" +
	"\x04icon\x18\t \x01(\tB\b\xda\xf3\x18\x04\b\x01\x18\x01H\x03R\x04icon\x88\x01\x01\x12P\n" +
	"\x06schema\x18\n" +
	...
	"\x12TemplateUserAccess\"\xce\x01\n" +
	"\x10TemplateApproval\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12H\n" +
	"\x06policy\x18\x02 \x01(\v2+.resources.documents.TemplateApprovalPolicyH\x00R\x06policy\x88\x01\x01\x12C\n" +
	"\x05tasks\x18\x03 \x03(\v2-.resources.documents.TemplateApprovalTaskSeedR\x05tasks:\x06\xe2\xf3\x18\x02\b\x01B\t\n" +
	"\a_policy\"\xcb\x02\n" +
	"\x16TemplateApprovalPolicy\x12B\n" +
	"\trule_kind\x18\x01 \x01(\x0e2%.resources.documents.ApprovalRuleKindR\bruleKind\x12M\n" +
