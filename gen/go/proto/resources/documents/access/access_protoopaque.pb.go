...
const file_resources_documents_access_access_proto_rawDesc = "" +
	"\n" +
	"'resources/documents/access/access.proto\x12\x1aresources.documents.access\x1a!codegen/dbscanner/dbscanner.proto\x1a resources/users/short/user.proto\x1a\x13tagger/tagger.proto\"\xe4\x01\n" +
	"\x0eDocumentAccess\x12b\n" +
	"\x04jobs\x18\x01 \x03(\v2-.resources.documents.access.DocumentJobAccessB\x1f\x9a\x84\x9e\x03\x12alias:\"job_access\"\xbaH\x05\x92\x01\x02\x10\x14R\x04jobs\x12f\n" +
	"\x05users\x18\x02 \x03(\v2..resources.documents.access.DocumentUserAccessB \x9a\x84\x9e\x03\x13alias:\"user_access\"\xbaH\x05\x92\x01\x02\x10\x14R\x05users:\x06\xe2\xf3\x18\x02\b\x01\"\x8b\x03\n" +
	...
	"\x0fjob_grade_label\x18\a \x01(\tB\a\xbaH\x04r\x02\x182H\x01R\rjobGradeLabel\x88\x01\x01\x12I\n" +
	"\x06access\x18\b \x01(\x0e2'.resources.documents.access.AccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06access\x12\x1f\n" +
	"\brequired\x18\t \x01(\bH\x02R\brequired\x88\x01\x01B\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
	"\x10_job_grade_labelB\v\n" +
	"\t_requiredJ\x04\b\x02\x10\x03\"\xa6\x02\n" +
	...
	"\x04user\x18\x05 \x01(\v2 .resources.users.short.UserShortH\x00R\x04user\x88\x01\x01\x12I\n" +
	"\x06access\x18\x06 \x01(\x0e2'.resources.documents.access.AccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06access\x12\x1f\n" +
