...
type DocumentRelation struct {
	...
	xxx_hidden_Document     *documents.DocumentShort `protobuf:"bytes,4,opt,name=document,proto3,oneof"`
	xxx_hidden_SourceUserId int32                    `protobuf:"varint,5,opt,name=source_user_id,json=sourceUserId,proto3"`
	xxx_hidden_SourceUser   *short.UserShort         `protobuf:"bytes,6,opt,name=source_user,json=sourceUser,proto3,oneof"`
	xxx_hidden_Relation     DocRelation              `protobuf:"varint,7,opt,name=relation,proto3,enum=resources.documents.relations.DocRelation"`
	xxx_hidden_TargetUserId int32                    `protobuf:"varint,8,opt,name=target_user_id,json=targetUserId,proto3"`
	xxx_hidden_TargetUser   *short.UserShort         `protobuf:"bytes,9,opt,name=target_user,json=targetUser,proto3,oneof"`
