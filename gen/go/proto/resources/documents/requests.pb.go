...
const file_resources_documents_requests_proto_rawDesc = "" +
	...
	"\n" +
	"creator_id\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00H\x00R\tcreatorId\x88\x01\x01\x12O\n" +
	"\acreator\x18\a \x01(\v2\x1a.resources.users.UserShortB\x14\x9a\x84\x9e\x03\x0falias:\"creator\"H\x01R\acreator\x88\x01\x01\x12(\n" +
	...
	"\x06reason\x18\n" +
	" \x01(\tB\b\xbaH\x05r\x03\x18\xff\x01H\x03R\x06reason\x88\x01\x01\x128\n" +
