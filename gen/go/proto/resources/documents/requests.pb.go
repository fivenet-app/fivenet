...
const file_resources_documents_requests_proto_rawDesc = "" +
	"\n" +
	"\"resources/documents/requests.proto\x12\x13resources.documents\x1a\"resources/documents/activity.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x13tagger/tagger.proto\"\x8c\x05\n" +
	"\n" +
	"DocRequest\x12\x0e\n" +
	...
	"documentId\x12G\n" +
	"\frequest_type\x18\x05 \x01(\x0e2$.resources.documents.DocActivityTypeR\vrequestType\x12\"\n" +
	"\n" +
	"creator_id\x18\x06 \x01(\x05H\x00R\tcreatorId\x88\x01\x01\x12O\n" +
	"\acreator\x18\a \x01(\v2\x1a.resources.users.UserShortB\x14\x9a\x84\x9e\x03\x0falias:\"creator\"H\x01R\acreator\x88\x01\x01\x12\x1f\n" +
	"\vcreator_job\x18\b \x01(\tR\n" +
	"creatorJob\x12/\n" +
	"\x11creator_job_label\x18\t \x01(\tH\x02R\x0fcreatorJobLabel\x88\x01\x01\x12\x1b\n" +
	"\x06reason\x18\n" +
	" \x01(\tH\x03R\x06reason\x88\x01\x01\x128\n" +
