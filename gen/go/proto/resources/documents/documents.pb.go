...
const (
	DocReference_DOC_REFERENCE_LINKED     DocReference = 0
	DocReference_DOC_REFERENCE_SOLVES     DocReference = 1
	DocReference_DOC_REFERENCE_CLOSES     DocReference = 2
	DocReference_DOC_REFERENCE_DEPRECATES DocReference = 3
)
...
var (
	DocReference_name = map[int32]string{
		...
		1: "DOC_REFERENCE_SOLVES",
		2: "DOC_REFERENCE_CLOSES",
		3: "DOC_REFERENCE_DEPRECATES",
	}
	DocReference_value = map[string]int32{
		"DOC_REFERENCE_LINKED":     0,
		"DOC_REFERENCE_SOLVES":     1,
		"DOC_REFERENCE_CLOSES":     2,
		"DOC_REFERENCE_DEPRECATES": 3,
	}
)
...
const (
	DocRelation_DOC_RELATION_MENTIONED DocRelation = 0
	DocRelation_DOC_RELATION_TARGETS   DocRelation = 1
	DocRelation_DOC_RELATION_CAUSED    DocRelation = 2
)

// Enum value maps for DocRelation.
var (
	DocRelation_name = map[int32]string{
		0: "DOC_RELATION_MENTIONED",
		1: "DOC_RELATION_TARGETS",
		2: "DOC_RELATION_CAUSED",
	}
	DocRelation_value = map[string]int32{
		"DOC_RELATION_MENTIONED": 0,
		"DOC_RELATION_TARGETS":   1,
		"DOC_RELATION_CAUSED":    2,
	}
)
...
type Document struct {
	...
	ContentType DocContentType `protobuf:"varint,7,opt,name=content_type,json=contentType,proto3,enum=resources.documents.DocContentType" json:"content_type,omitempty" alias:"content_type"` // @gotags: alias:"content_type"
	// @sanitize
...
type DocumentJobAccess struct {
	...
	Access        AccessLevel          `protobuf:"varint,9,opt,name=access,proto3,enum=resources.documents.AccessLevel" json:"access,omitempty" alias:"access"`      // @gotags: alias:"access"
}
...
type DocumentUserAccess struct {
	...
	Access     AccessLevel          `protobuf:"varint,7,opt,name=access,proto3,enum=resources.documents.AccessLevel" json:"access,omitempty" alias:"access"` // @gotags: alias:"access"
}
...
func (x *DocumentReference) GetReference() DocReference {
	...
	return DocReference_DOC_REFERENCE_LINKED
}
...
func (x *DocumentRelation) GetRelation() DocRelation {
	...
	return DocRelation_DOC_RELATION_MENTIONED
}
...
var file_resources_documents_documents_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd3, 0x05, 0x0a, 0x08,
	...
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x3e, 0x0a, 0x08,
	...
	0x65, 0x6e, 0x74, 0x73, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x48, 0x01, 0x52,
	0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x88, 0x01, 0x01, 0x12, 0x21, 0x0a, 0x05,
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0b, 0xfa, 0x42, 0x08,
	0x72, 0x06, 0x10, 0x03, 0x28, 0xd5, 0xaa, 0x01, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12,
	0x50, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x65, 0x12, 0x25, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x22, 0x0a, 0x0a,
	...
	0x28, 0x08, 0x52, 0x06, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x12, 0x3d, 0x0a, 0x0a, 0x64, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x63, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x5f, 0x69, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x63, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x6f, 0x72, 0x5f, 0x69, 0x64, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f,
	0x72, 0x22, 0xbd, 0x05, 0x0a, 0x0d, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x68,
	...
	0x6f, 0x72, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x65, 0x73, 0x6f,
	...
	0x67, 0x6f, 0x72, 0x79, 0x88, 0x01, 0x01, 0x12, 0x1d, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x03, 0x52,
	0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x50, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e,
	0x74, 0x73, 0x2e, 0x44, 0x6f, 0x63, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70,
	0x65, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x0b, 0x63, 0x6f, 0x6e,
	...
	,
	...
	0xfa, 0x03, 0x0a, 0x11, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x4a, 0x6f, 0x62, 0x41,
	...
	0x04, 0x72, 0x02, 0x18, 0x32, 0x48, 0x02, 0x52, 0x08, 0x6a, 0x6f, 0x62, 0x4c, 0x61, 0x62, 0x65,
	...
	0x4c, 0x61, 0x62, 0x65, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x42, 0x0a, 0x06, 0x61, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6a,
	0x6f, 0x62, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x42, 0x12, 0x0a, 0x10, 0x5f, 0x6a, 0x6f, 0x62,
	0x5f, 0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0x8f, 0x03, 0x0a,
	...
	0x88, 0x01, 0x01, 0x12, 0x42, 0x0a, 0x06, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x07, 0x20,
	...
	0x65, 0x64, 0x5f, 0x61, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x22, 0xef,
	0x04, 0x0a, 0x11, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x12, 0x13, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x48, 0x01, 0x52,
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x88, 0x01, 0x01, 0x12, 0x2c, 0x0a,
	0x12, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74,
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x50, 0x0a, 0x0f, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x04,
	...
	0x65, 0x6e, 0x74, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x48, 0x02, 0x52, 0x0e, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x88, 0x01, 0x01, 0x12, 0x49, 0x0a,
	0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x21, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x64, 0x6f, 0x63,
	0x75, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x44, 0x6f, 0x63, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x09, 0x72,
	...
	0x22, 0xbe, 0x04, 0x0a, 0x10, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x6c,
	...
	0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x46, 0x0a, 0x08, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x44, 0x6f,
	0x63, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x82, 0x01,
	...
	0x72, 0x2a, 0x69, 0x0a, 0x0e, 0x44, 0x6f, 0x63, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x54,
	...
	,
...
var file_resources_documents_documents_proto_depIdxs = []int32{
	...
	11, // 2: resources.documents.Document.category:type_name -> resources.documents.Category
	0,  // 3: resources.documents.Document.content_type:type_name -> resources.documents.DocContentType
	12, // 4: resources.documents.Document.creator:type_name -> resources.users.UserShort
	10, // 5: resources.documents.Document.deleted_at:type_name -> resources.timestamp.Timestamp
	...
	11, // 8: resources.documents.DocumentShort.category:type_name -> resources.documents.Category
	0,  // 9: resources.documents.DocumentShort.content_type:type_name -> resources.documents.DocContentType
	12, // 10: resources.documents.DocumentShort.creator:type_name -> resources.users.UserShort
	10, // 11: resources.documents.DocumentShort.deleted_at:type_name -> resources.timestamp.Timestamp
	...
	10, // 15: resources.documents.DocumentJobAccess.updated_at:type_name -> resources.timestamp.Timestamp
	13, // 16: resources.documents.DocumentJobAccess.access:type_name -> resources.documents.AccessLevel
	10, // 17: resources.documents.DocumentUserAccess.created_at:type_name -> resources.timestamp.Timestamp
	10, // 18: resources.documents.DocumentUserAccess.updated_at:type_name -> resources.timestamp.Timestamp
	12, // 19: resources.documents.DocumentUserAccess.user:type_name -> resources.users.UserShort
	13, // 20: resources.documents.DocumentUserAccess.access:type_name -> resources.documents.AccessLevel
	10, // 21: resources.documents.DocumentReference.created_at:type_name -> resources.timestamp.Timestamp
	4,  // 22: resources.documents.DocumentReference.source_document:type_name -> resources.documents.DocumentShort
	1,  // 23: resources.documents.DocumentReference.reference:type_name -> resources.documents.DocReference
	4,  // 24: resources.documents.DocumentReference.target_document:type_name -> resources.documents.DocumentShort
	12, // 25: resources.documents.DocumentReference.creator:type_name -> resources.users.UserShort
	10, // 26: resources.documents.DocumentRelation.created_at:type_name -> resources.timestamp.Timestamp
	4,  // 27: resources.documents.DocumentRelation.document:type_name -> resources.documents.DocumentShort
	12, // 28: resources.documents.DocumentRelation.source_user:type_name -> resources.users.UserShort
	2,  // 29: resources.documents.DocumentRelation.relation:type_name -> resources.documents.DocRelation
