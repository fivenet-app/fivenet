...
type Stamp struct {
	...
	xxx_hidden_Access      *StampAccess           `protobuf:"bytes,7,opt,name=access,proto3"`
...
type StampAccess struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Jobs *[]*StampJobAccess     `protobuf:"bytes,1,rep,name=jobs,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type StampJobAccess struct {
	...
	xxx_hidden_Access        StampAccessLevel       `protobuf:"varint,8,opt,name=access,proto3,enum=resources.documents.stamps.StampAccessLevel"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
const file_resources_documents_stamps_stamp_proto_rawDesc = "" +
	"\n" +
	"&resources/documents/stamps/stamp.proto\x12\x1aresources.documents.stamps\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xbf\x02\n" +
	"\x05Stamp\x12\x0e\n" +
	...
	"_job_label\"n\n" +
	"\vStampAccess\x12_\n" +
	"\x04jobs\x18\x01 \x03(\v2*.resources.documents.stamps.StampJobAccessB\x1f\x9a\x84\x9e\x03\x12alias:\"job_access\"\xbaH\x05\x92\x01\x02\x10\x14R\x04jobs\"\xac\x03\n" +
	...
	"\x06access\x18\b \x01(\x0e2,.resources.documents.stamps.StampAccessLevelB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06accessB\r\n" +
	"\v_created_atB\f\n" +
	"\n" +
	"_job_labelB\x12\n" +
