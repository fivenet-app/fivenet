...
var file_resources_documents_comment_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x85, 0x04, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12,
...
func file_resources_documents_comment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_documents_comment_proto_msgTypes[0].Exporter = func(v any, i int) any {
