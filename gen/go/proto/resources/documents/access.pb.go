...
const file_resources_documents_access_proto_rawDesc = "" +
	"\n" +
	" resources/documents/access.proto\x12\x13resources.documents\x1a!codegen/dbscanner/dbscanner.proto\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x13tagger/tagger.proto\"\xc6\x01\n" +
	"\x0eDocumentAccess\x12S\n" +
	"\x04jobs\x18\x01 \x03(\v2&.resources.documents.DocumentJobAccessB\x17\x9a\x84\x9e\x03\x12alias:\"job_access\"R\x04jobs\x12W\n" +
	"\x05users\x18\x02 \x03(\v2'.resources.documents.DocumentUserAccessB\x18\x9a\x84\x9e\x03\x13alias:\"user_access\"R\x05users:\x06\xe2\xf3\x18\x02\b\x01\"\xa3\x03\n" +
	...
	"\x06access\x18\b \x01(\x0e2 .resources.documents.AccessLevelR\x06access\x12\x1f\n" +
	...
	"\x04user\x18\x05 \x01(\v2\x1a.resources.users.UserShortH\x01R\x04user\x88\x01\x01\x128\n" +
	"\x06access\x18\x06 \x01(\x0e2 .resources.documents.AccessLevelR\x06access\x12\x1f\n" +
