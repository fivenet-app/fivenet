...
const file_resources_documents_access_proto_rawDesc = "" +
	"\n" +
	" resources/documents/access.proto\x12\x13resources.documents\x1a#resources/timestamp/timestamp.proto\x1a\x1bresources/users/users.proto\x1a\x17validate/validate.proto\"\x9f\x01\n" +
	"\x0eDocumentAccess\x12D\n" +
	"\x04jobs\x18\x01 \x03(\v2&.resources.documents.DocumentJobAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\x04jobs\x12G\n" +
	"\x05users\x18\x02 \x03(\v2'.resources.documents.DocumentUserAccessB\b\xfaB\x05\x92\x01\x02\x10\x14R\x05users\"\xd1\x03\n" +
	...
	"\x06access\x18\b \x01(\x0e2 .resources.documents.AccessLevelB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06access\x12\x1f\n" +
	...
	"\x06access\x18\x06 \x01(\x0e2 .resources.documents.AccessLevelB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06access\x12\x1f\n" +
