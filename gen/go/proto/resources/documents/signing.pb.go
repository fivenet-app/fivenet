...
const file_resources_documents_signing_proto_rawDesc = "" +
	"\n" +
	"!resources/documents/signing.proto\x12\x13resources.documents\x1a\"resources/documents/approval.proto\x1a#resources/timestamp/timestamp.proto\"\xc8\x03\n" +
	...
	"\bselector\x18\a \x01(\v2\".resources.documents.PartySelectorR\bselector\x12M\n" +
	"\fbinding_mode\x18\b \x01(\x0e2 .resources.documents.BindingModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\vbindingMode\x12X\n" +
	"\rallowed_types\x18\t \x03(\x0e2\".resources.documents.SignatureTypeB\x0f\xbaH\f\x92\x01\t\x10\x03\"\x05\x82\x01\x02\x10\x01R\fallowedTypes\"\xbf\x04\n" +
	"\tSignature\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1f\n" +
	"\vdocument_id\x18\x02 \x01(\x03R\n" +
	"documentId\x12*\n" +
	...
	"\rsnapshot_hash\x18\t \x01(\tR\fsnapshotHash\x12F\n" +
	"\x06status\x18\n" +
	" \x01(\x0e2$.resources.documents.SignatureStatusB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06status\x12\x16\n" +
