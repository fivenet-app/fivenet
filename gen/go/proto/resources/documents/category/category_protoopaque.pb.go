...
const file_resources_documents_category_category_proto_rawDesc = "" +
	"\n" +
	"+resources/documents/category/category.proto\x12\x1cresources.documents.category\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\"\xad\x03\n" +
	"\bCategory\x12\x0e\n" +
	...
	"\x05color\x18\a \x01(\tB\x11\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x06r\x04\x10\x03\x18\aH\x03R\x05color\x88\x01\x01\x12)\n" +
	"\x04icon\x18\b \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01H\x04R\x04icon\x88\x01\x01B\r\n" +
	"\v_deleted_atB\x0e\n" +
	"\f_descriptionB\x06\n" +
	"\x04_jobB\b\n" +
	"\x06_colorB\a\n" +
