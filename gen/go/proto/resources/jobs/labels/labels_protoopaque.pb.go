...
type Label struct {
	...
	xxx_hidden_Icon        *string                `protobuf:"bytes,6,opt,name=icon,proto3,oneof"`
	xxx_hidden_SortOrder   int32                  `protobuf:"varint,7,opt,name=sort_order,json=sortOrder,proto3"`
...
const file_resources_jobs_labels_labels_proto_rawDesc = "" +
	"\n" +
	"\"resources/jobs/labels/labels.proto\x12\x15resources.jobs.labels\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"D\n" +
	"\x06Labels\x12:\n" +
	"\x04list\x18\x01 \x03(\v2\x1c.resources.jobs.labels.LabelB\b\xbaH\x05\x92\x01\x02\x10\n" +
	"R\x04list\"\xe9\x02\n" +
	"\x05Label\x121\n" +
	...
	"\x04name\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x180R\x04name\x129\n" +
	"\x05color\x18\x05 \x01(\tB#\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x18r\x162\x11^#[A-Fa-f0-9]{6}$\x98\x01\aR\x05color\x12)\n" +
	"\x04icon\x18\x06 \x01(\tB\x10\xda\xf3\x18\x04\b\x01\x18\x01\xbaH\x05r\x03\x18\x80\x01H\x02R\x04icon\x88\x01\x01\x12&\n" +
	"\n" +
	"sort_order\x18\a \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tsortOrderB\x06\n" +
	"\x04_jobB\r\n" +
	"\v_deleted_atB\a\n" +
	"\x05_icon\"V\n" +
	"\n" +
