...
const file_resources_jobs_conduct_proto_rawDesc = "" +
	"\n" +
	"\x1cresources/jobs/conduct.proto\x12\x0eresources.jobs\x1a!codegen/sanitizer/sanitizer.proto\x1a\x1fresources/jobs/colleagues.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xfe\x05\n" +
	"\fConductEntry\x121\n" +
	...
	"\x04type\x18\x06 \x01(\x0e2\x1b.resources.jobs.ConductTypeR\x04type\x12 \n" +
	"\amessage\x18\a \x01(\tB\x06\xda\xf3\x18\x02\b\x01R\amessage\x12B\n" +
	"\n" +
	"expires_at\x18\b \x01(\v2\x1e.resources.timestamp.TimestampH\x03R\texpiresAt\x88\x01\x01\x12$\n" +
	"\x0etarget_user_id\x18\t \x01(\x05R\ftargetUserId\x12Y\n" +
	"\vtarget_user\x18\n" +
	" \x01(\v2\x19.resources.jobs.ColleagueB\x18\x9a\x84\x9e\x03\x13alias:\"target_user\"H\x04R\n" +
	"targetUser\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"creator_id\x18\v \x01(\x05R\tcreatorId\x12N\n" +
