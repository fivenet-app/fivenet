...
type PlayerTime struct {
	...
	Minutes uint64               `protobuf:"varint,6,opt,name=minutes,proto3" json:"minutes,omitempty"`
}

func (x *PlayerTime) Reset() {
	*x = PlayerTime{}
...
func (x *PlayerTime) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlayerTime) ProtoMessage() {}

func (x *PlayerTime) ProtoReflect() protoreflect.Message {
	mi := &file_resources_jobs_timeclock_proto_msgTypes[0]
...
// Deprecated: Use PlayerTime.ProtoReflect.Descriptor instead.
func (*PlayerTime) Descriptor() ([]byte, []int) {
	return file_resources_jobs_timeclock_proto_rawDescGZIP(), []int{0}
}

func (x *PlayerTime) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PlayerTime) GetJob() string {
	if x != nil {
		return x.Job
	}
	return ""
...
func (x *PlayerTime) GetDate() *timestamp.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *PlayerTime) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PlayerTime) GetUser() *users.UserShort {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *PlayerTime) GetMinutes() uint64 {
	if x != nil {
		return x.Minutes
	}
	return 0
...
func (x *TimeclockEntry) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_resources_jobs_timeclock_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc, 0x01, 0x0a, 0x0a,
	0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x03, 0x6a, 0x6f,
	0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x18, 0x14,
	0x52, 0x03, 0x6a, 0x6f, 0x62, 0x12, 0x32, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20,
	...
	0x61, 0x6d, 0x70, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	...
	0x75, 0x73, 0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x69, 0x6e, 0x75, 0x74,
	0x65, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6d, 0x69, 0x6e, 0x75, 0x74, 0x65,
	0x73, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x22, 0x20, 0x0a, 0x0e, 0x54, 0x69,
	0x6d, 0x65, 0x63, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x42, 0x3d, 0x5a, 0x3b,
...
var file_resources_jobs_timeclock_proto_goTypes = []interface{}{
	(*PlayerTime)(nil),          // 0: resources.jobs.PlayerTime
	(*TimeclockEntry)(nil),      // 1: resources.jobs.TimeclockEntry
...
var file_resources_jobs_timeclock_proto_depIdxs = []int32{
	2, // 0: resources.jobs.PlayerTime.date:type_name -> resources.timestamp.Timestamp
	3, // 1: resources.jobs.PlayerTime.user:type_name -> resources.users.UserShort
