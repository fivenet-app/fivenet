...
const file_resources_jobs_activity_proto_rawDesc = "" +
	...
	"\x03job\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18\x14R\x03job\x122\n" +
	"\x0esource_user_id\x18\x05 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00H\x01R\fsourceUserId\x88\x01\x01\x12?\n" +
	"\vsource_user\x18\x06 \x01(\v2\x19.resources.jobs.ColleagueH\x02R\n" +
