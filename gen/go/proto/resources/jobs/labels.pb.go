...
const file_resources_jobs_labels_proto_rawDesc = "" +
	"\n" +
	"\x1bresources/jobs/labels.proto\x12\x0eresources.jobs\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"3\n" +
	"\x06Labels\x12)\n" +
	"\x04list\x18\x01 \x03(\v2\x15.resources.jobs.LabelR\x04list\"\xff\x01\n" +
	"\x05Label\x121\n" +
	...
	"\x05color\x18\x05 \x01(\tB\x11\xda\xf3\x18\r\b\x01\x12\tStripTagsR\x05color\x12\x14\n" +
