...
const file_resources_jobs_job_props_proto_rawDesc = "" +
	"\n" +
	"\x1eresources/jobs/job_props.proto\x12\x0eresources.jobs\x1a!codegen/dbscanner/dbscanner.proto\x1a\x19resources/file/file.proto\x1a!resources/jobs/job_settings.proto\x1a#resources/timestamp/timestamp.proto\x1a\x13tagger/tagger.proto\"\xbf\a\n" +
	"\bJobProps\x12\x10\n" +
	...
	"\x14livemap_marker_color\x18\x04 \x01(\tR\x12livemapMarkerColor\x12A\n" +
	"\rquick_buttons\x18\x05 \x01(\v2\x1c.resources.jobs.QuickButtonsR\fquickButtons\x12,\n" +
	...
	" \x01(\v2\".resources.jobs.DiscordSyncChangesH\x05R\x12discordSyncChanges\x88\x01\x01\x12\x17\n" +
