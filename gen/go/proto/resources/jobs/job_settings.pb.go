...
const file_resources_jobs_job_settings_proto_rawDesc = "" +
	"\n" +
	"!resources/jobs/job_settings.proto\x12\x0eresources.jobs\x1a!codegen/dbscanner/dbscanner.proto\x1a!codegen/sanitizer/sanitizer.proto\x1a#resources/timestamp/timestamp.proto\"\xb8\x04\n" +
	...
	"\x13group_sync_settings\x18\b \x01(\v2!.resources.jobs.GroupSyncSettingsR\x11groupSyncSettings\x12<\n" +
	"\x1aqualifications_role_format\x18\t \x01(\tR\x18qualificationsRoleFormat:\x06\xe2\xf3\x18\x02\b\x01\"Y\n" +
	...
	"\x04plan\x18\x02 \x01(\tR\x04plan\"\xc8\x03\n" +
	...
	"\x12unemployed_enabled\x18\x04 \x01(\bR\x11unemployedEnabled\x12S\n" +
	"\x0funemployed_mode\x18\x05 \x01(\x0e2*.resources.jobs.UserInfoSyncUnemployedModeR\x0eunemployedMode\x120\n" +
	"\x14unemployed_role_name\x18\x06 \x01(\tR\x12unemployedRoleName\x12%\n" +
	"\x0esync_nicknames\x18\a \x01(\bR\rsyncNicknames\x12A\n" +
	"\rgroup_mapping\x18\b \x03(\v2\x1c.resources.jobs.GroupMappingR\fgroupMapping\"\\\n" +
