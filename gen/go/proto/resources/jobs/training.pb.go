...
func (x *TrainingModule) GetRequireRequirements() bool {
	if x != nil {
...
type TrainingResult struct {
	...
	TrainingId uint64               `protobuf:"varint,1,opt,name=training_id,json=trainingId,proto3" json:"training_id,omitempty"`
	CreatedAt  *timestamp.Timestamp `protobuf:"bytes,2,opt,name=created_at,json=createdAt,proto3,oneof" json:"created_at,omitempty"`
...
func (x *TrainingResult) Reset() {
	*x = TrainingResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_jobs_training_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TrainingResult) Descriptor() ([]byte, []int) {
	return file_resources_jobs_training_proto_rawDescGZIP(), []int{2}
}

func (x *TrainingResult) GetTrainingId() uint64 {
	if x != nil {
		return x.TrainingId
	}
	return 0
...
func (x *TrainingResult) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *TrainingResult) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *TrainingResult) GetUser() *users.UserShort {
	if x != nil {
		return x.User
	}
	return nil
...
var file_resources_jobs_training_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x03, 0x0a, 0x0e, 0x54,
	0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x41, 0x74, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x04, 0x20, 0x01,
	...
	0x6f, 0x70, 0x65, 0x6e, 0x12, 0x31, 0x0a, 0x14, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x5f,
	0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x13, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x69,
	0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x2c, 0x0a, 0x0d, 0x6d, 0x69, 0x6e, 0x69, 0x6d,
	0x75, 0x6d, 0x5f, 0x67, 0x72, 0x61, 0x64, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x42, 0x07,
	0xfa, 0x42, 0x04, 0x1a, 0x02, 0x20, 0x00, 0x52, 0x0c, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d,
	0x47, 0x72, 0x61, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x08,
	...
	0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x22, 0x11, 0x0a, 0x0f, 0x54,
	0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xcd,
	0x01, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67,
	...
	0x64, 0x41, 0x74, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12,
	0x2e, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	...
	0x0d, 0x0a, 0x0b, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x42, 0x3d,
...
var file_resources_jobs_training_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_resources_jobs_training_proto_goTypes = []interface{}{
	(*TrainingModule)(nil),      // 0: resources.jobs.TrainingModule
	(*TrainingRequest)(nil),     // 1: resources.jobs.TrainingRequest
	(*TrainingResult)(nil),      // 2: resources.jobs.TrainingResult
...
var file_resources_jobs_training_proto_depIdxs = []int32{
	3, // 0: resources.jobs.TrainingModule.created_at:type_name -> resources.timestamp.Timestamp
	3, // 1: resources.jobs.TrainingModule.updated_at:type_name -> resources.timestamp.Timestamp
	3, // 2: resources.jobs.TrainingResult.created_at:type_name -> resources.timestamp.Timestamp
	4, // 3: resources.jobs.TrainingResult.user:type_name -> resources.users.UserShort
...
func file_resources_jobs_training_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resources_jobs_training_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_jobs_training_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
