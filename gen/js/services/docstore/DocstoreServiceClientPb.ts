...
export class DocStoreServiceClient {
  ...
  methodDescriptorListDocuments = new grpcWeb.MethodDescriptor(
    '/services.docstore.DocStoreService/ListDocuments',
    grpcWeb.MethodType.UNARY,
    services_docstore_docstore_pb.ListDocumentsRequest,
    services_docstore_docstore_pb.ListDocumentsResponse,
    (request: services_docstore_docstore_pb.ListDocumentsRequest) => {
      return request.serializeBinary();
    },
    services_docstore_docstore_pb.ListDocumentsResponse.deserializeBinary
  );

  listDocuments(
    request: services_docstore_docstore_pb.ListDocumentsRequest,
    metadata: grpcWeb.Metadata | null): Promise<services_docstore_docstore_pb.ListDocumentsResponse>;

  listDocuments(
    request: services_docstore_docstore_pb.ListDocumentsRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: services_docstore_docstore_pb.ListDocumentsResponse) => void): grpcWeb.ClientReadableStream<services_docstore_docstore_pb.ListDocumentsResponse>;

  listDocuments(
    request: services_docstore_docstore_pb.ListDocumentsRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: services_docstore_docstore_pb.ListDocumentsResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/services.docstore.DocStoreService/ListDocuments',
  ...
  methodDescriptorListUserDocuments = new grpcWeb.MethodDescriptor(
    '/services.docstore.DocStoreService/ListUserDocuments',
    grpcWeb.MethodType.UNARY,
    services_docstore_docstore_pb.ListUserDocumentsRequest,
    services_docstore_docstore_pb.ListUserDocumentsResponse,
    (request: services_docstore_docstore_pb.ListUserDocumentsRequest) => {
      return request.serializeBinary();
    },
    services_docstore_docstore_pb.ListUserDocumentsResponse.deserializeBinary
  );

  listUserDocuments(
    request: services_docstore_docstore_pb.ListUserDocumentsRequest,
    metadata: grpcWeb.Metadata | null): Promise<services_docstore_docstore_pb.ListUserDocumentsResponse>;

  listUserDocuments(
    request: services_docstore_docstore_pb.ListUserDocumentsRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: services_docstore_docstore_pb.ListUserDocumentsResponse) => void): grpcWeb.ClientReadableStream<services_docstore_docstore_pb.ListUserDocumentsResponse>;

  listUserDocuments(
    request: services_docstore_docstore_pb.ListUserDocumentsRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: services_docstore_docstore_pb.ListUserDocumentsResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/services.docstore.DocStoreService/ListUserDocuments',
        request,
        metadata || {},
        this.methodDescriptorListUserDocuments,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
