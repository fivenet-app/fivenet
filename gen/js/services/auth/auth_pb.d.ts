...
export class DeleteOAuth2ConnectionRequest extends jspb.Message {
  getProvider(): string;
  setProvider(value: string): DeleteOAuth2ConnectionRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DeleteOAuth2ConnectionRequest.AsObject;
  static toObject(includeInstance: boolean, msg: DeleteOAuth2ConnectionRequest): DeleteOAuth2ConnectionRequest.AsObject;
  static serializeBinaryToWriter(message: DeleteOAuth2ConnectionRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DeleteOAuth2ConnectionRequest;
  static deserializeBinaryFromReader(message: DeleteOAuth2ConnectionRequest, reader: jspb.BinaryReader): DeleteOAuth2ConnectionRequest;
}

export namespace DeleteOAuth2ConnectionRequest {
  export type AsObject = {
    provider: string,
  }
}

export class DeleteOAuth2ConnectionResponse extends jspb.Message {
  getSuccess(): boolean;
  setSuccess(value: boolean): DeleteOAuth2ConnectionResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DeleteOAuth2ConnectionResponse.AsObject;
  static toObject(includeInstance: boolean, msg: DeleteOAuth2ConnectionResponse): DeleteOAuth2ConnectionResponse.AsObject;
  static serializeBinaryToWriter(message: DeleteOAuth2ConnectionResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DeleteOAuth2ConnectionResponse;
  static deserializeBinaryFromReader(message: DeleteOAuth2ConnectionResponse, reader: jspb.BinaryReader): DeleteOAuth2ConnectionResponse;
}

export namespace DeleteOAuth2ConnectionResponse {
  export type AsObject = {
    success: boolean,
  }
}
