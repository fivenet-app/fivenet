...
export const GroupsService = new ServiceType("services.jobs.GroupsService", [
    ...
    { name: "UploadGroupLogo", clientStreaming: true, options: { "codegen.perms.perms": { enabled: true, name: "CreateGroup" } }, I: UploadFileRequest, O: UploadFileResponse },
    { name: "DeleteGroupLogo", options: { "codegen.perms.perms": { enabled: true, name: "CreateGroup" } }, I: DeleteGroupLogoRequest, O: DeleteGroupLogoResponse },
