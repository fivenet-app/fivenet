...
class ReadNotificationsRequest$Type extends MessageType<ReadNotificationsRequest> {
    constructor() {
        super("services.notificator.ReadNotificationsRequest", [
            { no: 1, name: "ids", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/, options: { "validate.rules": { repeated: { minItems: "1", maxItems: "20" } } } }
        ]);
    }
}
/**
...
class StreamRequest$Type extends MessageType<StreamRequest> {
    constructor() {
        super("services.notificator.StreamRequest", [
            { no: 1, name: "last_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
}
/**
