...
import type { SetVehiclePropsResponse } from "./sync";
import type { SetVehiclePropsRequest } from "./sync";
import type { GetVehiclePropsResponse } from "./sync";
import type { GetVehiclePropsRequest } from "./sync";
...
export interface ISyncServiceClient {
     ...
     *
     * @generated from protobuf rpc: GetVehicleProps
     */
    getVehicleProps(input: GetVehiclePropsRequest, options?: RpcOptions): UnaryCall<GetVehiclePropsRequest, GetVehiclePropsResponse>;
    /**
...
export class SyncServiceClient implements ISyncServiceClient, ServiceInfo {
    ...
    getVehicleProps(input: GetVehiclePropsRequest, options?: RpcOptions): UnaryCall<GetVehiclePropsRequest, GetVehiclePropsResponse> {
        ...
        return stackIntercept<GetVehiclePropsRequest, GetVehiclePropsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Update vehicle props.
     *
