...
import type { EmptyRequest } from "../../resources/common/common.js";
...
export interface ICentrumServiceClient {
     ...
     * @perm
     *
     * @generated from protobuf rpc: GetSettings(resources.common.EmptyRequest) returns (resources.dispatch.Settings);
     */
    getSettings(input: EmptyRequest, options?: RpcOptions): UnaryCall<EmptyRequest, Settings>;
    /**
...
export class CentrumServiceClient implements ICentrumServiceClient, ServiceInfo {
    ...
    getSettings(input: EmptyRequest, options?: RpcOptions): UnaryCall<EmptyRequest, Settings> {
        ...
        return stackIntercept<EmptyRequest, Settings>("unary", this._transport, method, opt, input);
    }
    /**
     * @perm: Name=GetSettings
     *
