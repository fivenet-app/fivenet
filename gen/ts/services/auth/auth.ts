...
import { OAuth2Account, OAuth2Provider } from '../../resources/accounts/oauth2.js';
        ...
        super('services.auth.CreateAccountRequest', [
            {
                ...
                options: { 'validate.rules': { string: { len: '6', pattern: '^[0-9]{6}$' } } },
            },
            {
                no: 2,
                name: 'username',
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { minLen: '3', maxLen: '24', pattern: '^[0-9A-ZÄÖÜß_-]*$' } } },
            },
            {
                no: 3,
                name: 'password',
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { minLen: '6', maxBytes: '70' } } },
            },
        ]);
    }
}
...
class LogoutResponse$Type extends MessageType<LogoutResponse> {
    constructor() {
        super('services.auth.LogoutResponse', [{ no: 1, name: 'success', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ }]);
    }
}
/**
        ...
        super('services.auth.DeleteOAuth2ConnectionRequest', [
            {
                ...
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { maxLen: '50' } } },
            },
        ]);
    }
}
