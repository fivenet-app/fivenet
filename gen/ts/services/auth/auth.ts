...
class CreateAccountRequest$Type extends MessageType<CreateAccountRequest> {
    constructor() {
        super("services.auth.CreateAccountRequest", [
            ...
            { no: 2, name: "username", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "3", maxLen: "24", pattern: "^[a-zA-Z0-9-_]+$" } } } },
...
class LoginRequest$Type extends MessageType<LoginRequest> {
    constructor() {
        super("services.auth.LoginRequest", [
            { no: 1, name: "username", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "3", maxLen: "24", pattern: "^[a-zA-Z0-9-_]+$" } } } },
