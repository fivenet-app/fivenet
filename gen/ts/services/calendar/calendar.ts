...
class ListCalendarsRequest$Type extends MessageType<ListCalendarsRequest> {
    constructor() {
        super("services.calendar.ListCalendarsRequest", [
            ...
            { no: 5, name: "calendar_ids", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/, options: { "buf.validate.field": { repeated: { maxItems: "50" } } } }
        ]);
    }
