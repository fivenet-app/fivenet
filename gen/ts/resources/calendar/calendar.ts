...
class Calendar$Type extends MessageType<Calendar> {
    constructor() {
        super('resources.calendar.Calendar', [
            ...
            },
            {
                ...
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { minLen: '3', maxLen: '255' } } },
            },
            {
                no: 7,
                name: 'description',
                ...
                opt: true,
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { maxLen: '512' } } },
            },
            ...
            { no: 9, name: 'closed', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
            {
                ...
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { maxLen: '12' } } },
            },
    ...
    create(value?: PartialMessage<Calendar>): Calendar {
        ...
        message.color = '';
        message.creatorJob = '';
        if (value !== undefined) reflectionMergePartial<Calendar>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional resources.calendar.CalendarSub subscription */ 14:
                    message.subscription = CalendarSub.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
    ...
    internalBinaryWrite(message: Calendar, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id !== '0') writer.tag(1, WireType.Varint).uint64(message.id);
        ...
        if (message.job !== undefined) writer.tag(5, WireType.LengthDelimited).string(message.job);
        /* string name = 6; */
        if (message.name !== '') writer.tag(6, WireType.LengthDelimited).string(message.name);
        /* optional string description = 7; */
        if (message.description !== undefined) writer.tag(7, WireType.LengthDelimited).string(message.description);
        /* bool public = 8; */
        if (message.public !== false) writer.tag(8, WireType.Varint).bool(message.public);
        /* bool closed = 9; */
        if (message.closed !== false) writer.tag(9, WireType.Varint).bool(message.closed);
        /* string color = 10; */
        if (message.color !== '') writer.tag(10, WireType.LengthDelimited).string(message.color);
        /* optional int32 creator_id = 11; */
        if (message.creatorId !== undefined) writer.tag(11, WireType.Varint).int32(message.creatorId);
        ...
        if (message.creatorJob !== '') writer.tag(13, WireType.LengthDelimited).string(message.creatorJob);
        /* optional resources.calendar.CalendarSub subscription = 14; */
        if (message.subscription)
            CalendarSub.internalBinaryWrite(
                message.subscription,
...
class CalendarShort$Type extends MessageType<CalendarShort> {
    ...
    create(value?: PartialMessage<CalendarShort>): CalendarShort {
        ...
        message.closed = false;
        message.color = '';
        if (value !== undefined) reflectionMergePartial<CalendarShort>(this, message, value);
        return message;
    }
    internalBinaryRead(
...
class CalendarSub$Type extends MessageType<CalendarSub> {
    ...
    create(value?: PartialMessage<CalendarSub>): CalendarSub {
        ...
        message.muted = false;
        if (value !== undefined) reflectionMergePartial<CalendarSub>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: CalendarSub, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.calendarId !== '0') writer.tag(1, WireType.Varint).uint64(message.calendarId);
        /* int32 user_id = 2; */
        ...
        /* bool confirmed = 5; */
        if (message.confirmed !== false) writer.tag(5, WireType.Varint).bool(message.confirmed);
        /* bool muted = 6; */
        if (message.muted !== false) writer.tag(6, WireType.Varint).bool(message.muted);
        let u = options.writeUnknownFields;
        if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
    }
...
class CalendarEntry$Type extends MessageType<CalendarEntry> {
    constructor() {
        super('resources.calendar.CalendarEntry', [
            ...
            { no: 9, name: 'end_time', kind: 'message', T: () => Timestamp },
            {
                ...
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { minLen: '3', maxLen: '512' } } },
            },
            {
                no: 11,
                name: 'content',
                kind: 'scalar',
                T: 9 /*ScalarType.STRING*/,
                options: { 'validate.rules': { string: { minLen: '20', maxBytes: '1000000' } } },
            },
    ...
    create(value?: PartialMessage<CalendarEntry>): CalendarEntry {
        ...
        message.closed = false;
        message.creatorJob = '';
        if (value !== undefined) reflectionMergePartial<CalendarEntry>(this, message, value);
        return message;
    }
    internalBinaryRead(
        reader: IBinaryReader,
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional resources.calendar.CalendarEntryRecurring recurring */ 17:
                    message.recurring = CalendarEntryRecurring.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.recurring,
    ...
    internalBinaryWrite(message: CalendarEntry, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.calendarId !== '0') writer.tag(5, WireType.Varint).uint64(message.calendarId);
        ...
        if (message.job !== undefined) writer.tag(7, WireType.LengthDelimited).string(message.job);
        ...
        /* string title = 10; */
        if (message.title !== '') writer.tag(10, WireType.LengthDelimited).string(message.title);
        /* string content = 11; */
        if (message.content !== '') writer.tag(11, WireType.LengthDelimited).string(message.content);
        /* bool closed = 12; */
        if (message.closed !== false) writer.tag(12, WireType.Varint).bool(message.closed);
        /* optional bool rsvp_open = 13; */
        if (message.rsvpOpen !== undefined) writer.tag(13, WireType.Varint).bool(message.rsvpOpen);
        /* optional int32 creator_id = 14; */
        if (message.creatorId !== undefined) writer.tag(14, WireType.Varint).int32(message.creatorId);
        ...
        if (message.creatorJob !== '') writer.tag(16, WireType.LengthDelimited).string(message.creatorJob);
        /* optional resources.calendar.CalendarEntryRecurring recurring = 17; */
        if (message.recurring)
            CalendarEntryRecurring.internalBinaryWrite(
                message.recurring,
...
class CalendarEntryRecurring$Type extends MessageType<CalendarEntryRecurring> {
    ...
    create(value?: PartialMessage<CalendarEntryRecurring>): CalendarEntryRecurring {
        ...
        message.every = '';
        message.count = 0;
        if (value !== undefined) reflectionMergePartial<CalendarEntryRecurring>(this, message, value);
        return message;
    }
    internalBinaryRead(
        reader: IBinaryReader,
    ...
    internalBinaryWrite(message: CalendarEntryRecurring, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string every = 1; */
        if (message.every !== '') writer.tag(1, WireType.LengthDelimited).string(message.every);
        /* int32 count = 2; */
        if (message.count !== 0) writer.tag(2, WireType.Varint).int32(message.count);
...
class CalendarEntryRSVP$Type extends MessageType<CalendarEntryRSVP> {
    constructor() {
        super('resources.calendar.CalendarEntryRSVP', [
            ...
            { no: 4, name: 'user', kind: 'message', T: () => UserShort },
            {
                ...
                name: 'response',
                kind: 'enum',
                T: () => ['resources.calendar.RsvpResponses', RsvpResponses, 'RSVP_RESPONSES_'],
    ...
    create(value?: PartialMessage<CalendarEntryRSVP>): CalendarEntryRSVP {
        ...
        message.userId = 0;
        message.response = 0;
        if (value !== undefined) reflectionMergePartial<CalendarEntryRSVP>(this, message, value);
        return message;
    }
    internalBinaryRead(
        reader: IBinaryReader,
    ...
    internalBinaryWrite(message: CalendarEntryRSVP, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.entryId !== '0') writer.tag(1, WireType.Varint).uint64(message.entryId);
        /* optional resources.timestamp.Timestamp created_at = 2; */
        if (message.createdAt)
            Timestamp.internalBinaryWrite(message.createdAt, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* int32 user_id = 3; */
        ...
        if (message.response !== 0) writer.tag(5, WireType.Varint).int32(message.response);
        let u = options.writeUnknownFields;
        if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
    }
