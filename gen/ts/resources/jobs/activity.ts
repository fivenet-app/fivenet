...
class ColleagueActivity$Type extends MessageType<ColleagueActivity> {
    constructor() {
        super("resources.jobs.ColleagueActivity", [
            ...
            { no: 5, name: "source_user_id", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/, options: { "buf.validate.field": { int32: { gt: 0 } } } },
            { no: 6, name: "source_user", kind: "message", T: () => Colleague, options: { "tagger.tags": "alias:\"source_user\"" } },
            { no: 7, name: "target_user_id", kind: "scalar", T: 5 /*ScalarType.INT32*/, options: { "buf.validate.field": { int32: { gt: 0 } } } },
