...
export interface Qualification {
    ...
    /**
     * @generated from protobuf field: repeated resources.jobs.QualificationRequirement requirements = 16;
     */
    ...
    /**
     * @generated from protobuf field: optional resources.jobs.QualificationResult result = 18;
     */
    result?: QualificationResult;
}
/**
 * @generated from protobuf message resources.jobs.QualificationShort
 */
...
/**
 * @generated from protobuf message resources.jobs.QualificationRequirement
 */
export interface QualificationRequirement {
    ...
    /**
     * @generated from protobuf field: optional resources.jobs.QualificationShort target_qualification = 5;
     */
...
class Qualification$Type extends MessageType<Qualification> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* resources.jobs.QualificationAccess access */ 15:
                    ...
                    break;
                case /* repeated resources.jobs.QualificationRequirement requirements */ 16:
                ...
                case /* optional resources.jobs.QualificationDiscordSettings discord_settings */ 17:
                    ...
                    break;
                case /* optional resources.jobs.QualificationResult result */ 18:
    ...
    internalBinaryWrite(message: Qualification, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated resources.jobs.QualificationRequirement requirements = 16; */
        ...
        /* optional resources.jobs.QualificationResult result = 18; */
        if (message.result)
...
class QualificationShort$Type extends MessageType<QualificationShort> {
    constructor() {
        super("resources.jobs.QualificationShort", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 2, name: "created_at", kind: "message", T: () => Timestamp },
            { no: 3, name: "updated_at", kind: "message", T: () => Timestamp },
            { no: 4, name: "deleted_at", kind: "message", T: () => Timestamp },
...
/**
 * @generated MessageType for protobuf message resources.jobs.QualificationShort
 */
...
class QualificationRequirement$Type extends MessageType<QualificationRequirement> {
    constructor() {
        super("resources.jobs.QualificationRequirement", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 2, name: "created_at", kind: "message", T: () => Timestamp },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 target_qualification_id = 4 [jstype = JS_STRING];*/ 4:
                    ...
                    break;
                case /* optional resources.jobs.QualificationShort target_qualification */ 5:
    ...
    internalBinaryWrite(message: QualificationRequirement, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional resources.jobs.QualificationShort target_qualification = 5; */
...
/**
 * @generated MessageType for protobuf message resources.jobs.QualificationRequirement
 */
...
class QualificationResult$Type extends MessageType<QualificationResult> {
    constructor() {
        super("resources.jobs.QualificationResult", [
            ...
            { no: 7, name: "status", kind: "enum", T: () => ["resources.jobs.ResultStatus", ResultStatus, "RESULT_STATUS_"] },
