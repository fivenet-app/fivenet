...
class UploadPacket$Type extends MessageType<UploadPacket> {
    constructor() {
        super("resources.file.UploadPacket", [
            ...
            { no: 2, name: "data", kind: "scalar", oneof: "payload", T: 12 /*ScalarType.BYTES*/, options: { "validate.rules": { bytes: { maxLen: "131072" } } } }
        ]);
    }
...
class UploadMeta$Type extends MessageType<UploadMeta> {
    constructor() {
        super("resources.file.UploadMeta", [
            ...
            { no: 3, name: "original_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { maxLen: "255" } } } },
            { no: 4, name: "content_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "size", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/, options: { "validate.rules": { int64: { gt: "0" } } } },
            { no: 6, name: "reason", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "3", maxLen: "255", ignoreEmpty: true } } } }
        ]);
    }
...
class DeleteFileRequest$Type extends MessageType<DeleteFileRequest> {
    constructor() {
        super("resources.file.DeleteFileRequest", [
            { no: 1, name: "parent_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/, options: { "validate.rules": { uint64: { gt: "0" } } } },
            { no: 2, name: "file_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/, options: { "validate.rules": { uint64: { gt: "0" } } } }
        ]);
    }
