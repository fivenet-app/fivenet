...
export interface CentrumAccess {
     ...
     */
    jobs: CentrumJobAccess[]; // @gotags: alias:"job_access"
}
/**
...
class CentrumAccess$Type extends MessageType<CentrumAccess> {
    constructor() {
        super("resources.centrum.CentrumAccess", [
            { no: 1, name: "jobs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CentrumJobAccess, options: { "validate.rules": { repeated: { maxItems: "10" } } } }
        ]);
    }
