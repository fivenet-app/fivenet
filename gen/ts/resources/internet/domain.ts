...
export interface Domain {
    ...
    deletedAt?: Timestamp;
    /**
     * @generated from protobuf field: int64 tld_id = 5
     */
    tldId: number;
    /**
...
class TLD$Type extends MessageType<TLD> {
    constructor() {
        super("resources.internet.TLD", [
            ...
            { no: 5, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { string: { minLen: "2", maxLen: "24" } } } },
...
class Domain$Type extends MessageType<Domain> {
    constructor() {
        super("resources.internet.Domain", [
            ...
            { no: 3, name: "updated_at", kind: "message", T: () => Timestamp },
            { no: 4, name: "deleted_at", kind: "message", T: () => Timestamp },
            { no: 5, name: "tld_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 6, name: "tld", kind: "message", T: () => TLD },
            { no: 7, name: "active", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 8, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { string: { maxLen: "128" } } } },
            { no: 9, name: "transfer_code", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { string: { len: "10", pattern: "^[0-9A-Z]{6}$" } } } },
    ...
    internalBinaryWrite(message: Domain, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int64 tld_id = 5; */
        if (message.tldId !== 0)
            writer.tag(5, WireType.Varint).int64(message.tldId);
