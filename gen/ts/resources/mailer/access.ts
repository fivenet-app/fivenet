...
class Access$Type extends MessageType<Access> {
    constructor() {
        super("resources.mailer.Access", [
            { no: 1, name: "jobs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => JobAccess, options: { "validate.rules": { repeated: { maxItems: "20" } } } },
            { no: 2, name: "users", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UserAccess, options: { "validate.rules": { repeated: { maxItems: "20" } } } },
            { no: 3, name: "qualifications", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QualificationAccess, options: { "validate.rules": { repeated: { maxItems: "20" } } } }
        ]);
    }
