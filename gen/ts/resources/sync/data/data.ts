...
class DataUser$Type extends MessageType<DataUser> {
    constructor() {
        super("resources.sync.data.DataUser", [
            ...
            { no: 20, name: "jobs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UserJob, options: { "buf.validate.field": { ignore: "IGNORE_IF_ZERO_VALUE", repeated: { maxItems: "7" } }, "tagger.tags": "alias:\"user.jobs\"" } },
            { no: 7, name: "firstname", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { string: { maxLen: "50" } }, "tagger.tags": "alias:\"user.firstname\"" } },
            { no: 8, name: "lastname", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { string: { maxLen: "50" } }, "tagger.tags": "alias:\"user.lastname\"" } },
