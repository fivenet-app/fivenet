...
class ObjectEvent$Type extends MessageType<ObjectEvent> {
    constructor() {
        super("resources.notifications.ObjectEvent", [
            { no: 1, name: "type", kind: "enum", T: () => ["resources.notifications.ObjectType", ObjectType, "OBJECT_TYPE_"], options: { "validate.rules": { enum: { definedOnly: true } } } },
            { no: 2, name: "id", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "event_type", kind: "enum", T: () => ["resources.notifications.ObjectEventType", ObjectEventType, "OBJECT_EVENT_TYPE_"], options: { "validate.rules": { enum: { definedOnly: true } } } },
