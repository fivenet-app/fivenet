...
export interface ApprovalPolicy {
    ...
    /**
     * @generated from protobuf field: resources.documents.OnEditBehavior on_edit_behavior = 5
     */
    onEditBehavior: OnEditBehavior;
    /**
     * @generated from protobuf field: resources.documents.ApprovalRuleKind rule_kind = 6
     */
...
export interface ApprovalTask {
    ...
    slotNo: number;
    /**
     * @generated from protobuf field: resources.documents.ApprovalTaskStatus status = 15
     */
    ...
    creatorId: number;
    /**
     * @generated from protobuf field: optional resources.users.UserShort creator = 23
     */
    creator?: UserShort;
    /**
...
export interface Approval {
    ...
    stampId?: number;
    /**
     * @generated from protobuf field: optional resources.documents.Stamp stamp = 14
     */
    stamp?: Stamp;
    /**
     * @generated from protobuf field: resources.documents.ApprovalStatus status = 15
     */
...
class ApprovalPolicy$Type extends MessageType<ApprovalPolicy> {
    constructor() {
        super("resources.documents.ApprovalPolicy", [
            ...
            { no: 5, name: "on_edit_behavior", kind: "enum", T: () => ["resources.documents.OnEditBehavior", OnEditBehavior, "ON_EDIT_BEHAVIOR_"], options: { "buf.validate.field": { enum: { definedOnly: true } } } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* resources.timestamp.Timestamp snapshot_date */ 4:
                    ...
                    break;
                case /* resources.documents.OnEditBehavior on_edit_behavior */ 5:
                    message.onEditBehavior = reader.int32();
                    break;
                case /* resources.documents.ApprovalRuleKind rule_kind */ 6:
    ...
    internalBinaryWrite(message: ApprovalPolicy, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* resources.documents.OnEditBehavior on_edit_behavior = 5; */
        if (message.onEditBehavior !== 0)
            writer.tag(5, WireType.Varint).int32(message.onEditBehavior);
        /* resources.documents.ApprovalRuleKind rule_kind = 6; */
...
class ApprovalTask$Type extends MessageType<ApprovalTask> {
    constructor() {
        super("resources.documents.ApprovalTask", [
            ...
            { no: 15, name: "status", kind: "enum", T: () => ["resources.documents.ApprovalTaskStatus", ApprovalTaskStatus, "APPROVAL_TASK_STATUS_"], options: { "buf.validate.field": { enum: { definedOnly: true } } } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 slot_no */ 14:
                    ...
                    break;
                case /* resources.documents.ApprovalTaskStatus status */ 15:
                ...
                case /* int32 creator_id */ 22:
                    ...
                    break;
                case /* optional resources.users.UserShort creator */ 23:
    ...
    internalBinaryWrite(message: ApprovalTask, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* resources.documents.ApprovalTaskStatus status = 15; */
        if (message.status !== 0)
        ...
        /* optional resources.users.UserShort creator = 23; */
        if (message.creator)
...
class Approval$Type extends MessageType<Approval> {
    constructor() {
        super("resources.documents.Approval", [
            ...
            { no: 15, name: "status", kind: "enum", T: () => ["resources.documents.ApprovalStatus", ApprovalStatus, "APPROVAL_STATUS_"], options: { "buf.validate.field": { enum: { definedOnly: true } } } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional int64 stamp_id */ 13:
                    ...
                    break;
                case /* optional resources.documents.Stamp stamp */ 14:
                    message.stamp = Stamp.internalBinaryRead(reader, reader.uint32(), options, message.stamp);
                    break;
                case /* resources.documents.ApprovalStatus status */ 15:
                    message.status = reader.int32();
                    break;
                case /* optional string comment */ 16:
                    message.comment = reader.string();
