...
// @generated from protobuf file "resources/messenger/access.proto" (package "resources.messenger", syntax proto3)
// @ts-nocheck
...
/**
 * @generated from protobuf message resources.messenger.ThreadAccess
 */
export interface ThreadAccess {
    /**
     * @generated from protobuf field: repeated resources.messenger.ThreadJobAccess jobs = 1;
     */
    jobs: ThreadJobAccess[]; // @gotags: alias:"job_access"
    /**
     * @generated from protobuf field: repeated resources.messenger.ThreadUserAccess users = 2;
     */
    users: ThreadUserAccess[]; // @gotags: alias:"user_access"
}
/**
 * @generated from protobuf message resources.messenger.ThreadJobAccess
 */
export interface ThreadJobAccess {
    ...
    /**
     * @generated from protobuf field: resources.messenger.AccessLevel access = 8;
     */
    access: AccessLevel;
}
/**
 * @generated from protobuf message resources.messenger.ThreadUserAccess
 */
export interface ThreadUserAccess {
    ...
    user?: UserShort;
    /**
     * @generated from protobuf field: resources.messenger.AccessLevel access = 6;
     */
    access: AccessLevel;
}
/**
 * @generated from protobuf enum resources.messenger.AccessLevelUpdateMode
 */
...
/**
 * @generated from protobuf enum resources.messenger.AccessLevel
 */
export enum AccessLevel {
    ...
    VIEW = 2,
    /**
     * @generated from protobuf enum value: ACCESS_LEVEL_MESSAGE = 3;
     */
    MESSAGE = 3,
    /**
    ...
    MANAGE = 4,
    /**
     * @generated from protobuf enum value: ACCESS_LEVEL_ADMIN = 5;
     */
    ADMIN = 5
}
...
class ThreadAccess$Type extends MessageType<ThreadAccess> {
    constructor() {
        super("resources.messenger.ThreadAccess", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ThreadAccess): ThreadAccess {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated resources.messenger.ThreadJobAccess jobs */ 1:
                    message.jobs.push(ThreadJobAccess.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated resources.messenger.ThreadUserAccess users */ 2:
...
/**
 * @generated MessageType for protobuf message resources.messenger.ThreadAccess
 */
export const ThreadAccess = new ThreadAccess$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ThreadJobAccess$Type extends MessageType<ThreadJobAccess> {
    constructor() {
        super("resources.messenger.ThreadJobAccess", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 2, name: "created_at", kind: "message", T: () => Timestamp },
            { no: 3, name: "thread_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            ...
            { no: 8, name: "access", kind: "enum", T: () => ["resources.messenger.AccessLevel", AccessLevel, "ACCESS_LEVEL_"], options: { "validate.rules": { enum: { definedOnly: true } } } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional string job_grade_label */ 7:
                    ...
                    break;
                case /* resources.messenger.AccessLevel access */ 8:
    ...
    internalBinaryWrite(message: ThreadJobAccess, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* resources.messenger.AccessLevel access = 8; */
        if (message.access !== 0)
...
/**
 * @generated MessageType for protobuf message resources.messenger.ThreadJobAccess
 */
export const ThreadJobAccess = new ThreadJobAccess$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ThreadUserAccess$Type extends MessageType<ThreadUserAccess> {
    constructor() {
        super("resources.messenger.ThreadUserAccess", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 2, name: "created_at", kind: "message", T: () => Timestamp },
            { no: 3, name: "thread_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            ...
            { no: 6, name: "access", kind: "enum", T: () => ["resources.messenger.AccessLevel", AccessLevel, "ACCESS_LEVEL_"], options: { "validate.rules": { enum: { definedOnly: true } } } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional resources.users.UserShort user */ 5:
                    ...
                    break;
                case /* resources.messenger.AccessLevel access */ 6:
                    message.access = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: ThreadUserAccess, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* resources.messenger.AccessLevel access = 6; */
        if (message.access !== 0)
...
/**
 * @generated MessageType for protobuf message resources.messenger.ThreadUserAccess
 */
