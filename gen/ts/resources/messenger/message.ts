...
// @generated from protobuf file "resources/messenger/message.proto" (package "resources.messenger", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message resources.messenger.Message
 */
export interface Message {
    ...
    message: string;
    /**
     * @generated from protobuf field: optional resources.messenger.MessageData data = 7;
     */
    data?: MessageData;
    /**
...
class Message$Type extends MessageType<Message> {
    constructor() {
        super("resources.messenger.Message", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string message */ 6:
                    ...
                    break;
                case /* optional resources.messenger.MessageData data */ 7:
    ...
    internalBinaryWrite(message: Message, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional resources.messenger.MessageData data = 7; */
        if (message.data)
...
/**
 * @generated MessageType for protobuf message resources.messenger.Message
 */
export const Message = new Message$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageData$Type extends MessageType<MessageData> {
    constructor() {
        super("resources.messenger.MessageData", []);
    }
...
/**
 * @generated MessageType for protobuf message resources.messenger.MessageData
 */
