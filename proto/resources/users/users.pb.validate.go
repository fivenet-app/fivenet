...
// Validate checks the field values on UserShortNI with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *UserShortNI) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UserShortNI with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UserShortNIMultiError, or
// nil if none found.
func (m *UserShortNI) ValidateAll() error {
	return m.validate(true)
}

func (m *UserShortNI) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetUserId() <= 0 {
		err := UserShortNIValidationError{
			field:  "UserId",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return UserShortNIMultiError(errors)
	}

	return nil
}

// UserShortNIMultiError is an error wrapping multiple validation errors
// returned by UserShortNI.ValidateAll() if the designated constraints aren't met.
type UserShortNIMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserShortNIMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserShortNIMultiError) AllErrors() []error { return m }

// UserShortNIValidationError is the validation error returned by
// UserShortNI.Validate if the designated constraints aren't met.
type UserShortNIValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserShortNIValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserShortNIValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserShortNIValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserShortNIValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserShortNIValidationError) ErrorName() string { return "UserShortNIValidationError" }

// Error satisfies the builtin error interface
func (e UserShortNIValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UserShortNIValidationError{}
