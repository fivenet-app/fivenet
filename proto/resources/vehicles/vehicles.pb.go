...
type Vehicles struct {
	...
	Mode  string           `protobuf:"bytes,2,opt,name=mode,proto3" json:"mode,omitempty" alias:"mode"`   // @gotags: alias:"mode"
...
func (x *Vehicles) GetPlate() string {
	if x != nil {
		return x.Plate
	}
	return ""
...
func (x *Vehicles) GetMode() string {
	if x != nil {
		return x.Mode
	}
	return ""
...
func (x *Vehicles) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *Vehicles) GetOwner() *users.UserShort {
	if x != nil {
		return x.Owner
	}
	return nil
...
var file_resources_vehicles_vehicles_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7a, 0x0a, 0x08, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x73,
	0x12, 0x14, 0x0a, 0x05, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x02,
	...
	0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72,
...
var file_resources_vehicles_vehicles_proto_goTypes = []interface{}{
	(*Vehicles)(nil),        // 0: resources.vehicles.Vehicles
	(*users.UserShort)(nil), // 1: resources.users.UserShort
}
var file_resources_vehicles_vehicles_proto_depIdxs = []int32{
	1, // 0: resources.vehicles.Vehicles.owner:type_name -> resources.users.UserShort
