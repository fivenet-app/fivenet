...
var file_documents_documents_proto_rawDesc = []byte{
	...
	0x09, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x22, 0x17, 0x0a, 0x15, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x18, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x6f, 0x63,
	0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa3, 0x02,
...
var file_documents_documents_proto_goTypes = []interface{}{
	...
	(*common.OrderBy)(nil),         // 7: gen.common.OrderBy
	(*timestamppb.Timestamp)(nil),  // 8: google.protobuf.Timestamp
	(*common.ShortUser)(nil),       // 9: gen.common.ShortUser
}
var file_documents_documents_proto_depIdxs = []int32{
	7,  // 0: gen.documents.FindDocumentsRequest.orderBy:type_name -> gen.common.OrderBy
	2,  // 1: gen.documents.FindDocumentsResponse.documents:type_name -> gen.documents.Document
	8,  // 2: gen.documents.Document.created_at:type_name -> google.protobuf.Timestamp
	8,  // 3: gen.documents.Document.updated_at:type_name -> google.protobuf.Timestamp
	9,  // 4: gen.documents.Document.creator:type_name -> gen.common.ShortUser
	...
	5,  // 9: gen.documents.DocumentsService.CreateDocument:input_type -> gen.documents.CreateDocumentRequest
	1,  // 10: gen.documents.DocumentsService.FindDocuments:output_type -> gen.documents.FindDocumentsResponse
	4,  // 11: gen.documents.DocumentsService.GetDocument:output_type -> gen.documents.GetDocumentResponse
	6,  // 12: gen.documents.DocumentsService.CreateDocument:output_type -> gen.documents.CreateDocumentResponse
