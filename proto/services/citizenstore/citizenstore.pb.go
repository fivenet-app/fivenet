...
import (
	...
	_ "github.com/galexrt/arpanet/proto/resources/documents"
...
var file_services_citizenstore_citizenstore_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf3, 0x01, 0x0a, 0x10, 0x46, 0x69, 0x6e, 0x64, 0x55,
	0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x56, 0x0a, 0x0a, 0x70,
	...
	0x10, 0x03, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x79, 0x12, 0x27, 0x0a, 0x0a, 0x73,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x18, 0x32, 0x52, 0x0a, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x77, 0x61, 0x6e, 0x74, 0x65, 0x64, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x77, 0x61, 0x6e, 0x74, 0x65, 0x64, 0x22, 0x8f, 0x01, 0x0a,
...
var file_services_citizenstore_citizenstore_proto_goTypes = []interface{}{
	...
	(*database.OrderBy)(nil),            // 9: resources.common.database.OrderBy
	...
	(*users.UserProps)(nil),             // 13: resources.users.UserProps
}
var file_services_citizenstore_citizenstore_proto_depIdxs = []int32{
	...
	9,  // 1: services.citizenstore.FindUsersRequest.orderBy:type_name -> resources.common.database.OrderBy
	10, // 2: services.citizenstore.FindUsersResponse.pagination:type_name -> resources.common.database.PaginationResponse
	11, // 3: services.citizenstore.FindUsersResponse.users:type_name -> resources.users.User
	11, // 4: services.citizenstore.GetUserResponse.user:type_name -> resources.users.User
	12, // 5: services.citizenstore.GetUserActivityResponse.activity:type_name -> resources.users.UserActivity
	13, // 6: services.citizenstore.SetUserPropsRequest.props:type_name -> resources.users.UserProps
	0,  // 7: services.citizenstore.CitizenStoreService.FindUsers:input_type -> services.citizenstore.FindUsersRequest
	2,  // 8: services.citizenstore.CitizenStoreService.GetUser:input_type -> services.citizenstore.GetUserRequest
	4,  // 9: services.citizenstore.CitizenStoreService.GetUserActivity:input_type -> services.citizenstore.GetUserActivityRequest
	6,  // 10: services.citizenstore.CitizenStoreService.SetUserProps:input_type -> services.citizenstore.SetUserPropsRequest
	...
	7,  // 14: services.citizenstore.CitizenStoreService.SetUserProps:output_type -> services.citizenstore.SetUserPropsResponse
