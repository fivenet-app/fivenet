...
var file_services_auth_auth_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5a, 0x0a, 0x0c, 0x4c, 0x6f,
	...
	0x61, 0x64, 0x65, 0x22, 0x5d, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x35, 0x0a, 0x09, 0x6a,
	0x6f, 0x62, 0x5f, 0x70, 0x72, 0x6f, 0x70, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
	0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x6a, 0x6f, 0x62, 0x73, 0x2e,
	0x4a, 0x6f, 0x62, 0x50, 0x72, 0x6f, 0x70, 0x73, 0x52, 0x08, 0x6a, 0x6f, 0x62, 0x50, 0x72, 0x6f,
	0x70, 0x73, 0x32, 0x9d, 0x03, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x06, 0x53,
...
var file_services_auth_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_services_auth_auth_proto_goTypes = []interface{}{
	...
	(*SetJobRequest)(nil),           // 8: services.auth.SetJobRequest
	(*SetJobResponse)(nil),          // 9: services.auth.SetJobResponse
	(*users.User)(nil),              // 10: resources.users.User
	(*jobs.JobProps)(nil),           // 11: resources.jobs.JobProps
}
var file_services_auth_auth_proto_depIdxs = []int32{
	10, // 0: services.auth.GetCharactersResponse.chars:type_name -> resources.users.User
	11, // 1: services.auth.ChooseCharacterResponse.job_props:type_name -> resources.jobs.JobProps
	11, // 2: services.auth.SetJobResponse.job_props:type_name -> resources.jobs.JobProps
	0,  // 3: services.auth.AuthService.Login:input_type -> services.auth.LoginRequest
	2,  // 4: services.auth.AuthService.GetCharacters:input_type -> services.auth.GetCharactersRequest
	4,  // 5: services.auth.AuthService.ChooseCharacter:input_type -> services.auth.ChooseCharacterRequest
	6,  // 6: services.auth.AuthService.Logout:input_type -> services.auth.LogoutRequest
	8,  // 7: services.auth.AuthService.SetJob:input_type -> services.auth.SetJobRequest
	1,  // 8: services.auth.AuthService.Login:output_type -> services.auth.LoginResponse
	3,  // 9: services.auth.AuthService.GetCharacters:output_type -> services.auth.GetCharactersResponse
	5,  // 10: services.auth.AuthService.ChooseCharacter:output_type -> services.auth.ChooseCharacterResponse
	7,  // 11: services.auth.AuthService.Logout:output_type -> services.auth.LogoutResponse
	9,  // 12: services.auth.AuthService.SetJob:output_type -> services.auth.SetJobResponse
