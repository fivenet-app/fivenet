...
func (x *ChooseCharacterRequest) GetUserID() int32 {
	if x != nil {
		return x.UserID
	}
	return 0
...
var file_services_auth_auth_proto_rawDesc = []byte{
	...
	0x22, 0x39, 0x0a, 0x16, 0x43, 0x68, 0x6f, 0x6f, 0x73, 0x65, 0x43, 0x68, 0x61, 0x72, 0x61, 0x63,
	0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x06, 0x75, 0x73,
	0x65, 0x72, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x1a,
	0x02, 0x20, 0x00, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x51, 0x0a, 0x17, 0x43,
	...
	0x09, 0x52, 0x0b, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x0f,
	...
	0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xd9, 0x02, 0x0a, 0x0e,
...
var file_services_auth_auth_proto_depIdxs = []int32{
	...
	0, // 1: services.auth.AccountService.Login:input_type -> services.auth.LoginRequest
	2, // 2: services.auth.AccountService.GetCharacters:input_type -> services.auth.GetCharactersRequest
	4, // 3: services.auth.AccountService.ChooseCharacter:input_type -> services.auth.ChooseCharacterRequest
	6, // 4: services.auth.AccountService.Logout:input_type -> services.auth.LogoutRequest
	1, // 5: services.auth.AccountService.Login:output_type -> services.auth.LoginResponse
	3, // 6: services.auth.AccountService.GetCharacters:output_type -> services.auth.GetCharactersResponse
	5, // 7: services.auth.AccountService.ChooseCharacter:output_type -> services.auth.ChooseCharacterResponse
	7, // 8: services.auth.AccountService.Logout:output_type -> services.auth.LogoutResponse
