...
func (c *dMVServiceClient) FindVehicles(ctx context.Context, in *FindVehiclesRequest, opts ...grpc.CallOption) (*FindVehiclesResponse, error) {
	out := new(FindVehiclesResponse)
	err := c.cc.Invoke(ctx, "/services.dmv.DMVService/FindVehicles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDMVServiceServer) FindVehicles(context.Context, *FindVehiclesRequest) (*FindVehiclesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindVehicles not implemented")
}
...
func _DMVService_FindVehicles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindVehiclesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DMVServiceServer).FindVehicles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.dmv.DMVService/FindVehicles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DMVServiceServer).FindVehicles(ctx, req.(*FindVehiclesRequest))
	}
...
var DMVService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindVehicles",
			Handler:    _DMVService_FindVehicles_Handler,
		},
	},
