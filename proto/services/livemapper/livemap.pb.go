...
type ServerStreamResponse struct {
	...
	Users      []*livemap.Marker `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
	Dispatches []*livemap.Marker `protobuf:"bytes,2,rep,name=dispatches,proto3" json:"dispatches,omitempty"`
}
...
func (x *ServerStreamResponse) GetUsers() []*livemap.Marker {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *ServerStreamResponse) GetDispatches() []*livemap.Marker {
	if x != nil {
		return x.Dispatches
	}
	return nil
...
var file_services_livemapper_livemap_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x82, 0x01, 0x0a, 0x14, 0x53,
	...
	0x69, 0x76, 0x65, 0x6d, 0x61, 0x70, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x72, 0x52, 0x05, 0x75,
	0x73, 0x65, 0x72, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68,
	...
	,
...
var file_services_livemapper_livemap_proto_goTypes = []interface{}{
	...
	(*livemap.Marker)(nil),       // 2: resources.livemap.Marker
}
var file_services_livemapper_livemap_proto_depIdxs = []int32{
	2, // 0: services.livemapper.ServerStreamResponse.users:type_name -> resources.livemap.Marker
	2, // 1: services.livemapper.ServerStreamResponse.dispatches:type_name -> resources.livemap.Marker
