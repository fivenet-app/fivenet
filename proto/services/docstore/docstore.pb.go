...
var file_services_docstore_docstore_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x1e, 0x0a,
	0x1c, 0x41, 0x64, 0x64, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x30, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x1d, 0x0a, 0x1b, 0x41, 0x64, 0x64, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65,
	0x6e, 0x74, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x2f, 0x0a, 0x1d, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x44, 0x63, 0x6f, 0x75,
	...
	0x73, 0x65, 0x22, 0x5c, 0x0a, 0x1a, 0x45, 0x64, 0x69, 0x74, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65,
	...
	0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x3b, 0x0a, 0x16, 0x44,
	...
	0x05, 0x43, 0x4c, 0x45, 0x41, 0x52, 0x10, 0x02, 0x32, 0x8b, 0x0f, 0x0a, 0x0f, 0x44, 0x6f, 0x63,
	...
	0x17, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x44, 0x63, 0x6f, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52,
	...
	0x63, 0x6f, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x61, 0x6e, 0x65, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69,
...
var file_services_docstore_docstore_proto_goTypes = []interface{}{
	...
	(*database.OrderBy)(nil),                // 38: resources.common.database.OrderBy
	(*database.PaginationResponse)(nil),     // 39: resources.common.database.PaginationResponse
	(*documents.Document)(nil),              // 40: resources.documents.Document
	(*documents.DocumentAccess)(nil),        // 41: resources.documents.DocumentAccess
	(*documents.DocumentReference)(nil),     // 42: resources.documents.DocumentReference
	(*documents.DocumentRelation)(nil),      // 43: resources.documents.DocumentRelation
	(*documents.DocumentComment)(nil),       // 44: resources.documents.DocumentComment
	(documents.DOC_CONTENT_TYPE)(0),         // 45: resources.documents.DOC_CONTENT_TYPE
}
var file_services_docstore_docstore_proto_depIdxs = []int32{
	...
	37, // 2: services.docstore.FindDocumentsRequest.pagination:type_name -> resources.common.database.PaginationRequest
	38, // 3: services.docstore.FindDocumentsRequest.orderBy:type_name -> resources.common.database.OrderBy
	39, // 4: services.docstore.FindDocumentsResponse.pagination:type_name -> resources.common.database.PaginationResponse
	40, // 5: services.docstore.FindDocumentsResponse.documents:type_name -> resources.documents.Document
	40, // 6: services.docstore.GetDocumentResponse.document:type_name -> resources.documents.Document
	41, // 7: services.docstore.GetDocumentResponse.access:type_name -> resources.documents.DocumentAccess
	42, // 8: services.docstore.GetDocumentReferencesResponse.references:type_name -> resources.documents.DocumentReference
	43, // 9: services.docstore.GetDocumentRelationsResponse.relations:type_name -> resources.documents.DocumentRelation
	42, // 10: services.docstore.AddDocumentReferenceRequest.reference:type_name -> resources.documents.DocumentReference
	43, // 11: services.docstore.AddDocumentRelationRequest.relation:type_name -> resources.documents.DocumentRelation
	39, // 12: services.docstore.GetDocumentCommentsRequest.pagination:type_name -> resources.common.database.PaginationResponse
	39, // 13: services.docstore.GetDocumentCommentsResponse.pagination:type_name -> resources.common.database.PaginationResponse
	44, // 14: services.docstore.GetDocumentCommentsResponse.comments:type_name -> resources.documents.DocumentComment
	44, // 15: services.docstore.PostDocumentCommentRequest.comment:type_name -> resources.documents.DocumentComment
	44, // 16: services.docstore.EditDocumentCommentRequest.comment:type_name -> resources.documents.DocumentComment
	45, // 17: services.docstore.CreateDocumentRequest.content_type:type_name -> resources.documents.DOC_CONTENT_TYPE
	41, // 18: services.docstore.CreateDocumentRequest.access:type_name -> resources.documents.DocumentAccess
	45, // 19: services.docstore.UpdateDocumentRequest.content_type:type_name -> resources.documents.DOC_CONTENT_TYPE
	41, // 20: services.docstore.UpdateDocumentRequest.access:type_name -> resources.documents.DocumentAccess
	41, // 21: services.docstore.GetDocumentAccessResponse.access:type_name -> resources.documents.DocumentAccess
	0,  // 22: services.docstore.SetDocumentAccessRequest.mode:type_name -> services.docstore.DOC_ACCESS_UPDATE_MODE
	41, // 23: services.docstore.SetDocumentAccessRequest.access:type_name -> resources.documents.DocumentAccess
	1,  // 24: services.docstore.DocStoreService.ListTemplates:input_type -> services.docstore.ListTemplatesRequest
	3,  // 25: services.docstore.DocStoreService.GetTemplate:input_type -> services.docstore.GetTemplateRequest
	5,  // 26: services.docstore.DocStoreService.FindDocuments:input_type -> services.docstore.FindDocumentsRequest
	7,  // 27: services.docstore.DocStoreService.GetDocument:input_type -> services.docstore.GetDocumentRequest
	27, // 28: services.docstore.DocStoreService.CreateDocument:input_type -> services.docstore.CreateDocumentRequest
	29, // 29: services.docstore.DocStoreService.UpdateDocument:input_type -> services.docstore.UpdateDocumentRequest
	9,  // 30: services.docstore.DocStoreService.GetDocumentReferences:input_type -> services.docstore.GetDocumentReferencesRequest
	11, // 31: services.docstore.DocStoreService.GetDocumentRelations:input_type -> services.docstore.GetDocumentRelationsRequest
	13, // 32: services.docstore.DocStoreService.AddDocumentReference:input_type -> services.docstore.AddDocumentReferenceRequest
	15, // 33: services.docstore.DocStoreService.RemoveDcoumentReference:input_type -> services.docstore.RemoveDcoumentReferenceRequest
	17, // 34: services.docstore.DocStoreService.AddDocumentRelation:input_type -> services.docstore.AddDocumentRelationRequest
	19, // 35: services.docstore.DocStoreService.RemoveDcoumentRelation:input_type -> services.docstore.RemoveDcoumentRelationRequest
	21, // 36: services.docstore.DocStoreService.GetDocumentComments:input_type -> services.docstore.GetDocumentCommentsRequest
	23, // 37: services.docstore.DocStoreService.PostDocumentComment:input_type -> services.docstore.PostDocumentCommentRequest
	25, // 38: services.docstore.DocStoreService.EditDocumentComment:input_type -> services.docstore.EditDocumentCommentRequest
	31, // 39: services.docstore.DocStoreService.GetDocumentAccess:input_type -> services.docstore.GetDocumentAccessRequest
	33, // 40: services.docstore.DocStoreService.SetDocumentAccess:input_type -> services.docstore.SetDocumentAccessRequest
	2,  // 41: services.docstore.DocStoreService.ListTemplates:output_type -> services.docstore.ListTemplatesResponse
	4,  // 42: services.docstore.DocStoreService.GetTemplate:output_type -> services.docstore.GetTemplateResponse
	6,  // 43: services.docstore.DocStoreService.FindDocuments:output_type -> services.docstore.FindDocumentsResponse
	8,  // 44: services.docstore.DocStoreService.GetDocument:output_type -> services.docstore.GetDocumentResponse
	28, // 45: services.docstore.DocStoreService.CreateDocument:output_type -> services.docstore.CreateDocumentResponse
	30, // 46: services.docstore.DocStoreService.UpdateDocument:output_type -> services.docstore.UpdateDocumentResponse
	10, // 47: services.docstore.DocStoreService.GetDocumentReferences:output_type -> services.docstore.GetDocumentReferencesResponse
	12, // 48: services.docstore.DocStoreService.GetDocumentRelations:output_type -> services.docstore.GetDocumentRelationsResponse
	14, // 49: services.docstore.DocStoreService.AddDocumentReference:output_type -> services.docstore.AddDocumentReferenceResponse
	16, // 50: services.docstore.DocStoreService.RemoveDcoumentReference:output_type -> services.docstore.RemoveDcoumentReferenceResponse
	18, // 51: services.docstore.DocStoreService.AddDocumentRelation:output_type -> services.docstore.AddDocumentRelationResponse
	20, // 52: services.docstore.DocStoreService.RemoveDcoumentRelation:output_type -> services.docstore.RemoveDcoumentRelationResponse
	22, // 53: services.docstore.DocStoreService.GetDocumentComments:output_type -> services.docstore.GetDocumentCommentsResponse
	24, // 54: services.docstore.DocStoreService.PostDocumentComment:output_type -> services.docstore.PostDocumentCommentResponse
	26, // 55: services.docstore.DocStoreService.EditDocumentComment:output_type -> services.docstore.EditDocumentCommentResponse
	32, // 56: services.docstore.DocStoreService.GetDocumentAccess:output_type -> services.docstore.GetDocumentAccessResponse
	34, // 57: services.docstore.DocStoreService.SetDocumentAccess:output_type -> services.docstore.SetDocumentAccessResponse
