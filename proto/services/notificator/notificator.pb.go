...
var file_services_notificator_notificator_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x43, 0x5a, 0x41, 0x67, 0x69, 0x74,
...
var file_services_notificator_notificator_proto_depIdxs = []int32{
	...
	2, // 2: services.notificator.NotificatorService.GetNotifications:input_type -> services.notificator.GetNotificationsRequest
	4, // 3: services.notificator.NotificatorService.ReadNotifications:input_type -> services.notificator.ReadNotificationsRequest
	0, // 4: services.notificator.NotificatorService.Stream:input_type -> services.notificator.StreamRequest
	3, // 5: services.notificator.NotificatorService.GetNotifications:output_type -> services.notificator.GetNotificationsResponse
	5, // 6: services.notificator.NotificatorService.ReadNotifications:output_type -> services.notificator.ReadNotificationsResponse
	1, // 7: services.notificator.NotificatorService.Stream:output_type -> services.notificator.StreamResponse
