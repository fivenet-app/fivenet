...
func (c *usersServiceClient) GetUserActivity(ctx context.Context, in *GetUserActivityRequest, opts ...grpc.CallOption) (*GetUserActivityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/users.UsersService/GetUserActivity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersServiceClient) SetUserProps(ctx context.Context, in *SetUserPropsRequest, opts ...grpc.CallOption) (*SetUserPropsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/users.UsersService/SetUserProps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UsersService_GetUserActivity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.UsersService/GetUserActivity",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UsersService_SetUserProps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.UsersService/SetUserProps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
