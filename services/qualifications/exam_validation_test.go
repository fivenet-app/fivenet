...
func TestNormalizeExamResponsesRejectsDuplicateQuestionIDs(t *testing.T) {
	...
	responses := &qualificationsexam.ExamResponses{Responses: []*qualificationsexam.ExamResponse{
		{QuestionId: 1, Response: &qualificationsexam.ExamResponseData{Response: &qualificationsexam.ExamResponseData_Yesno{Yesno: &qualificationsexam.ExamResponseYesNo{}}}},
		{QuestionId: 1, Response: &qualificationsexam.ExamResponseData{Response: &qualificationsexam.ExamResponseData_Yesno{Yesno: &qualificationsexam.ExamResponseYesNo{}}}},
	}}
...
func TestNormalizeExamResponsesCanonicalizesQuestionSnapshot(t *testing.T) {
	...
	question := &qualificationsexam.ExamQuestion{
		...
		Data:  &qualificationsexam.ExamQuestionData{Data: &qualificationsexam.ExamQuestionData_Yesno{Yesno: &qualificationsexam.ExamQuestionYesNo{}}},
	}
	response := &qualificationsexam.ExamResponse{
		QuestionId: 1,
		Question:   &qualificationsexam.ExamQuestion{Id: 1, Title: "Client supplied question"},
		Response:   &qualificationsexam.ExamResponseData{Response: &qualificationsexam.ExamResponseData_Yesno{Yesno: &qualificationsexam.ExamResponseYesNo{}}},
	}
	...
	assert.Same(t, question, normalized.GetResponses()[0].GetQuestion())
}
	...
	exam := &qualificationsexam.ExamQuestions{Questions: []*qualificationsexam.ExamQuestion{
		{
			...
			Data: &qualificationsexam.ExamQuestionData{Data: &qualificationsexam.ExamQuestionData_SingleChoice{
				SingleChoice: &qualificationsexam.ExamQuestionSingleChoice{Choices: []string{"A"}},
			}},
		},
		{
			Id: 2,
			Data: &qualificationsexam.ExamQuestionData{Data: &qualificationsexam.ExamQuestionData_FreeText{
				FreeText: &qualificationsexam.ExamQuestionText{MinLength: 3, MaxLength: 5},
			}},
		},
	}}

	_, err := normalizeExamResponses(exam, &qualificationsexam.ExamResponses{Responses: []*qualificationsexam.ExamResponse{
		{QuestionId: 1, Response: &qualificationsexam.ExamResponseData{Response: &qualificationsexam.ExamResponseData_SingleChoice{SingleChoice: &qualificationsexam.ExamResponseSingleChoice{Choice: "B"}}}},
		{QuestionId: 2, Response: &qualificationsexam.ExamResponseData{Response: &qualificationsexam.ExamResponseData_FreeText{FreeText: &qualificationsexam.ExamResponseText{Text: "ab"}}}},
	}}, false)
	require.Error(t, err)
