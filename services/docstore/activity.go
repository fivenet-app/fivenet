...
func (s *Server) ListDocumentActivity(ctx context.Context, req *pbdocstore.ListDocumentActivityRequest) (*pbdocstore.ListDocumentActivityResponse, error) {
	...
	resp := &pbdocstore.ListDocumentActivityResponse{
		Pagination: pag,
