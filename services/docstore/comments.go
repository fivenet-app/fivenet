...
import (
	...
	permsdocstore "github.com/fivenet-app/fivenet/v2025/gen/go/proto/services/docstore/perms"
...
func (s *Server) GetComments(ctx context.Context, req *pbdocstore.GetCommentsRequest) (*pbdocstore.GetCommentsResponse, error) {
	...
	resp := &pbdocstore.GetCommentsResponse{
		Pagination: pag,
...
func (s *Server) PostComment(ctx context.Context, req *pbdocstore.PostCommentRequest) (*pbdocstore.PostCommentResponse, error) {
	...
	return &pbdocstore.PostCommentResponse{
		Comment: comment,
	}, nil
}

func (s *Server) EditComment(ctx context.Context, req *pbdocstore.EditCommentRequest) (*pbdocstore.EditCommentResponse, error) {
	trace.SpanFromContext(ctx).SetAttributes(attribute.Int64("fivenet.docstore.id", int64(req.Comment.DocumentId)))
	...
	return &pbdocstore.EditCommentResponse{
		Comment: comment,
	}, nil
}
...
func (s *Server) DeleteComment(ctx context.Context, req *pbdocstore.DeleteCommentRequest) (*pbdocstore.DeleteCommentResponse, error) {
	...
	return &pbdocstore.DeleteCommentResponse{}, nil
}
