...
|-----------|-------------|---------|
| `affinity` |  | `{}` |
| `discordBot` | FiveNet Discord Bot deployment config | `{"additionalEnv":[],"enabled":true,"image":{"pullPolicy":"IfNotPresent","repository":"docker.io/galexrt/fivenet","tag":""},"livenessProbe":{"httpGet":{"path":"/readiness","port":"metrics"},"initialDelaySeconds":15,"periodSeconds":10},"readinessProbe":{"httpGet":{"path":"/readiness","port":"metrics"},"initialDelaySeconds":10,"periodSeconds":7},"replicaCount":1,"resources":{},"serviceMonitor":{"additionalLabels":{},"enabled":false,"namespaceSelector":null,"scrapeInterval":"30s"}}` |
| `discordBot.serviceMonitor.additionalLabels` | Additional Labels for the ServiceMonitor object | `{}` |
| `discordBot.serviceMonitor.enabled` | Specifies whether a prometheus-operator ServiceMonitor should be created | `false` |
| `discordBot.serviceMonitor.scrapeInterval` | Interval at which metrics should be scraped | `"30s"` |
