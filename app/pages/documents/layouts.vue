...
import SvgEditor from '~/components/SvgEdit/SvgEditor.client.vue';
...
<template>
    <div class="p-2">
        <h1 class="mb-4 text-2xl font-semibold">SVG Editor</h1>
        <SvgEditor :initial-svg="starter" />
    </div>
</template>
