...
<template>
    <div class="flex flex-col gap-2">
        <div class="flex flex-row flex-wrap gap-1">
            <UBadge v-for="entry in jobs" :key="entry.id" color="neutral" class="inline-flex gap-1" size="md" v-bind="$attrs">
        ...
        <div class="flex flex-row flex-wrap gap-1">
            <UBadge v-for="entry in users" :key="entry.id" color="neutral" class="inline-flex gap-1" size="md" v-bind="$attrs">
