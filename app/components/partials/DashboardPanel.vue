...
<template>
    ...
    >
        ...
        <slot name="handle" :on-drag="onDrag">
            <UDashboardResizeHandle v-if="resizable && !grow" @mousedown="onDrag" />
        </slot>
    </div>
...
const config = {
    ...
    border: 'border-b lg:border-b-0 lg:border-r border-neutral-200 dark:border-neutral-800 lg:w-(--width) shrink-0',
    grow: 'flex-1',
