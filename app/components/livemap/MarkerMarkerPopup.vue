...
function openMarkerEditor(marker: MarkerMarker, closePopup: () => void): void {
    closePopup();
...
<template>
    <LeafletLazyPopup class="min-w-[175px] md:min-w-[305px] xl:min-w-[330px]" :options="{ closeButton: false }">
        <template #default="{ popupOpen, closePopup }">
            <UCard
                v-if="popupOpen"
                    ...
                    <div class="grid grid-cols-1 gap-2 !text-primary md:grid-cols-2 xl:grid-cols-3">
                        ...
                        >
                            <UButton
                                ...
                                :label="$t('common.edit')"
                                block
                                @click="openMarkerEditor(marker, closePopup)"
                            />
                        </UTooltip>
