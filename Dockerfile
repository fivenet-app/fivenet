...
# Frontend Build
FROM docker.io/library/node:24.10.0-alpine3.22 AS nodebuilder
...
FROM docker.io/library/alpine:3.22.2 AS livemaptiles
...
FROM docker.io/library/alpine:3.22.2 AS iconsets
