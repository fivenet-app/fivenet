...
//
// You can control the behavior of the wrapper (e.g. modifying CORS behavior) using `With*` options.
...
//
// You can control the CORS behavior using `With*` options in the WrapServer function.
