// Package wk provides handlers for the well-known endpoints as defined in RFC 8615.
//
// It includes handlers for /.well-known/change-password and /.well-known/security.txt.
package wk
...
func New() *WK {
	return &WK{
		...
		securityTxt: fmt.Sprintf(
			securityTxtTpl,
			time.Now().AddDate(0, 4, 0).Format("2006-01-02T15:04:05:07.000Z"),
		),
	}
}
