...
import (
	...
	"github.com/galexrt/arpanet/pkg/permify/helpers"
	"github.com/galexrt/arpanet/pkg/permify/models"
	"github.com/galexrt/arpanet/pkg/permify/options"
	"github.com/galexrt/arpanet/pkg/permify/repositories"
...
func New(opts Options) (p *Permify, err error) {
	if opts.TablePrefix != nil {
		models.TablePrefix = *opts.TablePrefix
	}
