...
CREATE TABLE IF NOT EXISTS `fivenet_oauth2_accounts` (
  ...
  UNIQUE KEY `idx_fivenet_oauth2_accounts_unique` (`account_id`,`provider`) USING BTREE,
  UNIQUE KEY `idx_fivenet_oauth2_accounts_provider_external_id` (`provider`,`external_id`) USING BTREE,
