...
CREATE TABLE IF NOT EXISTS `fivenet_wiki_pages_visibility_public` (
  ...
  CONSTRAINT `fk_fivenet_wiki_pages_visibility_public_target_id` FOREIGN KEY (`target_id`) REFERENCES `fivenet_wiki_pages` (`id`)
...
CREATE TABLE IF NOT EXISTS `fivenet_wiki_pages_visibility_creator` (
  ...
  CONSTRAINT `fk_fivenet_wiki_pages_visibility_creator_target_id` FOREIGN KEY (`target_id`) REFERENCES `fivenet_wiki_pages` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `fivenet_wiki_pages_visibility_subject` (
  ...
  CONSTRAINT `fk_fivenet_wiki_pages_visibility_subject_target_id` FOREIGN KEY (`target_id`) REFERENCES `fivenet_wiki_pages` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fivenet_wiki_pages_visibility_subject_subject_id` FOREIGN KEY (`subject_id`) REFERENCES `fivenet_acl_subjects` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
