...
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'filestore.FilestoreService' AND `name` = 'DeleteFile' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'filestore.FilestoreService' AND `name` = 'DeleteFileByPath' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'filestore.FilestoreService' AND `name` = 'ListFiles' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'filestore.FilestoreService' AND `name` = 'Upload' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'notifications.NotificationsService' AND `name` = 'GetNotifications' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'notifications.NotificationsService' AND `name` = 'MarkNotifications' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'notifications.NotificationsService' AND `name` = 'Stream' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.AccountsService' AND `name` = 'CreateAccount' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.AccountsService' AND `name` = 'DeleteAccount' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.AccountsService' AND `name` = 'DisconnectOAuth2Connection' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.AccountsService' AND `name` = 'ListAccounts' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.AccountsService' AND `name` = 'UpdateAccount' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.ConfigService' AND `name` = 'GetAppConfig' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.ConfigService' AND `name` = 'UpdateAppConfig' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.CronService' AND `name` = 'ListCronjobs' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.SystemService' AND `name` = 'DeleteFaction' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.SystemService' AND `name` = 'GetAllPermissions' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.SystemService' AND `name` = 'GetJobLimits' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.SystemService' AND `name` = 'GetStatus' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'settings.SystemService' AND `name` = 'UpdateJobLimits' LIMIT 1;
...
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'mailer.MailerService' AND `name` = 'DeleteThread' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'mailer.MailerService' AND `name` = 'DeleteTemplate' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'mailer.MailerService' AND `name` = 'DeleteMessage' LIMIT 1;
...
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'jobs.JobsService' AND `name` = 'GetMOTD' LIMIT 1;
...
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'completor.CompletorService' AND `name` = 'ListLawBooks' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'completor.CompletorService' AND `name` = 'CompleteJobs' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'citizens.CitizensService' AND `name` = 'UploadMugshot' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'citizens.CitizensService' AND `name` = 'UploadAvatar' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'citizens.CitizensService' AND `name` = 'DeleteMugshot' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'citizens.CitizensService' AND `name` = 'DeleteAvatar' LIMIT 1;
...
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'UpdateCalendar' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'SubscribeToCalendar' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'ShareCalendarEntry' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'RSVPCalendarEntry' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'ListSubscriptions' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'ListCalendars' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'ListCalendarEntryRSVP' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'ListCalendarEntries' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'GetUpcomingEntries' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'GetCalendarEntry' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'GetCalendar' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'DeleteCalendarEntry' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'DeleteCalendar' LIMIT 1;
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'calendar.CalendarService' AND `name` = 'CreateOrUpdateCalendarEntry' LIMIT 1;

-- Remove unused permission from completor
DELETE FROM `fivenet_rbac_permissions` WHERE `category` = 'completor.CompletorService' AND `name` = 'CompleteCitizens' LIMIT 1;
...
INSERT INTO `fivenet_rbac_roles_permissions` (role_id, permission_id, val)
	...
	1 AS `val`
FROM
	`fivenet_rbac_roles_permissions` fr,
