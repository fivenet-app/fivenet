...
CREATE TABLE IF NOT EXISTS `fivenet_documents_stamps_visibility_creator` (
  ...
  CONSTRAINT `fk_fivenet_documents_stamps_visibility_creator_target_id` FOREIGN KEY (`target_id`) REFERENCES `fivenet_documents_stamps` (`id`)
...
CREATE TABLE IF NOT EXISTS `fivenet_documents_stamps_visibility_subject` (
  ...
  CONSTRAINT `fk_fivenet_documents_stamps_visibility_subject_target_id` FOREIGN KEY (`target_id`) REFERENCES `fivenet_documents_stamps` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fivenet_documents_stamps_visibility_subject_subject_id` FOREIGN KEY (`subject_id`) REFERENCES `fivenet_acl_subjects` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
