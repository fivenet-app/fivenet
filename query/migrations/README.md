...
ALTER TABLE `fivenet_user_citizen_attributes` ADD CONSTRAINT `fk_fivenet_user_citizen_attributes_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
