...
ALTER TABLE `fivenet_qualifications_exam_responses` ADD CONSTRAINT `fk_fivenet_qualifications_exam_responses_quali_user_id` FOREIGN KEY (`qualification_id`) REFERENCES `fivenet_qualifications` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `fivenet_qualifications_exam_responses` ADD CONSTRAINT `fk_fivenet_qualifications_exam_responses_user_id` FOREIGN KEY (`user_id`) REFERENCES `{{.UsersTableName}}` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE;
