...
CREATE TABLE IF NOT EXISTS `fivenet_user_accounts` (
  ...
  CONSTRAINT `fk_fivenet_user_accounts_user_id` FOREIGN KEY (`user_id`) REFERENCES `fivenet_user` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fivenet_user_accounts_account_id` FOREIGN KEY (`account_id`) REFERENCES `fivenet_accounts` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
