...
CREATE TABLE IF NOT EXISTS `fivenet_attrs` (
  ...
  CONSTRAINT `fk_fivenet_attrs_permissions_permission_id` FOREIGN KEY (`permission_id`) REFERENCES `fivenet_permissions` (`id`)
...
CREATE TABLE IF NOT EXISTS `fivenet_role_attrs` (
  ...
  CONSTRAINT `fk_fivenet_role_attrs_role_id` FOREIGN KEY (`role_id`) REFERENCES `fivenet_roles` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fivenet_role_attrs_attr_id` FOREIGN KEY (`attr_id`) REFERENCES `fivenet_attrs` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `fivenet_role_permissions` (
  ...
  CONSTRAINT `fk_fivenet_role_permissions_permission` FOREIGN KEY (`permission_id`) REFERENCES `fivenet_permissions` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fivenet_role_permissions_role` FOREIGN KEY (`role_id`) REFERENCES `fivenet_roles` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `fivenet_job_permissions` (
  ...
  CONSTRAINT `fk_fivenet_job_permissions_permission` FOREIGN KEY (`permission_id`) REFERENCES `fivenet_permissions` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `fivenet_job_attrs` (
  ...
  CONSTRAINT `fk_fivenet_job_attrs_attr_id` FOREIGN KEY (`attr_id`) REFERENCES `fivenet_attrs` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
