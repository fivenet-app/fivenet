...
CREATE TABLE IF NOT EXISTS `fivenet_user_labels_job_visibility_subject` (
  ...
  CONSTRAINT `fk_fivenet_user_labels_job_visibility_subject_target_id` FOREIGN KEY (`target_id`) REFERENCES `fivenet_user_labels_job` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fivenet_user_labels_job_visibility_subject_subject_id` FOREIGN KEY (`subject_id`) REFERENCES `fivenet_acl_subjects` (`id`)
    ON DELETE CASCADE ON UPDATE CASCADE,
