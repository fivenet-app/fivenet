...
func Test_accountQuery(t *testing.T) {
	...
	_, err = _do.First()
	if err != nil {
		t.Error("First() on table <arpanet_accounts> fail:", err)
	}
	...
	if err != nil {
		t.Error("FindInBatch() on table <arpanet_accounts> fail:", err)
	}
	...
	if err != nil {
		t.Error("Group() on table <arpanet_accounts> fail:", err)
	}

	_, err = _do.Scopes(func(dao gen.Dao) gen.Dao { return dao.Where(primaryKey.IsNotNull()) }).Find()
	if err != nil {
		t.Error("Scopes() on table <arpanet_accounts> fail:", err)
	}

	_, _, err = _do.FindByPage(0, 1)
	if err != nil {
		t.Error("FindByPage() on table <arpanet_accounts> fail:", err)
	}

	_, err = _do.ScanByPage(&model.Account{}, 0, 1)
	if err != nil {
		t.Error("ScanByPage() on table <arpanet_accounts> fail:", err)
	}

	_, err = _do.Attrs(primaryKey).Assign(primaryKey).FirstOrInit()
	if err != nil {
		t.Error("FirstOrInit() on table <arpanet_accounts> fail:", err)
	}

	_, err = _do.Attrs(primaryKey).Assign(primaryKey).FirstOrCreate()
	if err != nil {
		t.Error("FirstOrCreate() on table <arpanet_accounts> fail:", err)
	}
	...
	if err != nil {
		t.Error("Join() on table <arpanet_accounts> fail:", err)
	}

	err = _do.LeftJoin(&_a, primaryKey.EqCol(_aPK)).Scan(map[string]interface{}{})
	if err != nil {
		t.Error("LeftJoin() on table <arpanet_accounts> fail:", err)
	}

	_, err = _do.Not().Or().Clauses().Take()
	if err != nil {
		t.Error("Not/Or/Clauses on table <arpanet_accounts> fail:", err)
	}
}
