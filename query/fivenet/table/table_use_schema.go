...
func UseSchema(schema string) {
	...
	FivenetMailerAddresses = FivenetMailerAddresses.FromSchema(schema)
	FivenetMailerAddressesJobAccess = FivenetMailerAddressesJobAccess.FromSchema(schema)
	FivenetMailerAddressesUserAccess = FivenetMailerAddressesUserAccess.FromSchema(schema)
	...
	FivenetMailerThreadsJobAccess = FivenetMailerThreadsJobAccess.FromSchema(schema)
	FivenetMailerThreadsUserAccess = FivenetMailerThreadsUserAccess.FromSchema(schema)
	FivenetMailerThreadsUserState = FivenetMailerThreadsUserState.FromSchema(schema)
