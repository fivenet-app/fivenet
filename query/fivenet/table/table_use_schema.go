...
func UseSchema(schema string) {
	...
	FivenetDocumentsApprovalAccess = FivenetDocumentsApprovalAccess.FromSchema(schema)
	...
	FivenetDocumentsSignaturePoliciesAccess = FivenetDocumentsSignaturePoliciesAccess.FromSchema(schema)
