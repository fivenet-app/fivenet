...
import (
	...
	sanitizerpb "github.com/fivenet-app/fivenet/v2026/gen/go/proto/codegen/sanitizer"
...
func (p *SanitizerModule) generate(f pgs.File) {
	...
	for _, m := range f.Messages() {
		...
		for _, f := range m.Fields() {
			...
			if val.StripHtmlTags != nil && *val.StripHtmlTags {
				s.Method = "StripHTMLTags"
			} else if val.Method != nil && *val.Method != "" {
				s.Method = *val.Method
...
const sanitizerTpl = `// Code generated by protoc-gen-backend. DO NOT EDIT.
// source: {{ .F.InputPath }}
