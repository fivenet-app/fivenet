...
INSERT INTO `fivenet_documents_templates` (`id`, `created_at`, `updated_at`, `deleted_at`, `category_id`, `title`, `description`, `content_title`, `content`, `state`, `access`, `schema`, `creator_job`) VALUES (1,'2023-03-17 19:31:28.661','2023-03-17 19:31:35.698',NULL,1,'Patientenakte','LSMD Patientenakten Template','Patientenakte NAME','Patientenakte für Name','','{}',NULL,'ambulance');
