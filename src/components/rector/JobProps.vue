            ...
            <template v-else>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center">
                                        <UToggle v-model="jobProps.quickButtons.penaltyCalculator">
                                            <span
                                                :class="[
                                                    jobProps.quickButtons.penaltyCalculator ? 'translate-x-5' : 'translate-x-0',
                ...
                <UDashboardPanelContent v-if="jobProps.discordSyncSettings" class="pb-2">
                    ...
                    >
                        ...
                        <template
                            v-if="
                                jobProps.discordSyncSettings.userInfoSync && jobProps.discordSyncSettings.userInfoSyncSettings
                            "
                        >
                            <UFormGroup
                                name="userInfoSync"
                            ...
                            >
                                <UInput
                                    ...
                                    :placeholder="$t('components.rector.job_props.user_info_sync_settings.grade_role_format')"
                                    :label="$t('components.rector.job_props.user_info_sync_settings.grade_role_format')"
                                    maxlength="48"
                                    @focusin="focusTablet(true)"
                                    @focusout="focusTablet(false)"
                            ...
                            >
                                <USelectMenu
                                    ...
                                    :options="[UserInfoSyncUnemployedMode.GIVE_ROLE, UserInfoSyncUnemployedMode.KICK]"
                                >
                                    <template #label>
                                        {{
                                            UserInfoSyncUnemployedMode[
                                                jobProps.discordSyncSettings.userInfoSyncSettings.unemployedMode ?? 0
                                            ]
                                        }}
                                    </template>

                                    <template #option="{ option }">
                                        {{ UserInfoSyncUnemployedMode[option ?? 0] }}
                                    </template>
                                </USelectMenu>
                            </UFormGroup>
