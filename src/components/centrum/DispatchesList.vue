    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-100">Transactions</h1>
                <p class="mt-2 text-sm text-gray-300">A table of placeholder stock market data that does not make any sense.</p>
            </div>
