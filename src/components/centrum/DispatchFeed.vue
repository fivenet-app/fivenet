...
const activity = [
    { id: 1, type: 'created', person: { name: 'Chelsea Hagon' }, date: '2023-01-23T10:32' },
    { id: 2, type: 'edited', person: { name: 'Chelsea Hagon' }, date: '2023-01-23T11:03' },
    { id: 3, type: 'sent', person: { name: 'Chelsea Hagon' }, date: '2023-01-23T11:24' },
    {
        id: 4,
        type: 'commented',
        person: {
        ...
        date: '2023-01-23T15:56',
    },
    { id: 5, type: 'viewed', person: { name: 'Alex Curren' }, date: '2023-01-24T09:12' },
    { id: 6, type: 'paid', person: { name: 'Alex Curren' }, date: '2023-01-24T09:20' },
];
</script>
