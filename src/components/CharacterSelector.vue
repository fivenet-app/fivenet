    ...
    methods: {
        chooseCharacter(identifier: string) {
            ...
            client.chooseCharacter(req, null).then((resp) => {
                this.accessToken = resp.getToken();
...
<template>
    <div class="flex w-full">
        <div v-for="(char, index) in chars" :key="char.getIdentifier()"
            class="grid flex-grow card w-96 bg-base-100 shadow-xl rounded-box place-items-center">
            <div class="card-body items-center text-center">
                <h2 class="card-title text-xl">
                    ...
                    <div v-if="activeChar == char.getIdentifier()" class="badge badge-primary badge-outline">Last Used</div>
                </h2>
