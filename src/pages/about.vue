                        ...
                        <div class="max-w-xl text-base leading-7 text-gray-100 lg:max-w-lg">
                            ...
                            <ul role="list" class="mt-8 space-y-8 text-gray-400">
                                ...
                                <li class="flex gap-x-3">
                                    ...
                                    <span>
                                        <strong class="font-semibold text-gray-200">Livemap.</strong> See the location of
        ...
        <div class="relative bg-gray-900">
            <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-20">
                <div class="mx-auto max-w-4xl">
                    <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Got any questions or issues?
                    </p>
