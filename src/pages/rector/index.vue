...
<template>
    <UDashboardPage>
        <UDashboardPanel grow>
            ...
            <CardsList class="mx-2 mt-2 lg:mx-6" :items="items" />
        </UDashboardPanel>
    </UDashboardPage>
</template>
