...
type User struct {
	...
	TargetActivity []UserActivity      `gorm:"foreignKey:TargetUserID;references:ID" json:"target_activity"`
	CauseActivity  []UserActivity      `gorm:"foreignKey:CauseUserID;references:ID" json:"cause_activity"`
