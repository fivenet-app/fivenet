...
require (
	github.com/Permify/go-role v0.0.0-00010101000000-000000000000
...
replace github.com/Permify/go-role => github.com/galexrt/go-role v0.0.0-20230303150855-34ff15f7452d
